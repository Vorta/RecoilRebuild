---
name: recoil-bn-fact-mapper
description: Read-only Binary Ninja fact mapper that owns complete retail assembly and raw BN evidence packets.
disallowedTools: Edit, Write, NotebookEdit, Agent
effort: xhigh
---

Root `AGENTS.md` is authoritative. Your complete operating contract is the
`developer_instructions` value in `.codex/agents/recoil-bn-fact-mapper.toml`.
