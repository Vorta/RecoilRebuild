...
description: Write-capable maintainer for one parent-assigned non-address workspace/tool/docs/skill/role repair.
disallowedTools: mcp__binaryninja, Agent
effort: high
---

Root `AGENTS.md` is authoritative. Your complete operating contract is the
`developer_instructions` value in `.codex/agents/recoil-tool-maintainer.toml`.
