...
- `0x401060` `AINet::TickAiMode2TopLevel` -> `src/Battlesport/ai_net.h:725`
- `0x401180` `AINet::TickAiMode2PathFollow` -> `src/Battlesport/ai_net.h:806`
- `0x401420` `AINet::AiMode2ForwardProbeRequiresAutoTurn` -> `src/Battlesport/ai_net.h:935`
- `0x401580` `AINet::AiAdvancePathCursorAndComputeTargetVec` -> `src/Battlesport/ai_net.h:988`
- `0x4016a0` `AINet::AiChooseNextPathBranchIndex` -> `src/Battlesport/ai_net.h:1068`
- `0x401710` `AINet::TickAiMode2SteeringSubstate` -> `src/Battlesport/ai_net.h:1107`
- `0x401970` `AINet::UpdateAiMode2MoveAndTurnTowardTarget` -> `src/Battlesport/ai_net.h:1224`
- `0x401a40` `AINet::TickAiMode2OffsetTargetSteering` -> `src/Battlesport/ai_net.h:1267`
- `0x401ab0` `AINet::TickAiMode2DynamicOffsetTargetSteering` -> `src/Battlesport/ai_net.h:1304`
- `0x401b20` `AINet::AiTryEnterMode2AttackPursuitIfLineOfSight` -> `src/Battlesport/ai_net.h:1341`
- `0x401c00` `AINet::AiAlertAttackBuddies` -> `src/Battlesport/ai_net.h:1382`
- `0x401c60` `AINet::AiEnterMode2SteeringPursuit` -> `src/Battlesport/ai_net.h:1405`
- `0x401f60` `AINet::AiRebuildSyntheticPathToNodeIfFar` -> `src/Battlesport/ai_net.h:1593`
- `0x402090` `AINet::UpdateAiMode2TurnTowardPlayerNoThrottle` -> `src/Battlesport/ai_net.h:1651`
- `0x402170` `AINet::UpdateAiMode2TurnInPlaceTowardPlayer` -> `src/Battlesport/ai_net.h:1697`
- `0x402250` `AINet::TickAiMode2AltGunAttackWindow` -> `src/Battlesport/ai_net.h:1743`
- `0x4024a0` `AINet::SolveAltGunLeadTargetPoint` -> `src/Battlesport/ai_net.h:1851`
- `0x4026d0` `AINet::UpdateAiMode2MoveAndTurnTowardOffsetTarget` -> `src/Battlesport/ai_net.h:1910`
- `0x4028c0` `AINet::UpdateAiMode2MoveAndTurnTowardDynamicOffsetTarget` -> `src/Battlesport/ai_net.h:1974`
- `0x402b70` `AINet::TickAiMode2TimedPathSteering` -> `src/Battlesport/ai_net.h:2065`
- `0x402be0` `AINet::AiSteerTowardPathNodeForward` -> `src/Battlesport/ai_net.h:2091`
- `0x402d60` `AINet::AiSteerTowardPathNodeReverse` -> `src/Battlesport/ai_net.h:2163`
...
- `0x41b8ac` `NetSessionBrowserDialog::kHelpDocsFindExecutableErrorClassTable` -> `src/Battlesport/game_net_body.h:448`

## Battlesport/hud.cpp

- `0x404ca0` `HudUiElement::Draw` -> `src/Battlesport/hud.cpp:280`
- `0x404cb0` `HudUiElement::DrawBase` -> `src/Battlesport/hud.cpp:289`
- `0x404cd0` `HudUiElement::SetPos` -> `src/Battlesport/hud.cpp:306`
- `0x404cf0` `HudUiElement::SetX` -> `src/Battlesport/hud.cpp:320`
- `0x404d00` `HudUiElement::SetY` -> `src/Battlesport/hud.cpp:332`
- `0x404d10` `HudUiElement::HitTestTrue` -> `src/Battlesport/hud.cpp:344`
- `0x404d20` `HudUiElement::SetVisible` -> `src/Battlesport/hud.cpp:358`
- `0x404d50` `HudUiElement::GetX` -> `src/Battlesport/hud.cpp:375`
- `0x404d60` `HudUiElement::GetY` -> `src/Battlesport/hud.cpp:384`
- `0x404d70` `HudUiElement::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:393`
- `0x404d90` `HudUiWidget::GetCenterX` -> `src/Battlesport/hud.cpp:412`
- `0x404dd0` `HudUiWidget::GetCenterY` -> `src/Battlesport/hud.cpp:426`
- `0x404e10` `HudUiWidget::RebuildBltRectFromImage` -> `src/Battlesport/hud.cpp:440`
- `0x404e60` `HudUiCircle::HitTest` -> `src/Battlesport/hud.cpp:461`
- `0x406af0` `HudCheat::ExecuteCommandString` -> `src/Battlesport/hud.cpp:3587`
- `0x406cf0` `HudCheat::ClearNanitePanelCheatSentinel` -> `src/Battlesport/hud.cpp:3711`
- `0x407100` `HudUiCallback::QueueExitCurrentState` -> `src/Battlesport/hud.cpp:3545`
- `0x407110` `HudUiCallback::QueueCheatCodeState` -> `src/Battlesport/hud.cpp:3554`
- `0x4089c0` `HudUiMgr::ScreenToWorld` -> `src/GameZRecoil/zUI/zui.cpp:5718`
- `0x40bef0` `HudUiPanel::DestructorThunk` -> `src/GameZRecoil/zUI/zui.cpp:17354`
- `0x40bf00` `HudUtil::FreeFieldPtr` -> `src/GameZRecoil/zUI/zui.cpp:17519`
- `0x40d330` `HudLayoutHW::GlobalDestructor` -> `src/GameZRecoil/zUI/zui.cpp:988`
- `0x40d400` `HudUiMgr::StaticInitAndRegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:4454`
- `0x40d7e0` `HudUiMgr::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:4391`
- `0x40dbf0` `HudUiCounterTextPanel::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:18321`
- `0x40dcd0` `HudUiTriplet::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:18359`
- `0x40eb00` `HudUiShieldMessageWidget::ApplyLayout` -> `src/GameZRecoil/zUI/zui.cpp:15837`
- `0x40f2e0` `HudUiNanitePanel::InitLayout` -> `src/GameZRecoil/zUI/zui.cpp:14814`
- `0x40fe30` `HudUiShieldMessageWidget::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:15907`
- `0x40ff50` `HudUiMgr::ActivateHud` -> `src/GameZRecoil/zUI/zui.cpp:5819`
- `0x40ff80` `HudUiMgr::OnViewportChanged` -> `src/GameZRecoil/zUI/zui.cpp:5750`
- `0x410160` `HudUiMgr::EnsureHudLoaded` -> `src/GameZRecoil/zUI/zui.cpp:4605`
- `0x410e90` `HudUiMgr::EnableHud` -> `src/GameZRecoil/zUI/zui.cpp:5475`
- `0x410fe0` `HudUiMgr::UpdateFrame` -> `src/GameZRecoil/zUI/zui.cpp:5553`
- `0x411170` `HudUiMgr::ProjectPointToNormalizedClamped` -> `src/GameZRecoil/zUI/zui.cpp:4530`
- `0x411760` `HudUiMgrObjective::SetVisibleAndResetMeterFill` -> `src/GameZRecoil/zUI/zui.cpp:3794`
- `0x4117f0` `HudUiMgrObjective::TickMeterFillAnimation` -> `src/GameZRecoil/zUI/zui.cpp:3834`
- `0x4118b0` `HudUiMgrObjective::UpdateMeterXPoints` -> `src/GameZRecoil/zUI/zui.cpp:3819`
- `0x411900` `HudUiMgrObjective::Show` -> `src/GameZRecoil/zUI/zui.cpp:3938`
- `0x411a20` `HudUiMgrObjective::Begin` -> `src/GameZRecoil/zUI/zui.cpp:3985`
- `0x411ac0` `HudUiMgrObjective::StartHide` -> `src/GameZRecoil/zUI/zui.cpp:4016`
- `0x411f10` `HudUiMgrSensor::SetShieldMessageRatio` -> `src/GameZRecoil/zUI/zui.cpp:3601`
- `0x412050` `HudUiMgrObjective::RefreshCounterText` -> `src/GameZRecoil/zUI/zui.cpp:3777`
- `0x4124b0` `HudUiMgrTarget::UpdateSelectedProgressMeter` -> `src/GameZRecoil/zUI/zui.cpp:3704`
- `0x412620` `HudUiMgr::HideTrackedProgressMeterIfOwnerMatches` -> `src/GameZRecoil/zUI/zui.cpp:5667`
- `0x412650` `HudUiMessage::SetValueIfOwnerMatches` -> `src/GameZRecoil/zUI/zui.cpp:15710`
- `0x412820` `HudUiMessage::UpdateSelectedWeaponDisplay` -> `src/GameZRecoil/zUI/zui.cpp:15737`
- `0x412c10` `HudLayoutSW::LoadTypeIFromZarRoot` -> `src/GameZRecoil/zUI/zui.cpp:1209`
- `0x412c60` `HudLayoutSW::SetActive` -> `src/GameZRecoil/zUI/zui.cpp:1141`
- `0x412db0` `HudLayout::ApplyViewportRect` -> `src/GameZRecoil/zUI/zui.cpp:1236`
- `0x412f70` `HudLayoutHW::LoadTypeIIFromZarRoot` -> `src/GameZRecoil/zUI/zui.cpp:1530`
- `0x4130d0` `HudLayoutHW::SetActive` -> `src/GameZRecoil/zUI/zui.cpp:1421`
- `0x4132b0` `HudLayoutHW::UpdateObjectiveDirtyRect` -> `src/GameZRecoil/zUI/zui.cpp:1397`
- `0x413340` `HudLayoutHW::OnActivated` -> `src/GameZRecoil/zUI/zui.cpp:1327`
- `0x4134e0` `HudUiMessage::Draw` -> `src/GameZRecoil/zUI/zui.cpp:15513`
- `0x413500` `HudLayoutHW::UpdateAll` -> `src/GameZRecoil/zUI/zui.cpp:1123`
- `0x413540` `HudLayoutHW::Enable` -> `src/GameZRecoil/zUI/zui.cpp:1597`
- `0x4135f0` `HudLayoutHW::Disable` -> `src/GameZRecoil/zUI/zui.cpp:1632`
- `0x413600` `zOpt::ToggleHudTypeForCurrentHwMode` -> `src/Battlesport/hud.cpp:3732`
- `0x413640` `HudUiMgr::ToggleHud` -> `src/GameZRecoil/zUI/zui.cpp:5539`
- `0x413660` `HudUiMgr::SwitchActiveDialog` -> `src/GameZRecoil/zUI/zui.cpp:5625`
- `0x4136b0` `HudUiMgr::ApplyHudModeSwitch` -> `src/GameZRecoil/zUI/zui.cpp:5698`
- `0x4136f0` `HudUiSensorWindow::StaticInitAndRegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:1015`
- `0x413700` `HudUiSensorWindow::StaticInit` -> `src/GameZRecoil/zUI/zui.cpp:1026`
- `0x413710` `HudUiSensorWindow::RegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:1035`
- `0x413720` `HudUiSensorWindow::AtExitDestructor` -> `src/GameZRecoil/zUI/zui.cpp:1045`
- `0x413770` `HudUiMgr::SetFloatTimerVisible` -> `src/GameZRecoil/zUI/zui.cpp:5652`
- `0x4137a0` `HudUiMgr::SetAuxOverlayVisible` -> `src/GameZRecoil/zUI/zui.cpp:5687`
- `0x4138d0` `HudUi::ShowTopMessageLine` -> `src/GameZRecoil/zUI/zui.cpp:19102`
- `0x4138f0` `HudUi::ShowChatLine` -> `src/GameZRecoil/zUI/zui.cpp:19120`
- `0x413990` `HudUiLayoutNode::ApplyTextLabel` -> `src/GameZRecoil/zUI/zui.cpp:2596`
- `0x413a10` `HudUiLayoutNode::ReadRectOffsetAndSize` -> `src/GameZRecoil/zUI/zui.cpp:2556`
- `0x413aa0` `HudUiLayoutNode::ReadRect` -> `src/GameZRecoil/zUI/zui.cpp:2371`
- `0x413ad0` `HudUiLayoutNode::ReadInt3` -> `src/GameZRecoil/zUI/zui.cpp:2392`
- `0x413b10` `HudUiLayoutNode::ApplyCornerTextQuad` -> `src/GameZRecoil/zUI/zui.cpp:2423`
- `0x413c10` `HudUiLayoutNode::ApplyMeterQuad` -> `src/GameZRecoil/zUI/zui.cpp:2486`
- `0x413d30` `HudUiLayoutNode::ApplyImageWidget` -> `src/GameZRecoil/zUI/zui.cpp:2631`
- `0x414070` `HudUiMessage::RebuildWeaponLayout` -> `src/GameZRecoil/zUI/zui.cpp:15523`
...
- `0x42bf40` `HudUi::PlayPowerupSfx` -> `src/GameZRecoil/zUI/zui.cpp:19084`
...
- `0x4bc480` `HudUiCircle::HudUiCircle` -> `src/GameZRecoil/zUI/zui.cpp:6546`
- `0x4bcf80` `HudUiBar::SetPointXY` -> `src/GameZRecoil/zUI/zui.cpp:15957`
- `0x4bd280` `HudUi::PushTopMessageLine` -> `src/GameZRecoil/zUI/zui.cpp:19159`
- `0x4bdc70` `HudWeatherFx::Constructor` -> `src/Battlesport/hud.cpp:1792`
- `0x4bde20` `HudWeatherFx::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:1883`
- `0x4bde40` `HudWeatherFx::Destructor` -> `src/Battlesport/hud.cpp:1899`
- `0x4bdee0` `HudWeatherFx::ResetParticleSlot` -> `src/Battlesport/hud.cpp:1958`
- `0x4bdfd0` `HudWeatherFx::ApplyPass3` -> `src/Battlesport/hud.cpp:1987`
- `0x4be210` `HudWeatherFx::ArePointBatchInsideRect` -> `src/Battlesport/hud.cpp:1927`
- `0x4be280` `HudWeatherFxSnow::Constructor` -> `src/Battlesport/hud.cpp:2089`
- `0x4be2c0` `HudWeatherFxSnow::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:2105`
- `0x4be2e0` `HudWeatherFxSnow::Destructor` -> `src/Battlesport/hud.cpp:2121`
- `0x4be2f0` `HudWeatherFxSnow::Update` -> `src/Battlesport/hud.cpp:2130`
- `0x4be810` `HudWeatherFxRain::Constructor` -> `src/Battlesport/hud.cpp:2291`
- `0x4be850` `HudWeatherFxRain::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:2307`
- `0x4be870` `HudWeatherFxRain::Destructor` -> `src/Battlesport/hud.cpp:2323`
- `0x4be880` `HudWeatherFxRain::Update` -> `src/Battlesport/hud.cpp:2332`

## Battlesport/hud_ui_dialogs.cpp

- `0x408a30` `HudUiControlsDialog::Constructor` -> `src/Battlesport/hud.cpp:3439`
- `0x408c20` `HudUiControlsDialog_CommandsWidget::OnActivate` -> `src/Battlesport/hud.cpp:3428`
- `0x408c40` `HudUiControlsDialog::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:3527`
- `0x408c70` `HudUiControlsDialog::Destructor` -> `src/Battlesport/hud.cpp:3509`

## Battlesport/HudCmdBindButton.cpp

- `0x40a940` `HudCmdCommandList::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:12336`
- `0x40aa30` `HudCmdKeyAButton::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:12399`
- `0x40ab20` `HudCmdKeyBButton::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:12462`
- `0x40ac10` `HudCmdJoyButton::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:12525`
- `0x40ad00` `HudCmdMouseButton::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:12588`
- `0x40bdc0` `zUtil_StdPtrVector_Clear` -> `src/GameZRecoil/zUI/zui.cpp:12221`
- `0x40be60` `HudCmdBindingEntry::CopyRange` -> `src/GameZRecoil/zUI/zui.cpp:12062`
- `0x40c280` `HudCmdBindButtonBase::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:12289`
- `0x4b8de0` `HudCmdBindButtonBase::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:14391`
- `0x4b90e0` `HudCmdBindButtonBase::RebuildBindingSlotWidgets` -> `src/GameZRecoil/zUI/zui.cpp:14330`
- `0x4b9320` `HudCmdBindButtonBase::OnSelectedIndexChanged` -> `src/GameZRecoil/zUI/zui.cpp:12120`
- `0x4b9330` `HudCmdBindButtonBase::SetSelectedEntry` -> `src/GameZRecoil/zUI/zui.cpp:12131`

## Battlesport/HudCmdDialog.cpp

- `0x40a5b0` `HudCmdDialog::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:12693`
- `0x40a920` `HudCmdDialog::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:12851`
- `0x40adf0` `HudCmdDialog::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:12826`
- `0x40b140` `HudCmdDialog::UpdateCaptureState` -> `src/GameZRecoil/zUI/zui.cpp:14084`
- `0x40b3e0` `HudCmdDialog::ApplyPrimaryKeyRebind` -> `src/GameZRecoil/zUI/zui.cpp:14192`
- `0x40b460` `HudCmdDialog::ApplySecondaryKeyRebind` -> `src/GameZRecoil/zUI/zui.cpp:14228`
- `0x40b4e0` `HudCmdDialog::ApplyJoystickButtonRebind` -> `src/GameZRecoil/zUI/zui.cpp:14264`
- `0x40b560` `HudCmdDialog::ApplyMouseButtonRebind` -> `src/GameZRecoil/zUI/zui.cpp:14297`
- `0x40b5e0` `HudCmdDialog::SelectGroupRelative` -> `src/GameZRecoil/zUI/zui.cpp:13673`
- `0x40b630` `HudCmdDialog::SelectCommandRelative` -> `src/GameZRecoil/zUI/zui.cpp:13694`
- `0x40b680` `HudCmdDialog::RebuildCommandBindingListsForGroup` -> `src/GameZRecoil/zUI/zui.cpp:13901`
- `0x40b930` `HudCmdResetButton::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13723`
- `0x40b960` `HudCmdSetListWidget::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13736`
- `0x40b980` `HudCmdDialog::OnCommandSelectionChanged` -> `src/GameZRecoil/zUI/zui.cpp:14051`
- `0x40ba30` `HudCmdKeyAButton::OnBeginCapture` -> `src/GameZRecoil/zUI/zui.cpp:13747`
- `0x40ba60` `HudCmdKeyAButton::OnClearBinding` -> `src/GameZRecoil/zUI/zui.cpp:13758`
- `0x40ba90` `HudCmdBindButtonBase::OnSelectionChangedRefresh` -> `src/GameZRecoil/zUI/zui.cpp:13772`
- `0x40bab0` `HudCmdKeyBButton::OnBeginCapture` -> `src/GameZRecoil/zUI/zui.cpp:13783`
- `0x40bae0` `HudCmdKeyBButton::OnClearBinding` -> `src/GameZRecoil/zUI/zui.cpp:13794`
- `0x40bb00` `HudCmdJoyButton::OnBeginCapture` -> `src/GameZRecoil/zUI/zui.cpp:13806`
- `0x40bb30` `HudCmdJoyButton::OnClearBinding` -> `src/GameZRecoil/zUI/zui.cpp:13817`
- `0x40bb50` `HudCmdMouseButton::OnBeginCapture` -> `src/GameZRecoil/zUI/zui.cpp:13830`
- `0x40bb80` `HudCmdMouseButton::OnClearBinding` -> `src/GameZRecoil/zUI/zui.cpp:13845`
- `0x40bba0` `HudCmdNextSetButton::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13861`
- `0x40bbc0` `HudCmdPrevSetButton::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13871`
- `0x40bbe0` `HudCmdNextCommandButton::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13881`
- `0x40bc00` `HudCmdPrevCommandButton::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13891`
- `0x40bc20` `HudCmdDialogState::StaticInitAndRegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:13549`
- `0x40bc30` `HudCmdDialogState::StaticInit` -> `src/GameZRecoil/zUI/zui.cpp:13559`
- `0x40bc40` `HudCmdDialogState::RegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:13568`
- `0x40bc50` `HudCmdDialogState::AtExitDestructor` -> `src/GameZRecoil/zUI/zui.cpp:13577`
- `0x40bc60` `HudCmdDialogState::HudCmdDialogState` -> `src/GameZRecoil/zUI/zui.cpp:13607`
- `0x40bc90` `HudCmdDialogState::~HudCmdDialogState` -> `src/GameZRecoil/zUI/zui.cpp:13660`
- `0x40bcf0` `HudCmdDialogState::OnTryBecomeCurrent` -> `src/GameZRecoil/zUI/zui.cpp:13616`
- `0x40bd60` `HudCmdDialogState::OnDeactivate` -> `src/GameZRecoil/zUI/zui.cpp:13634`
- `0x40bda0` `HudCmdDialogState::QueueEnter` -> `src/GameZRecoil/zUI/zui.cpp:13595`
- `0x40be00` `HudCmdBinding::DestroyRange` -> `src/GameZRecoil/zUI/zui.cpp:12188`

## Battlesport/HudConfirmQuitDialog.cpp

- `0x415740` `HudUiConfirmQuitOkButton::OnActivate` -> `src/Battlesport/hud.cpp:2866`
- `0x415810` `RecoilStateConfirmQuit::StaticInitAndRegisterAtExit` -> `src/Battlesport/hud.cpp:2829`
- `0x415820` `RecoilStateConfirmQuit::StaticInit` -> `src/Battlesport/hud.cpp:2839`
- `0x415830` `RecoilStateConfirmQuit::RegisterAtExit` -> `src/Battlesport/hud.cpp:2848`
- `0x415840` `RecoilStateConfirmQuit::AtExitDestructor` -> `src/Battlesport/hud.cpp:2857`
- `0x415850` `RecoilStateConfirmQuit::RecoilStateConfirmQuit` -> `src/Battlesport/hud.cpp:3145`
- `0x4158f0` `RecoilStateConfirmQuit::OnTryBecomeCurrent` -> `src/Battlesport/hud.cpp:3154`
- `0x415960` `RecoilStateConfirmQuit::OnDeactivate` -> `src/Battlesport/hud.cpp:3172`
- `0x4159b0` `RecoilStateConfirmQuit::QueueEnter` -> `src/Battlesport/hud.cpp:2794`

## Battlesport/HudOptionsDialog.cpp

- `0x40c6e0` `HudUiOptionsPanelBackButton::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:12877`
- `0x40c720` `HudOptionsDialog::HudOptionsDialog` -> `src/GameZRecoil/zUI/zui.cpp:13429`
- `0x40cf60` `HudOptionsDialog::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:13510`
- `0x40d070` `HudUiOptionsPanelOverlayOwner::StaticInitAndRegisterAtExit` -> `src/Battlesport/hud.cpp:2717`
- `0x40d080` `HudUiOptionsPanelOverlayOwner::StaticInit` -> `src/Battlesport/hud.cpp:2727`
- `0x40d090` `HudUiOptionsPanelOverlayOwner::RegisterAtExit` -> `src/Battlesport/hud.cpp:2736`
- `0x40d0a0` `HudUiOptionsPanelOverlayOwner::AtExitDestructor` -> `src/Battlesport/hud.cpp:2745`
- `0x40d0b0` `HudUiOptionsPanelOverlayOwner::HudUiOptionsPanelOverlayOwner` -> `src/Battlesport/hud.cpp:2754`
- `0x40d0e0` `HudUiOptionsPanelOverlayOwner::~HudUiOptionsPanelOverlayOwner` -> `src/Battlesport/hud.cpp:2763`
- `0x40d150` `HudUiOptionsPanelOverlayOwner::OnTryBecomeCurrent` -> `src/Battlesport/hud.cpp:2782`
- `0x40d1c0` `HudUiOptionsPanelOverlayOwner::QueueEnter` -> `src/Battlesport/hud.cpp:2705`

## Battlesport/HudScoreboard.cpp

- `0x40eab0` `HudScoreboard::SetScaleAndRebuild` -> `src/GameZRecoil/zUI/zui.cpp:18727`
- `0x40eae0` `HudScoreboard::DispatchSetScale` -> `src/GameZRecoil/zUI/zui.cpp:18739`

## Battlesport/HudUi.cpp

- `0x4143a0` `HudUiMgr::IsLocalPlayerFirstInStatsList` -> `src/GameZRecoil/zUI/zui.cpp:4596`
- `0x4143c0` `HudUi::RemoveScoreboardEntryRow` -> `src/GameZRecoil/zUI/zui.cpp:19148`
- `0x4bc810` `HudUiContainer::FindChildWithPrev` -> `src/GameZRecoil/zUI/zui.cpp:7163`
- `0x4bc860` `HudUiContainer::RemoveChild` -> `src/GameZRecoil/zUI/zui.cpp:7199`

## Battlesport/hudui.cpp

- `0x426150` `HudUi::HandleHotkeyCommand` -> `src/GameZRecoil/zUI/zui.cpp:18980`
- `0x4b3e90` `HudUiWidget::InvalidateRect` -> `src/GameZRecoil/zUI/zui.cpp:9104`
- `0x4b3fb0` `HudUiWidget::Draw` -> `src/GameZRecoil/zUI/zui.cpp:14575`

## Battlesport/hudui_background.cpp

- `0x4b9540` `HudUiBackground::HudUiBackground` -> `src/GameZRecoil/zUI/zui.cpp:8198`
- `0x4b9740` `HudUiBackground::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:8268`
- `0x4b9760` `HudUiBackground::~HudUiBackground` -> `src/GameZRecoil/zUI/zui.cpp:8246`
- `0x4b98d0` `HudUiBackground::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:8337`
- `0x4b9900` `HudUiBackground::LoadZrdAndSection` -> `src/GameZRecoil/zUI/zui.cpp:8360`
- `0x4ba020` `HudUiTransitionTextPanel::HudUiTransitionTextPanel` -> `src/GameZRecoil/zUI/zui.cpp:8680`
- `0x4bf980` `HudUiBackgroundCursorWidget::HudUiBackgroundCursorWidget` -> `src/GameZRecoil/zUI/zui.cpp:9169`
- `0x4bfa20` `HudUiBackgroundCursorWidget::~HudUiBackgroundCursorWidget` -> `src/GameZRecoil/zUI/zui.cpp:9189`
- `0x4bfa50` `HudUiBackgroundCursorWidget::SetImageByPathOwnedAndRefresh` -> `src/GameZRecoil/zUI/zui.cpp:9200`
- `0x4bfa70` `HudUiBackgroundCursorWidget::SetImageBorrowedAndRefreshIfChanged` -> `src/GameZRecoil/zUI/zui.cpp:9213`
- `0x4bfa90` `HudUiBackgroundCursorWidget::SetImageOwnedAndRefresh` -> `src/GameZRecoil/zUI/zui.cpp:9226`
- `0x4bfae0` `HudUiBackgroundCursorWidget::SetImageBorrowedAndRefresh` -> `src/GameZRecoil/zUI/zui.cpp:9250`
- `0x4bfb70` `HudUiBackgroundCursorWidget::SetPos` -> `src/GameZRecoil/zUI/zui.cpp:9290`
- `0x4bfba0` `HudUiBackgroundCursorWidget::RebuildCapturedImage` -> `src/GameZRecoil/zUI/zui.cpp:9309`
- `0x4bfc50` `HudUiBackgroundCursorWidget::Draw` -> `src/GameZRecoil/zUI/zui.cpp:9347`
- `0x4bfc60` `HudUiBackgroundCursorWidget::DrawBase` -> `src/GameZRecoil/zUI/zui.cpp:9356`

## Battlesport/hudui_element.cpp

- `0x4b4070` `HudUiElement::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:6097`
...
- `0x415680` `HudUiBackgroundConfirmQuit::Constructor` -> `src/Battlesport/hud.cpp:2883`
- `0x415790` `HudUiBackgroundConfirmQuit::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:2926`
- `0x4157b0` `HudUiBackgroundConfirmQuit::Destructor` -> `src/Battlesport/hud.cpp:2915`

## Battlesport/HudUiCheatCode.cpp

- `0x406d20` `HudUiCheatCodeDialog::HudUiCheatCodeDialog` -> `src/Battlesport/hud.cpp:2953`
- `0x406e10` `HudUiCheatCodeDialog::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:2997`
- `0x406e30` `HudUiCheatCodeDialog::Destructor` -> `src/Battlesport/hud.cpp:2986`
- `0x406e90` `RecoilStateCheatCode::StaticInitAndRegisterAtExit` -> `src/Battlesport/hud.cpp:3014`
- `0x406ea0` `RecoilStateCheatCode::ConstructGlobal` -> `src/Battlesport/hud.cpp:3024`
- `0x406eb0` `RecoilStateCheatCode::StaticInit` -> `src/Battlesport/hud.cpp:3033`
- `0x406ec0` `RecoilStateCheatCode::AtExitDestructor` -> `src/Battlesport/hud.cpp:3042`
- `0x406ed0` `RecoilStateCheatCode::RecoilStateCheatCode` -> `src/Battlesport/hud.cpp:3051`
- `0x406f00` `RecoilStateCheatCode::Destructor` -> `src/Battlesport/hud.cpp:3131`
- `0x4070e0` `HudUiCheatCodeTitleWidget::OnActivate` -> `src/Battlesport/hud.cpp:2943`

## Battlesport/HudUiCreditsPanel.cpp

- `0x409040` `HudUiCreditsPanel::HudUiCreditsPanel` -> `src/GameZRecoil/zUI/zui.cpp:7373`
- `0x409570` `HudUiZrdScrollingText::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:7433`
- `0x409b90` `HudUiPanelSpan::InsertN` -> `src/GameZRecoil/zUI/zui.cpp:7961`
- `0x409f00` `HudUiPanelSpanVec::InsertN` -> `src/GameZRecoil/zUI/zui.cpp:8052`

## Battlesport/HudUiElement.cpp

- `0x4b41e0` `HudUiElement::Update` -> `src/GameZRecoil/zUI/zui.cpp:6192`
- `0x4b4280` `HudUiElement::SetTimer` -> `src/GameZRecoil/zUI/zui.cpp:6244`

## Battlesport/HudUiListMenu.cpp

- `0x40d220` `HudUiListMenuEntry::CompareSortKey` -> `src/GameZRecoil/zUI/zui.cpp:1814`
- `0x414670` `HudUiTripletEntries::GetCount` -> `src/GameZRecoil/zUI/zui.cpp:2315`
- `0x4146a0` `HudUiTripletEntries::CopyRange` -> `src/GameZRecoil/zUI/zui.cpp:2328`
- `0x4146e0` `HudUiTripletEntries::FillN` -> `src/GameZRecoil/zUI/zui.cpp:2350`
- `0x414710` `HudUiListMenuEntry::SortRange` -> `src/GameZRecoil/zUI/zui.cpp:1947`
- `0x414930` `HudUiListMenuEntry::InsertPivotIntoSortedPrefix` -> `src/GameZRecoil/zUI/zui.cpp:1846`
- `0x414980` `HudUiListMenuEntry::InsertionSortRange` -> `src/GameZRecoil/zUI/zui.cpp:1869`
...
- `0x414b60` `HudUiMainMenuDialog::CanLoadGame` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:271`
- `0x414b90` `HudUiMainMenuDialog::CanSaveGame` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:296`
- `0x414bc0` `HudUiMainMenuDialog::HudUiMainMenuDialog` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:321`
- `0x414f40` `HudUiMainMenuDialog_CreditsButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:11`
- `0x414f60` `HudUiMainMenuDialog_SaveButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:32`
- `0x414f80` `HudUiMainMenuDialog_NewGameButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:60`
- `0x414fa0` `HudUiMenuBackButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:21`
- `0x414fc0` `HudUiMainMenuDialog_OptionsButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:70`
- `0x414fe0` `HudUiMainMenuDialog_QuitButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:80`
- `0x415000` `HudUiMainMenuDialog_ControlsButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:90`
- `0x415040` `HudUiMainMenuDialog::~HudUiMainMenuDialog` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:501`
- `0x415140` `HudUiMainMenuDialog_LoadButton::OnActivate` -> `src/Battlesport/hud_ui_main_menu_dialog_body.h:44`
...
- `0x412070` `HudUiMgrSensor::PlaceTrackCounterWidget` -> `src/GameZRecoil/zUI/zui.cpp:3224`
- `0x4122c0` `HudUiMgrSensor::PlaceTrackMarker` -> `src/GameZRecoil/zUI/zui.cpp:3352`
- `0x41ebd0` `HudUiMgrSensor::TrackList_Reset` -> `src/GameZRecoil/zUI/zui.cpp:3167`
- `0x438920` `HudUiMgrSensor::TrackList_Add` -> `src/GameZRecoil/zUI/zui.cpp:3190`
- `0x439690` `HudUiMgrSensor::UpdateMarkersAndProgressFromVariantTag` -> `src/GameZRecoil/zUI/zui.cpp:3450`
...
- `0x41c270` `HudUiNewGamePanel_StartButton::OnActivate` -> `src/Battlesport/hud.cpp:2691`
- `0x41c290` `HudUiNewGamePanel::HudUiNewGamePanel` -> `src/Battlesport/hud.cpp:2582`
- `0x41c3b0` `HudUiNewGamePanel_NameInput::OnActivate` -> `src/Battlesport/hud.cpp:2622`
- `0x41c3e0` `HudUiNewGamePanel::ScalarDeletingDestructor` -> `src/Battlesport/hud.cpp:2647`
- `0x41c400` `HudUiNewGamePanel::Destructor` -> `src/Battlesport/hud.cpp:2634`
- `0x41c4e0` `HudUiNewGamePanel::SyncIntensityFromDifficulty` -> `src/Battlesport/hud.cpp:2663`
- `0x41c500` `HudUiNewGamePanel::StartGameFromFields` -> `src/Battlesport/hud.cpp:2672`
- `0x41c560` `HudUiNewGamePanelOverlayOwner::OnTryBecomeCurrent` -> `src/Battlesport/hud.cpp:2569`
- `0x41c5e0` `HudUiNewGamePanelOverlayOwner::StaticInitAndRegisterAtExit` -> `src/Battlesport/hud.cpp:2502`
- `0x41c5f0` `HudUiNewGamePanelOverlayOwner::StaticInit` -> `src/Battlesport/hud.cpp:2512`
- `0x41c630` `HudUiNewGamePanelOverlayOwner::~HudUiNewGamePanelOverlayOwner` -> `src/Battlesport/hud.cpp:2550`
- `0x41c6a0` `HudUiNewGamePanelOverlayOwner::RegisterAtExit` -> `src/Battlesport/hud.cpp:2521`
- `0x41c6b0` `HudUiNewGamePanelOverlayOwner::AtExitDestructor` -> `src/Battlesport/hud.cpp:2530`
- `0x41c6c0` `HudUiNewGamePanelOverlayOwner::QueueEnter` -> `src/Battlesport/hud.cpp:2490`

## Battlesport/HudUiPanel.cpp

- `0x409910` `HudUiPanelSpan::Clear` -> `src/GameZRecoil/zUI/zui.cpp:7835`
- `0x409b60` `HudUiPanelLayoutEntry::DestroyRange` -> `src/GameZRecoil/zUI/zui.cpp:7819`
- `0x40a170` `HudUiPanelLayoutEntry::CopyAssignRange` -> `src/GameZRecoil/zUI/zui.cpp:7796`
- `0x40a1e0` `HudUiPanelLayoutEntry::CopyAssign` -> `src/GameZRecoil/zUI/zui.cpp:7782`
- `0x40a210` `HudUiPanelLayoutEntry::CopyConstruct` -> `src/GameZRecoil/zUI/zui.cpp:7768`
- `0x40a240` `HudUiPanelSpan::CopyInit` -> `src/GameZRecoil/zUI/zui.cpp:7853`
- `0x40a300` `HudUiPanelSpan::CopyFrom` -> `src/GameZRecoil/zUI/zui.cpp:7883`
- `0x4ba850` `HudUiPanel::CopyConstructCore` -> `src/GameZRecoil/zUI/zui.cpp:17245`
- `0x4ba9e0` `HudUiPanel::ConstructorCopy` -> `src/GameZRecoil/zUI/zui.cpp:17294`
- `0x4babb0` `HudUiPanel::SetFont` -> `src/GameZRecoil/zUI/zui.cpp:17590`
- `0x4bb440` `HudUiPanel::GetLastTextPtr` -> `src/GameZRecoil/zUI/zui.cpp:17451`
- `0x4bc9b0` `HudUiTransitionTextPanel::SetFlashColorAndRate` -> `src/GameZRecoil/zUI/zui.cpp:11092`
...
- `0x4bcbe0` `HudUiTextLabel::CopyConstructor` -> `src/GameZRecoil/zUI/zui.cpp:16985`
- `0x4bcc80` `HudUiTextLabel::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:17007`

## Battlesport/HudUiTextStack4.cpp

- `0x4bd110` `HudUiTextStack4::SetFontAll` -> `src/GameZRecoil/zUI/zui.cpp:19203`
- `0x4bd160` `HudUiTextStack4::PushLine` -> `src/GameZRecoil/zUI/zui.cpp:18753`

## Battlesport/HudUiTransitionTextPanel.cpp

- `0x4bc9f0` `HudUiTransitionTextPanel::Update` -> `src/GameZRecoil/zUI/zui.cpp:10976`

## Battlesport/HudUiTriplet.cpp

- `0x40d1e0` `HudUiTriplet::StaticInitWndClassNameAndRegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:802`
- `0x40d1f0` `HudUiTriplet::ConstructWndClassName` -> `src/GameZRecoil/zUI/zui.cpp:813`
- `0x40d200` `HudUiTriplet::RegisterWndClassNameDtorAtExit` -> `src/GameZRecoil/zUI/zui.cpp:823`
- `0x40d210` `HudUiTriplet::DestroyWndClassName` -> `src/GameZRecoil/zUI/zui.cpp:833`
- `0x40e070` `HudUiTriplet::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:18417`
- `0x40e140` `HudUiTriplet::RebuildDisplay` -> `src/GameZRecoil/zUI/zui.cpp:18455`
- `0x40e590` `HudUiTriplet::AddEntry` -> `src/GameZRecoil/zUI/zui.cpp:18620`
- `0x40e800` `HudUiTriplet::UpdateEntryData` -> `src/GameZRecoil/zUI/zui.cpp:18653`
- `0x40e880` `HudUiTriplet::RemoveEntry` -> `src/GameZRecoil/zUI/zui.cpp:18676`
- `0x40e910` `HudUiTriplet::InterpolateLayout` -> `src/GameZRecoil/zUI/zui.cpp:14914`
- `0x40ea60` `HudUiTriplet::IsLocalPlayerFirstEntry` -> `src/GameZRecoil/zUI/zui.cpp:18706`

## Battlesport/HudUiZrdWidget.cpp

- `0x40cf30` `HudUiCheckToggleWidget::DestructorCoreThunk` -> `src/GameZRecoil/zUI/zui.cpp:10392`
- `0x40cf40` `HudUiCycleSelectorWidget::DestructorCoreThunk` -> `src/GameZRecoil/zUI/zui.cpp:10767`
- `0x4b7020` `HudUiCheckToggleWidget::~HudUiCheckToggleWidget` -> `src/GameZRecoil/zUI/zui.cpp:10373`
- `0x4b7340` `HudUiCheckToggleWidget::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:10562`
- `0x4b7de0` `HudUiCycleSelectorWidget::~HudUiCycleSelectorWidget` -> `src/GameZRecoil/zUI/zui.cpp:10748`
...
- `0x408d20` `RecoilStateControls::StaticInitAndRegisterAtExit` -> `src/Battlesport/hud.cpp:3218`
- `0x408d30` `RecoilStateControls::StaticInit` -> `src/Battlesport/hud.cpp:3269`
- `0x408d40` `RecoilStateControls::RegisterAtExit` -> `src/Battlesport/hud.cpp:3278`
- `0x408d50` `RecoilStateControls::AtExitDestructor` -> `src/Battlesport/hud.cpp:3287`
- `0x408d60` `RecoilStateControls::RecoilStateControls` -> `src/Battlesport/hud.cpp:3296`
- `0x408d90` `RecoilStateControls::Destructor` -> `src/Battlesport/hud.cpp:3305`
- `0x408df0` `RecoilStateControls::OnTryBecomeCurrent` -> `src/Battlesport/hud.cpp:3319`
- `0x408ec0` `RecoilStateControls::OnDeactivate` -> `src/Battlesport/hud.cpp:3348`
- `0x408fa0` `RecoilStateControls::OnResume` -> `src/Battlesport/hud.cpp:3384`
- `0x408ff0` `RecoilStateControls::QueueEnter` -> `src/Battlesport/hud.cpp:3416`
...
- `0x406f60` `RecoilStateCheatCode::OnTryBecomeCurrent` -> `src/Battlesport/hud.cpp:3060`
- `0x407010` `RecoilStateCheatCode::OnDeactivate` -> `src/Battlesport/hud.cpp:3090`

## Battlesport/RecoilStateConfirmQuit.cpp

- `0x415880` `RecoilStateConfirmQuit::~RecoilStateConfirmQuit` -> `src/Battlesport/hud.cpp:3199`
...
- `0x408230` `zOpt::SetNetworkEnabled` -> `src/GameZRecoil/zGame/zgame_opt.c:2229`
- `0x408240` `zOpt::SetNetworkModemEnabled` -> `src/GameZRecoil/zGame/zgame_opt.c:2240`
- `0x408250` `zOpt::SetNetworkListenEnabled` -> `src/GameZRecoil/zGame/zgame_opt.c:2251`
- `0x408260` `zOpt::GetNetworkEnabled` -> `src/GameZRecoil/zGame/zgame_opt.c:2395`
- `0x408270` `zOpt::GetNetworkModemEnabled` -> `src/GameZRecoil/zGame/zgame_opt.c:2262`

## Battlesport/zopt.cpp

- `0x408360` `zOpt::GetHudTypeForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2364`
...
- `0x404e90` `Player::TickActiveCameraState` -> `src/Battlesport/hud.cpp:507`
- `0x405040` `Player::UpdateChaseCameraFromInput` -> `src/Battlesport/hud.cpp:586`
- `0x4057d0` `Player::UpdateTopDownCameraState` -> `src/Battlesport/hud.cpp:877`
- `0x405870` `Player::UpdateCameraFromStoredTargetTowardPlayer` -> `src/Battlesport/hud.cpp:908`
- `0x4059a0` `Player::UpdateFirstPersonCameraFromInput` -> `src/Battlesport/hud.cpp:955`
- `0x405ec0` `Player::ToggleSteeringModeAndResetMouseLook` -> `src/Battlesport/hud.cpp:1187`
- `0x405ee0` `Player::AdjustThirdPersonCameraByOffsetProbes` -> `src/Battlesport/hud.cpp:1200`
- `0x406110` `Player::AdjustThirdPersonCameraBySideProbes` -> `src/Battlesport/hud.cpp:1310`
- `0x4063f0` `Player::RestoreThirdPersonCameraFromObstructionState` -> `src/Battlesport/hud.cpp:1460`
- `0x406430` `Player::UnbindCurrentSaveStateIfSinglePlayer` -> `src/Battlesport/hud.cpp:1477`
- `0x406450` `Player::BindActiveGameStateAsCurrentSaveState` -> `src/Battlesport/hud.cpp:1493`
- `0x406470` `Player::UpdateCameraVariantFromCameraPos` -> `src/Battlesport/hud.cpp:1508`
- `0x406510` `Player::UpdateCameraVariantFromAnchor` -> `src/Battlesport/hud.cpp:1560`
- `0x406610` `Player::UpdateCameraWeatherFxEmitterVisibility` -> `src/Battlesport/hud.cpp:1620`
- `0x406730` `Player::FilterCameraProbeBlockingHits` -> `src/Battlesport/hud.cpp:1692`
- `0x4067a0` `Player::AdjustSubCameraFocusForObstruction` -> `src/Battlesport/hud.cpp:1737`
...
- `0x408300` `zOpt::SetReplicateMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2373`
- `0x408500` `zOpt::RenderSection_SetSize` -> `src/GameZRecoil/zGame/zgame_opt.c:2492`
- `0x408530` `zOpt::RenderSection_SetPosition` -> `src/GameZRecoil/zGame/zgame_opt.c:2456`
- `0x4085e0` `zOpt::DisplaySection_SetPosition` -> `src/GameZRecoil/zGame/zgame_opt.c:2551`
- `0x408620` `zOpt::DisplaySection_SetSize` -> `src/GameZRecoil/zGame/zgame_opt.c:2587`
- `0x408680` `zOpt::DisplaySection_SetBitsPerPixel` -> `src/GameZRecoil/zGame/zgame_opt.c:2639`
- `0x4086e0` `zOpt::WindowSection_SetSize` -> `src/GameZRecoil/zGame/zgame_opt.c:2674`
- `0x408700` `zOpt::WindowSection_SetPosition` -> `src/GameZRecoil/zGame/zgame_opt.c:2654`
...
- `0x407e20` `zOpt::SetGameControlOptions` -> `src/GameZRecoil/zGame/zgame_opt.c:1887`
- `0x407e30` `zOpt::SetThrottleMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1898`
- `0x407e50` `zOpt::GetThrottleMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1913`
- `0x407e60` `zOpt::SetSteeringMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1922`
- `0x407e80` `zOpt::GetSteeringMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1937`
- `0x407e90` `zOpt::SetCursorMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1946`
- `0x407eb0` `zOpt::GetCursorMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1961`
- `0x407ec0` `zOpt::SetCameraMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1970`
- `0x407ef0` `zOpt::GetCameraModeAsPlayerCameraState` -> `src/GameZRecoil/zGame/zgame_opt.c:1987`
- `0x4081a0` `zOpt::SetGraphicsFlagsForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2188`
- `0x4081f0` `zOpt::GetGraphicsFlagsForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2179`

## GameZRecoil/zGame/zopt.c

- `0x407190` `zOpt::LookupNamedValueAsInt` -> `src/GameZRecoil/zGame/zgame_opt.c:1683`
- `0x4071f0` `zOpt::ReadScalarValueAsInt` -> `src/GameZRecoil/zGame/zgame_opt.c:1706`
- `0x407220` `zOpt::EvalIntCompareOp` -> `src/GameZRecoil/zGame/zgame_opt.c:1828`
- `0x407470` `zOpt::EvaluateProfileMetricCondition` -> `src/GameZRecoil/zGame/zgame_opt.c:1727`
- `0x407680` `zOpt::SelectProfileValueForSystem` -> `src/GameZRecoil/zGame/zgame_opt.c:1792`

## GameZRecoil/zHud/HudUiBackground.cpp

- `0x4b9850` `HudUiBackground::SetEnabled` -> `src/GameZRecoil/zUI/zui.cpp:8300`

## GameZRecoil/zhud_ui.cpp

- `0x410d10` `HudUiMgrSensor::SetViewportRect` -> `src/GameZRecoil/zUI/zui.cpp:3640`
...
- `0x42a4e0` `zInput::BindMap_GetCommandLabel` -> `src/GameZRecoil/zInput/zInput.cpp:1227`
- `0x42a4f0` `zInput::BindMap_GetCommandHint` -> `src/GameZRecoil/zInput/zInput.cpp:1240`

## GameZRecoil/zInput/zin_cmd.cpp

- `0x42a000` `zInput_BindGroupInfo::Destroy` -> `src/GameZRecoil/zInput/zInput.cpp:1060`
- `0x42a2c0` `zInput::BindGroupList_AddCommandToGroup` -> `src/GameZRecoil/zInput/zInput.cpp:1121`
- `0x42a480` `zInput::BindGroupList_GetCount` -> `src/GameZRecoil/zInput/zInput.cpp:1160`
- `0x42a4a0` `zInput::BindGroupList_GetGroupTitle` -> `src/GameZRecoil/zInput/zInput.cpp:1176`
- `0x42a4b0` `zInput::BindGroupList_GetGroupCommandCount` -> `src/GameZRecoil/zInput/zInput.cpp:1191`
- `0x42a4d0` `zInput::BindGroupList_GetGroupCommandId` -> `src/GameZRecoil/zInput/zInput.cpp:1211`
- `0x42a9d0` `zInput_BindGroupInfoVec::Count` -> `src/GameZRecoil/zInput/zInput.cpp:1359`

## GameZRecoil/zInput/zin_ff.cpp

- `0x42f9f0` `zInput_DI_InitForceFeedbackEffectSet` -> `src/GameZRecoil/zInput/zInput.cpp:1412`
- `0x42fa80` `zInput_DI_IsForceFeedbackEnabled` -> `src/GameZRecoil/zInput/zInput.cpp:1445`
- `0x42faa0` `zInput_DI_RestartPrimaryFireEffect` -> `src/GameZRecoil/zInput/zInput.cpp:1459`
- `0x42fac0` `zInput_DI_PlayAltFireEffect` -> `src/GameZRecoil/zInput/zInput.cpp:1479`
- `0x42fb50` `zInputDI::PlayCollisionImpactEffect` -> `src/GameZRecoil/zInput/zInput.cpp:1517`
- `0x42fc90` `zInputDI::PlayDamageHitEffect` -> `src/GameZRecoil/zInput/zInput.cpp:1549`
- `0x42fdc0` `zInput_DI_UpdateSteerAndPitchForceEffects` -> `src/GameZRecoil/zInput/zInput.cpp:1615`
- `0x42ffa0` `zInput_DI_CreateConstantForceEffectScaled` -> `src/GameZRecoil/zInput/zInput.cpp:1822`
- `0x430070` `zInput_DI_CreateConstantForceEffectWithDirection` -> `src/GameZRecoil/zInput/zInput.cpp:1850`
- `0x430100` `zInput_DI_CreateSineEffectScaled` -> `src/GameZRecoil/zInput/zInput.cpp:1877`
...
- `0x429f10` `zInput::BindGroupList_StaticInitAndRegisterAtExit` -> `src/GameZRecoil/zInput/zInput.cpp:946`
- `0x429f20` `zInput::BindGroupListStaticInit` -> `src/GameZRecoil/zInput/zInput.cpp:960`
- `0x429f40` `zInput::BindGroupListRegisterAtExit` -> `src/GameZRecoil/zInput/zInput.cpp:979`
- `0x429f50` `zInput::BindGroupListAtExitDestructor` -> `src/GameZRecoil/zInput/zInput.cpp:989`
...
- `0x471b20` `zInput::OnAppActivate` -> `src/GameZRecoil/zInput/zin_init.cpp:131`
- `0x471b50` `zInput::Init` -> `src/GameZRecoil/zInput/zin_init.cpp:153`
- `0x471c10` `zInput::Shutdown` -> `src/GameZRecoil/zInput/zin_init.cpp:199`
- `0x471c60` `zInput::Mouse_IsUnsuspended` -> `src/GameZRecoil/zInput/zin_init.cpp:237`
- `0x471c70` `zInput::Joystick_IsUnsuspended` -> `src/GameZRecoil/zInput/zin_init.cpp:247`
- `0x471c80` `zInput_Keyboard_IsUnsuspended` -> `src/GameZRecoil/zInput/zin_init.cpp:267`
- `0x471c90` `zInput::Mouse_ResumeFromSuspend` -> `src/GameZRecoil/zInput/zin_init.cpp:340`
- `0x471cb0` `zInput::Joystick_ResumeFromSuspend` -> `src/GameZRecoil/zInput/zin_init.cpp:357`
- `0x471cd0` `zInput::Keyboard_ResumeFromSuspend` -> `src/GameZRecoil/zInput/zin_init.cpp:374`
- `0x471cf0` `zInput::Mouse_Suspend` -> `src/GameZRecoil/zInput/zin_init.cpp:391`
- `0x471d00` `zInput::Joystick_Suspend` -> `src/GameZRecoil/zInput/zin_init.cpp:400`
- `0x471d10` `zInput::Keyboard_Suspend` -> `src/GameZRecoil/zInput/zin_init.cpp:409`
- `0x471d20` `zInput::Keyboard_AddRef` -> `src/GameZRecoil/zInput/zin_init.cpp:418`
- `0x471d50` `zInput::DI_AddJoystickRef` -> `src/GameZRecoil/zInput/zin_init.cpp:435`
- `0x471d80` `zInput::DI_ReleaseJoystickRef` -> `src/GameZRecoil/zInput/zin_init.cpp:452`
- `0x471da0` `zInput::Mouse_AddRef` -> `src/GameZRecoil/zInput/zin_init.cpp:467`
- `0x471dd0` `zInput::DI_GetJoystickRefCount` -> `src/GameZRecoil/zInput/zin_init.cpp:484`

## GameZRecoil/zInput/zin_joystick.cpp

- `0x42e170` `zInput::DI_SetJoystickEnabled` -> `src/GameZRecoil/zInput/zInput.cpp:1375`
...
- `0x4710a0` `zInput::BindMapSystem_Init` -> `src/GameZRecoil/zInput/zInput.cpp:2601`
- `0x471660` `zInput::BindMapSystem_Shutdown` -> `src/GameZRecoil/zInput/zInput.cpp:2782`
...
- `0x408120` `zOpt::SetPlayerName` -> `src/GameZRecoil/zGame/zgame_opt.c:2151`
- `0x408190` `zOpt::GetPlayerName` -> `src/GameZRecoil/zGame/zgame_opt.c:2736`
- `0x4082a0` `zOpt::SetFullscreenOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2326`
- `0x408330` `zOpt::GetFullscreenOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2337`
- `0x408650` `zOpt::GetDisplaySection` -> `src/GameZRecoil/zGame/zgame_opt.c:2281`
- `0x408690` `zOpt::GetDisplaySectionBitsPerPixel` -> `src/GameZRecoil/zGame/zgame_opt.c:2290`
- `0x4086a0` `zOpt::GetVideoStrideValue` -> `src/GameZRecoil/zGame/zgame_opt.c:2299`
- `0x4086c0` `zOpt::GetWindowSection` -> `src/GameZRecoil/zGame/zgame_opt.c:2308`
- `0x4086d0` `zOpt::GetWindowSectionHeight` -> `src/GameZRecoil/zGame/zgame_opt.c:2317`
...
- `0x4b33f0` `zSys::HasCpuidSupport` -> `src/GameZRecoil/zSys/zSys.cpp:259`
...
- `0x4b3510` `zSys::ProbeDivZeroFlagBehavior` -> `src/GameZRecoil/zSys/zSys.cpp:422`
- `0x4b3510` `zSys::ProbeDivZeroFlagBehavior` -> `src/GameZRecoil/zSys/zsys_cpu_asm.inl:359`
- `0x4b3550` `zSys::DetectIs8086ByEflagsHiBits` -> `src/GameZRecoil/zSys/zSys.cpp:430`
- `0x4b3550` `zSys::DetectIs8086ByEflagsHiBits` -> `src/GameZRecoil/zSys/zsys_cpu_asm.inl:385`
- `0x4b35a0` `zSys::DetectIs80286ByEflagsHiBits` -> `src/GameZRecoil/zSys/zSys.cpp:438`
- `0x4b35a0` `zSys::DetectIs80286ByEflagsHiBits` -> `src/GameZRecoil/zSys/zsys_cpu_asm.inl:414`
- `0x4b35f0` `zSys::DetectIs80386ByAcFlag` -> `src/GameZRecoil/zSys/zSys.cpp:446`
- `0x4b35f0` `zSys::DetectIs80386ByAcFlag` -> `src/GameZRecoil/zSys/zsys_cpu_asm.inl:442`
- `0x4b3640` `zSys::ReadCpuidVendorAndFamily` -> `src/GameZRecoil/zSys/zSys.cpp:267`
...
- `0x40cf50` `HudUiFillBitmap::DestructorCoreThunk` -> `src/GameZRecoil/zUI/zui.cpp:11392`
- `0x4b84d0` `HudUiFillBitmap::~HudUiFillBitmap` -> `src/GameZRecoil/zUI/zui.cpp:11371`
...
- `0x401d50` `AINet::HasLineOfSightFromLocalPlayerFxOffset` -> `src/Battlesport/ai_net.h:1453`
- `0x401e50` `AINet::HasLineOfSightFromCameraTarget` -> `src/Battlesport/ai_net.h:1519`
- `0x402080` `AINet::AiRestoreSavedTopLevelState` -> `src/Battlesport/ai_net.h:1638`
- `0x402f10` `AINet::AiFinalizeMode2State1ForAllPlayers` -> `src/Battlesport/ai_net.h:2239`
...
- `0x404e80` `zError::ReportOldNoOp` -> `src/Battlesport/hud.cpp:477`
- `0x405650` `Player::UpdateThirdPersonCamera` -> `src/Battlesport/hud.cpp:810`
- `0x405c90` `Player::ApplyCameraState` -> `src/Battlesport/hud.cpp:1048`
...
- `0x4076f0` `zGame::ReturnOnlyStub` -> `src/GameZRecoil/zGame/zgame_opt.c:807`
- `0x407700` `zGame::Options_LoadGameOptions` -> `src/GameZRecoil/zGame/zgame_opt.c:1186`
- `0x407e00` `zGame::Options_SaveGameOptions` -> `src/GameZRecoil/zGame/zgame_opt.c:1127`
- `0x407f10` `zOpt::SetGameDifficultyMode` -> `src/GameZRecoil/zGame/zgame_opt.c:1996`
- `0x407f20` `zOpt::GetGameDifficultyMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2007`
- `0x407f30` `zOpt::SetEffectsLevelForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2016`
- `0x407f80` `zOpt::GetEffectsLevelForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2034`
- `0x407fa0` `zOpt::SetObjectLODForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2042`
- `0x408030` `zOpt::GetObjectLODForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2069`
- `0x408050` `zOpt::SetMuteSoundOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2085`
- `0x408060` `zOpt::GetMuteSoundOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2077`
- `0x408070` `zOpt::SetSoundVolumeOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2096`
- `0x408090` `zOpt::GetSoundVolumeOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2107`
...
- `0x4080c0` `zOpt::SetSoundLODOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2115`
- `0x4080d0` `zOpt::GetSoundLODOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2125`
- `0x4080e0` `zOpt::SetTextureMemoryForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2133`
- `0x408100` `zOpt::GetTextureMemoryForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2143`
...
- `0x4082b0` `zOpt::SetHudVisibilityOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2346`
- `0x4082d0` `zOpt::SetHudTypeForCurrentHwMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2211`
...
- `0x408340` `zOpt::GetHudVisibilityOption` -> `src/GameZRecoil/zGame/zgame_opt.c:2356`
- `0x408380` `zOpt::GetReplicateMode` -> `src/GameZRecoil/zGame/zgame_opt.c:2388`
- `0x4083d0` `zOpt_ViewRectSection::SetPosition` -> `src/GameZRecoil/zGame/zgame_opt.c:2404`
- `0x408400` `zOpt_ViewRectSection::SetSize` -> `src/GameZRecoil/zGame/zgame_opt.c:2420`
- `0x408430` `zOpt::ViewRectSection_ClampPointToInclusiveBounds` -> `src/GameZRecoil/zGame/zgame_opt.c:2436`
- `0x408480` `zOpt::CameraSection_SetActiveCamera` -> `src/GameZRecoil/zGame/zgame_opt.c:2694`
- `0x4084e0` `zOpt_CameraSection_GetActiveCamera` -> `src/GameZRecoil/zGame/zgame_opt.c:2725`
- `0x408570` `zOpt::RenderSection_SetTargetWindow` -> `src/GameZRecoil/zGame/zgame_opt.c:2522`
- `0x4085a0` `zOpt::GetRenderSection` -> `src/GameZRecoil/zGame/zgame_opt.c:2544`
- `0x4085b0` `zOpt::DisplaySection_SetTargetDisplay` -> `src/GameZRecoil/zGame/zgame_opt.c:2617`
- `0x408660` `zOpt_DisplaySection_GetWidth` -> `src/GameZRecoil/zGame/zgame_opt.c:2753`
- `0x408670` `zOpt_DisplaySection_GetHeight` -> `src/GameZRecoil/zGame/zgame_opt.c:2761`
- `0x4086b0` `zVid::GetVideoModeIndexFromOptions` -> `src/GameZRecoil/zVideo/zvid_main.c:2790`
- `0x408a10` `zOpt::SetWolPasswordFlag` -> `src/GameZRecoil/zGame/zgame_opt.c:2271`
- `0x408a20` `zOpt_GetWolPasswordFlagValue` -> `src/GameZRecoil/zGame/zgame_opt.c:2745`
- `0x408f50` `RecoilStateDialogHost::OnSuspend` -> `src/Battlesport/recoil_state_dialog_host_body.h:85`
- `0x409010` `HudUiZrdWidgetEx17C::EnableChildAtIndex` -> `src/GameZRecoil/zUI/zui.cpp:11930`
- `0x409160` `HudUiCreditsBackButton::OnActivate` -> `src/Battlesport/hud.cpp:2806`
- `0x409180` `HudUiCreditsQuitButton::OnActivate` -> `src/Battlesport/hud.cpp:2815`
- `0x4091c0` `HudUiCreditsPanel::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:7751`
- `0x4091e0` `HudUiZrdScrollingText::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:7344`
- `0x4092a0` `HudUiCreditsPanel::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:7718`
- `0x4092a0` `HudUiCreditsPanel::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:7728`
- `0x409360` `HudUiZrdScrollingText::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:7672`
- `0x409380` `HudUiCreditsPanel::UpdateFadeAndExit` -> `src/GameZRecoil/zUI/zui.cpp:7689`
- `0x409410` `HudUiZrdScrollingText::Update` -> `src/GameZRecoil/zUI/zui.cpp:7605`
- `0x409470` `HudUiZrdScrollingText::UpdateScrollPositions` -> `src/GameZRecoil/zUI/zui.cpp:7627`
- `0x409550` `HudUiZrdScrollingText::OnActivateResetOwnerFade` -> `src/GameZRecoil/zUI/zui.cpp:7416`
- `0x409570` `HudUiZrdScrollingText::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:7425`
- `0x409950` `RecoilStateCredits::StaticInitAndRegisterAtExit` -> `src/Battlesport/recoil_state_credits_body.h:36`
- `0x409970` `RecoilStateCredits::StaticInit` -> `src/Battlesport/recoil_state_credits_body.h:60`
- `0x409980` `RecoilStateCredits::RegisterAtExit` -> `src/Battlesport/recoil_state_credits_body.h:72`
- `0x409990` `RecoilStateCredits::RecoilStateCredits` -> `src/Battlesport/recoil_state_credits_body.h:26`
- `0x4099a0` `RecoilStateDialogHost::OnWndActivate` -> `src/Battlesport/recoil_state_dialog_host_body.h:10`
- `0x4099f0` `RecoilStateCredits::~RecoilStateCredits` -> `src/Battlesport/recoil_state_credits_body.h:103`
- `0x409a60` `RecoilStateCredits::OnTryBecomeCurrent` -> `src/Battlesport/recoil_state_credits_body.h:85`
- `0x409ad0` `RecoilStateDialogHost::OnDeactivate` -> `src/Battlesport/recoil_state_dialog_host_body.h:65`
- `0x409b00` `RecoilStateCredits::QueuePush` -> `src/Battlesport/recoil_state_credits_body.h:122`
- `0x409b20` `HudUiPanelSpan::DestroyAndFree` -> `src/GameZRecoil/zUI/zui.cpp:8142`
- `0x409ef0` `HudUiPanel::DestructorCallback` -> `src/GameZRecoil/zUI/zui.cpp:7661`
- `0x40a590` `HudUiPanel::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:17531`
- `0x40bdf0` `StdPtrVector::ClearNoOpDestroy` -> `src/GameZRecoil/zUI/zui.cpp:12038`
- `0x40be90` `HudUiPanel::Invalidate` -> `src/GameZRecoil/zUI/zui.cpp:17481`
- `0x40bea0` `HudUiPanel::GetFont` -> `src/GameZRecoil/zUI/zui.cpp:17490`
- `0x40beb0` `HudUiPanel::SetFontHandle` -> `src/GameZRecoil/zUI/zui.cpp:17498`
- `0x40bec0` `HudUiPanel::EnableWordWrapWithRect` -> `src/GameZRecoil/zUI/zui.cpp:17508`
- `0x40bf20` `HudCmdBindingEntry::DeleteAndReturnNull` -> `src/GameZRecoil/zUI/zui.cpp:12084`
- `0x40bf80` `HudCmdBindButtonBase::AddBindingEntry` -> `src/GameZRecoil/zUI/zui.cpp:12100`
- `0x40c1d0` `HudCmdBindButtonBase::ClearBindingEntries` -> `src/GameZRecoil/zUI/zui.cpp:12263`
- `0x40c370` `zSys::ProbePlatformAndVideoCaps` -> `src/GameZRecoil/zSys/zsys_probe_platform.inl:2`
- `0x40c9c0` `HudUiOptionsPanel_Lighting::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12903`
- `0x40c9c0` `HudUiOptionsPanel_Lighting::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12914`
- `0x40c9e0` `HudUiOptionsPanel_Lighting::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12922`
- `0x40ca20` `HudUiOptionsPanel_Perspective::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12945`
- `0x40ca20` `HudUiOptionsPanel_Perspective::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12956`
- `0x40ca40` `HudUiOptionsPanel_Perspective::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12964`
- `0x40ca80` `HudUiOptionsPanel_FullHud::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12977`
- `0x40ca80` `HudUiOptionsPanel_FullHud::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:12988`
- `0x40caa0` `HudUiCheckToggleWidget::OnActivateThunk` -> `src/GameZRecoil/zUI/zui.cpp:10554`
- `0x40cab0` `HudUiOptionsPanel_ObjectDetail::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13007`
- `0x40cab0` `HudUiOptionsPanel_ObjectDetail::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13018`
- `0x40cad0` `HudUiOptionsPanel_ObjectDetail::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13026`
- `0x40cad0` `HudUiOptionsPanel_ObjectDetail::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13035`
- `0x40caf0` `HudUiOptionsPanel_TextureMemory::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13043`
- `0x40caf0` `HudUiOptionsPanel_TextureMemory::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13053`
- `0x40cb10` `HudUiOptionsPanel_TextureMemory::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13061`
- `0x40cb10` `HudUiOptionsPanel_TextureMemory::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13070`
- `0x40cb30` `HudUiOptionsPanel_Effects::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13078`
- `0x40cb30` `HudUiOptionsPanel_Effects::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13088`
- `0x40cb70` `HudUiOptionsPanel_Effects::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13107`
- `0x40cb70` `HudUiOptionsPanel_Effects::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13116`
- `0x40cb90` `HudUiOptionsPanel_SoundActive::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13124`
- `0x40cb90` `HudUiOptionsPanel_SoundActive::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13134`
- `0x40cbb0` `HudUiOptionsPanel_SoundActive::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13142`
- `0x40cbb0` `HudUiOptionsPanel_SoundActive::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13151`
- `0x40cbd0` `HudUiOptionsPanel_SoundQuality::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13159`
- `0x40cbd0` `HudUiOptionsPanel_SoundQuality::InitFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13169`
- `0x40cbf0` `HudUiOptionsPanel_SoundQuality::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13177`
- `0x40cc10` `HudUiOptionsPanel_SoundVolume::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13186`
- `0x40cc10` `HudUiOptionsPanel_SoundVolume::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13196`
- `0x40cc30` `HudUiOptionsPanel_SoundVolume::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13204`
- `0x40cc60` `HudUiOptionsPanel_MusicEnable::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13214`
- `0x40cc60` `HudUiOptionsPanel_MusicEnable::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13224`
- `0x40cc80` `HudUiOptionsPanel_MusicEnable::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13232`
- `0x40ccc0` `HudUiOptionsPanel_MusicVolume::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13250`
- `0x40ccc0` `HudUiOptionsPanel_MusicVolume::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13260`
- `0x40cd00` `HudUiOptionsPanel_MusicVolume::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13274`
- `0x40cd30` `HudUiOptionsPanel_Resolution::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13287`
- `0x40cd30` `HudUiOptionsPanel_Resolution::SyncFromOptions` -> `src/GameZRecoil/zUI/zui.cpp:13297`
- `0x40ce80` `HudUiOptionsPanel_Resolution::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:13401`
- `0x40cf30` `HudUiCheckToggleWidget::DestructorCoreThunk` -> `src/GameZRecoil/zUI/zui.cpp:10403`
- `0x40cf40` `HudUiCycleSelectorWidget::DestructorCoreThunk` -> `src/GameZRecoil/zUI/zui.cpp:10778`
- `0x40cf50` `HudUiFillBitmap::DestructorCoreThunk` -> `src/GameZRecoil/zUI/zui.cpp:11403`
- `0x40d270` `HudLayoutSW::GlobalInit` -> `src/GameZRecoil/zUI/zui.cpp:895`
- `0x40d280` `HudLayoutSW::RegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:903`
- `0x40d290` `HudLayoutSW::AtExitDestructor` -> `src/GameZRecoil/zUI/zui.cpp:911`
- `0x40d2a0` `HudLayoutSW::GlobalDestructor` -> `src/GameZRecoil/zUI/zui.cpp:919`
- `0x40d2f0` `HudLayoutHW::CrtInitGlobalSingleton` -> `src/GameZRecoil/zUI/zui.cpp:1001`
- `0x40d300` `HudLayoutHW::GlobalInit` -> `src/GameZRecoil/zUI/zui.cpp:964`
- `0x40d310` `HudLayoutHW::RegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:972`
- `0x40d320` `HudLayoutHW::AtExitDestructor` -> `src/GameZRecoil/zUI/zui.cpp:980`
- `0x40d3b0` `HudLayoutBase::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:852`
- `0x40d410` `HudUiMgr::StaticInit` -> `src/GameZRecoil/zUI/zui.cpp:4464`
- `0x40d420` `HudUiMgr::RegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:4472`
- `0x40d430` `HudUiMgr::AtExitDestructor` -> `src/GameZRecoil/zUI/zui.cpp:4480`
- `0x40d440` `HudUiMgr::StaticDestructor` -> `src/GameZRecoil/zUI/zui.cpp:4488`
- `0x40d590` `HudUiMessage::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:15812`
- `0x40d600` `HudUiTripletPanel::UnwindDestructFirstItem` -> `src/GameZRecoil/zUI/zui.cpp:14893`
- `0x40d610` `HudUiTripletPanel::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:14901`
- `0x40d660` `HudUiMgrObjectiveBlock::~HudUiMgrObjectiveBlock` -> `src/GameZRecoil/zUI/zui.cpp:15305`
- `0x40d660` `HudUiMgrObjectiveBlock::~HudUiMgrObjectiveBlock` -> `src/GameZRecoil/zUI/zui.cpp:15313`
- `0x40d6e0` `HudUiMgrSensorBlock::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:15324`
- `0x40d780` `HudUiSlot::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:15339`
- `0x40d9d0` `HudUiContainer::SetEnabled` -> `src/GameZRecoil/zUI/zui.cpp:7133`
- `0x40d9e0` `HudUiMeter::ConstructorEx` -> `src/GameZRecoil/zUI/zui.cpp:16930`
- `0x40da00` `HudUiMessage::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:15790`
- `0x40daa0` `HudUiMessage::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:15822`
- `0x40dac0` `HudUiCounter::HudUiCounter` -> `src/GameZRecoil/zUI/zui.cpp:15446`
- `0x40db20` `HudUiSlot::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:15348`
- `0x40db90` `HudUiSlot::Draw` -> `src/GameZRecoil/zUI/zui.cpp:15362`
- `0x40dbd0` `HudUiSlot::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:15376`
- `0x40e010` `HudUiPanel::SetTextColorsAndMarkDirty` -> `src/GameZRecoil/zUI/zui.cpp:17561`
- `0x40e040` `HudUiPanel::SetShadow` -> `src/GameZRecoil/zUI/zui.cpp:17574`
- `0x40ec90` `HudLayoutBase::Shutdown_Stub` -> `src/GameZRecoil/zUI/zui.cpp:794`
- `0x40eca0` `HudUiTimerPanel::SetRunning` -> `src/GameZRecoil/zUI/zui.cpp:18184`
- `0x40ecc0` `HudUiTimerPanel::SetElapsedSeconds` -> `src/GameZRecoil/zUI/zui.cpp:18195`
- `0x40ece0` `HudUiTimerPanel::SetSeconds` -> `src/GameZRecoil/zUI/zui.cpp:18206`
- `0x40ed10` `HudUiTimerPanel::GetSeconds` -> `src/GameZRecoil/zUI/zui.cpp:18219`
- `0x40ed20` `HudUiTimerPanel::Update` -> `src/GameZRecoil/zUI/zui.cpp:18228`
- `0x40ed80` `HudUiTimerPanel::ConstructorDefault` -> `src/GameZRecoil/zUI/zui.cpp:18281`
- `0x40ee60` `HudUiTimerPanel::UpdateHMSFromSeconds` -> `src/GameZRecoil/zUI/zui.cpp:18162`
- `0x40ef00` `HudUiTimerPanel::SetTimeSeconds` -> `src/GameZRecoil/zUI/zui.cpp:18138`
- `0x40ef60` `HudUiTimerPanelFloat::ConstructorDefault` -> `src/GameZRecoil/zUI/zui.cpp:19360`
- `0x40f040` `HudUiTimerPanelFloat::Draw` -> `src/GameZRecoil/zUI/zui.cpp:19346`
- `0x40f070` `HudUiCounter::ApplyFromLayoutNode` -> `src/GameZRecoil/zUI/zui.cpp:15470`
- `0x40f0f0` `HudUiCounter::ReleaseStateImages` -> `src/GameZRecoil/zUI/zui.cpp:15456`
- `0x40f130` `HudUiCounter::UpdateLayoutPosition` -> `src/GameZRecoil/zUI/zui.cpp:15494`
- `0x40f1a0` `HudUiMgr::SetModeCounterState` -> `src/GameZRecoil/zUI/zui.cpp:5212`
- `0x40f200` `HudUiTripletPanel::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:14719`
- `0x40f2b0` `HudUiTripletPanel::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:14743`
- `0x40f2d0` `HudUiWidget::HudUiWidget` -> `src/GameZRecoil/zUI/zui.cpp:14537`
- `0x40f2d0` `HudUiWidget::HudUiWidget` -> `src/GameZRecoil/zUI/zui.cpp:14545`
- `0x40f3e0` `HudUiTripletPanel::ShutdownItems_Stub` -> `src/GameZRecoil/zUI/zui.cpp:14883`
- `0x40f400` `HudUiTripletPanel::Draw` -> `src/GameZRecoil/zUI/zui.cpp:14758`
- `0x40f460` `HudUiTripletPanel::SetVisibleCount` -> `src/GameZRecoil/zUI/zui.cpp:14778`
- `0x40f4c0` `HudUiMgr::InitHudLayouts / InitHudLayouts` -> `src/GameZRecoil/zUI/zui.cpp:5860`
- `0x40f9e0` `HudUiPanel::SetTextColor` -> `src/GameZRecoil/zUI/zui.cpp:17547`
- `0x40fa10` `HudUiStatsListElement::Update` -> `src/GameZRecoil/zUI/zui.cpp:15391`
- `0x40fa20` `HudUiStatsListElement::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:15416`
- `0x40fa40` `HudUiStatsListElement::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:15401`
- `0x40fab0` `HudUiPanelSimple::ConstructorDefaultThunk` -> `src/GameZRecoil/zUI/zui.cpp:18126`
- `0x40fac0` `HudUiPanelSimple::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:18094`
- `0x40fb70` `HudUiMeter::HudUiMeter` -> `src/GameZRecoil/zUI/zui.cpp:16921`
- `0x40fb90` `HudUiTimerPanel::ZarWriteTimerDataCallback` -> `src/GameZRecoil/zUI/zui.cpp:18264`
- `0x40fbb0` `HudUiTimerPanel::ZarReadTimerData` -> `src/GameZRecoil/zUI/zui.cpp:18248`
- `0x40fbd0` `HudUiMgr::ShutdownResources` -> `src/GameZRecoil/zUI/zui.cpp:5998`
- `0x40fdd0` `HudUiStringMenu::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:15431`
- `0x40fe90` `HudUiTopMessageStack::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:19291`
- `0x40fef0` `HudUiChatMessageStack::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:19338`
- `0x410140` `HudUiMgr::TickLayoutDelay` -> `src/GameZRecoil/zUI/zui.cpp:4582`
- `0x410ed0` `HudUiMgr::DisableHud` -> `src/GameZRecoil/zUI/zui.cpp:5492`
- `0x411270` `HudUiMgr::UpdateTargetReticleFromCursor` -> `src/GameZRecoil/zUI/zui.cpp:5261`
- `0x411710` `HudUiMgr::ReticleStaticAtexitStub` -> `src/GameZRecoil/zUI/zui.cpp:5230`
- `0x411720` `HudUiMgr::CopyReticleProjection` -> `src/GameZRecoil/zUI/zui.cpp:5236`
- `0x411740` `HudUiMgr::SetReticleMode` -> `src/GameZRecoil/zUI/zui.cpp:5251`
- `0x411750` `HudUiMgr::SetNanitePanelCount` -> `src/GameZRecoil/zUI/zui.cpp:5202`
- `0x411eb0` `HudUiMgrObjective::Update` -> `src/GameZRecoil/zUI/zui.cpp:4093`
- `0x4126e0` `HudUiMessage::SelectVariantDisplay` -> `src/GameZRecoil/zUI/zui.cpp:15648`
- `0x412790` `HudUiMessage::ApplySideImageSwap` -> `src/GameZRecoil/zUI/zui.cpp:15680`
- `0x4127d0` `HudUiMessage::ClearDisplay` -> `src/GameZRecoil/zUI/zui.cpp:15695`
- `0x412b60` `HudLayoutSW::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:882`
- `0x412bd0` `HudLayoutBase::SetActive` -> `src/GameZRecoil/zUI/zui.cpp:861`
- `0x412be0` `HudLayoutBase::UpdateAll` -> `src/GameZRecoil/zUI/zui.cpp:1078`
- `0x412bf0` `HudLayoutBase::Enable` -> `src/GameZRecoil/zUI/zui.cpp:1099`
- `0x412c00` `HudLayoutBase::Disable` -> `src/GameZRecoil/zUI/zui.cpp:1107`
- `0x412ea0` `HudLayoutHW::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:940`
- `0x413080` `HudLayoutHW::ReleaseImages` -> `src/GameZRecoil/zUI/zui.cpp:1311`
- `0x413630` `HudUiMgr::TriggerCurrentLayoutOnActivated` -> `src/GameZRecoil/zUI/zui.cpp:4572`
- `0x413730` `HudUiMgr::DestroySensorWindow` -> `src/GameZRecoil/zUI/zui.cpp:5453`
- `0x4137c0` `HudUiAuxOverlay::ClearTextLines` -> `src/GameZRecoil/zUI/zui.cpp:4229`
- `0x4137f0` `HudUiAuxOverlay::ApplyTextLineOp` -> `src/GameZRecoil/zUI/zui.cpp:4197`
- `0x413910` `HudUiMgr::EnableTopAndChatStacks` -> `src/GameZRecoil/zUI/zui.cpp:5838`
- `0x413950` `HudUiMgr::DisableTopAndChatStacks` -> `src/GameZRecoil/zUI/zui.cpp:5849`
- `0x413ec0` `HudUiMessage::LoadWeaponLayoutFromNode` -> `src/GameZRecoil/zUI/zui.cpp:15574`
- `0x413ff0` `HudUiMessage::ReleaseImages` -> `src/GameZRecoil/zUI/zui.cpp:15626`
- `0x414180` `HudUiLoadingCheckpoint::AdvanceAndLog` -> `src/GameZRecoil/zUI/zui.cpp:4121`
- `0x414210` `HudUiLoadingCheckpoint::InitTable` -> `src/GameZRecoil/zUI/zui.cpp:4156`
- `0x414300` `HudUiMgrSensor::GetFxRect` -> `src/GameZRecoil/zUI/zui.cpp:3692`
- `0x414330` `GameNet::ShowPlayerKillMessage` -> `src/Battlesport/game_net_body.h:3203`
- `0x414390` `GameNet::RefreshPlayerListMenu` -> `src/Battlesport/game_net_body.h:3339`
- `0x4143b0` `HudUi::RefreshScoreboardEntryRow` -> `src/GameZRecoil/zUI/zui.cpp:19138`
- `0x4143d0` `GameNet::BeginChatCompose` -> `src/Battlesport/game_net_body.h:1951`
- `0x414550` `GameNet::ChatComposeKeyCallback` -> `src/Battlesport/game_net_body.h:1930`
- `0x414590` `GameNet::EndChatComposeAndSend` -> `src/Battlesport/game_net_body.h:1991`
- `0x414660` `GameNet::EndChatComposeAndSendThunk` -> `src/Battlesport/game_net_body.h:2032`
...
- `0x414b50` `shared.authored_ret4_noop_414b50` -> `src/Battlesport/wol_download_body.h:71`
- `0x415100` `RecoilStateMainMenuTransition::StaticInitAndRegisterAtExit` -> `src/Battlesport/recoil_state_main_menu_transition_body.h:38`
- `0x415110` `RecoilStateMainMenuTransition::StaticInit` -> `src/Battlesport/recoil_state_main_menu_transition_body.h:49`
- `0x415120` `RecoilStateMainMenuTransition::RegisterAtExit` -> `src/Battlesport/recoil_state_main_menu_transition_body.h:59`
- `0x415130` `RecoilStateMainMenuTransition::AtExitDestructor` -> `src/Battlesport/recoil_state_main_menu_transition_body.h:69`
- `0x415170` `RecoilStateMainMenuTransition::RecoilStateMainMenuTransition` -> `src/Battlesport/recoil_state_main_menu_transition_body.h:25`
- `0x4151b0` `RecoilStateMainMenuTransition::~RecoilStateMainMenuTransition` -> `src/Battlesport/recoil_state_main_menu_transition_body.h:88`
...
- `0x4159d0` `zFMV_Action::Update` -> `src/GameZRecoil/zFMV/fmv_script.cpp:1562`
- `0x4159e0` `zFMV_Action::RunBlockingTimed` -> `src/GameZRecoil/zFMV/fmv_script.cpp:1595`
- `0x415aa0` `zFMV_Action::~zFMV_Action` -> `src/GameZRecoil/zFMV/fmv_script.cpp:1611`
...
- `0x41a190` `HudUiNumericTextInput::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:16298`
- `0x41a190` `HudUiNumericTextInput::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:16307`
- `0x41a200` `HudUiClampedIntTextInput::HudUiClampedIntTextInput` -> `src/GameZRecoil/zUI/zui.cpp:16322`
- `0x41a290` `HudUiNumericTextInput::OnAcceptForwardToCommit` -> `src/GameZRecoil/zUI/zui.cpp:16607`
- `0x41a2a0` `HudUiClampedIntTextInput::OnRawKeyboardChar` -> `src/GameZRecoil/zUI/zui.cpp:16615`
- `0x41a2a0` `HudUiClampedIntTextInput::OnRawKeyboardChar` -> `src/GameZRecoil/zUI/zui.cpp:16626`
- `0x41a2d0` `HudUiClampedIntTextInput::CommitAndGetValue` -> `src/GameZRecoil/zUI/zui.cpp:16643`
- `0x41a350` `HudUiClampedIntStepButton::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:16684`
- `0x41a3f0` `HudUiNumericTextInput::DestructorThunk` -> `src/GameZRecoil/zUI/zui.cpp:16485`
- `0x41a3f0` `HudUiNumericTextInput::DestructorThunk` -> `src/GameZRecoil/zUI/zui.cpp:16495`
- `0x41a400` `HudUiNetGameSetupPanel::Destructor` -> `src/Battlesport/hud_ui_net_game_setup_body.h:531`
- `0x41a570` `HudUiCycleSelectorWidget::ScalarDeletingDestructorThunk` -> `src/GameZRecoil/zUI/zui.cpp:10801`
- `0x41a5b0` `HudUiNetGameSetupPanel_LaunchButton::OnActivate` -> `src/Battlesport/hud_ui_net_game_setup_body.h:590`
- `0x41a7b0` `HudUiNetGameSetupTextInput::OnActivateFocusAndCursor` -> `src/GameZRecoil/zUI/zui.cpp:16720`
...
- `0x41ab60` `HudUiNetGameSetupOverlayOwner::StaticInitAndRegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:16744`
- `0x41ab60` `HudUiNetGameSetupOverlayOwner::StaticInitAndRegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:16752`
- `0x41ab70` `HudUiNetGameSetupOverlayOwner::StaticInit` -> `src/GameZRecoil/zUI/zui.cpp:16763`
- `0x41ab80` `HudUiNetGameSetupOverlayOwner::RegisterAtExit` -> `src/GameZRecoil/zUI/zui.cpp:16773`
- `0x41ab90` `HudUiNetGameSetupOverlayOwner::AtExitDestructor` -> `src/GameZRecoil/zUI/zui.cpp:16783`
- `0x41aba0` `HudUiNetGameSetupOverlayOwner::HudUiNetGameSetupOverlayOwner` -> `src/GameZRecoil/zUI/zui.cpp:16802`
- `0x41abe0` `HudUiNetGameSetupOverlayOwner::~HudUiNetGameSetupOverlayOwner` -> `src/GameZRecoil/zUI/zui.cpp:16813`
- `0x41ac50` `HudUiNetGameSetupOverlayOwner::OnTryBecomeCurrent` -> `src/GameZRecoil/zUI/zui.cpp:16833`
- `0x41ad20` `HudUiNetGameSetupOverlayOwner::OnDeactivate` -> `src/GameZRecoil/zUI/zui.cpp:16874`
- `0x41ad80` `HudUiNetGameSetupOverlayOwner::QueueEnterWithReconfigureFlag` -> `src/GameZRecoil/zUI/zui.cpp:16905`
- `0x41ada0` `NetSessionBrowserDialog::Constructor` -> `src/Battlesport/game_net_body.h:1093`
- `0x41ae90` `NetSessionBrowserDialog::ScalarDeletingDestructor` -> `src/Battlesport/game_net_body.h:1105`
- `0x41aeb0` `NetSessionBrowserDialog::Destructor` -> `src/Battlesport/game_net_body.h:1129`
- `0x41af50` `NetSessionBrowserDialog::DoDataExchange` -> `src/Battlesport/game_net_body.h:1138`
- `0x41afd0` `NetSessionBrowserDialog::GetMessageMap` -> `src/Battlesport/game_net_body.h:747`
- `0x41afe0` `NetSessionBrowserDialog::OnInitDialog` -> `src/Battlesport/game_net_body.h:756`
- `0x41b150` `NetSessionBrowserDialog::RefreshSessionList` -> `src/Battlesport/game_net_body.h:1183`
- `0x41b2f0` `NetSessionBrowserDialog::ConnectSelectedProvider` -> `src/Battlesport/game_net_body.h:1277`
- `0x41b510` `NetSessionBrowserDialog::OnOK` -> `src/Battlesport/game_net_body.h:1432`
- `0x41b5a0` `NetSessionBrowserDialog::OnCreateSession` -> `src/Battlesport/game_net_body.h:1480`
- `0x41b660` `NetSessionBrowserDialog::OnTimer` -> `src/Battlesport/game_net_body.h:1384`
- `0x41b680` `NetSessionBrowserDialog::OnDestroy` -> `src/Battlesport/game_net_body.h:1521`
- `0x41b6a0` `NetSessionBrowserDialog::ValidatePlayerName` -> `src/Battlesport/game_net_body.h:1396`
- `0x41b780` `NetSessionBrowserDialog::OnHelpDocs` -> `src/Battlesport/game_net_body.h:1534`
- `0x41b950` `Player::TickRemoteNetworkPlayer` -> `src/Battlesport/player.cpp:8860`
- `0x41c480` `HudUiZrdWidget::ScalarDeletingDestructorThunk` -> `src/GameZRecoil/zUI/zui.cpp:10076`
- `0x41c4a0` `HudUiNumericTextInput::ScalarDeletingDestructorThunk` -> `src/GameZRecoil/zUI/zui.cpp:16519`
- `0x41c4c0` `HudUiZrdWidgetEx17C::ScalarDeletingDestructorThunk` -> `src/GameZRecoil/zUI/zui.cpp:11872`
- `0x41c6e0` `NetSessionConfigDialog::NetSessionConfigDialog` -> `src/Battlesport/game_net_body.h:1606`
- `0x41c7f0` `NetSessionConfigDialog::~NetSessionConfigDialog` -> `src/Battlesport/game_net_body.h:1644`
- `0x41c880` `NetSessionConfigDialog::DoDataExchange` -> `src/Battlesport/game_net_body.h:1662`
- `0x41c970` `NetSessionConfigDialog::GetMessageMap` -> `src/Battlesport/game_net_body.h:1740`
- `0x41c980` `Mission::RegisterMultiplayerMaps` -> `src/Battlesport/game_net_body.h:1883`
- `0x41c990` `NetSessionConfigDialog::InitMapNameStrings` -> `src/Battlesport/game_net_body.h:1894`
- `0x41ca00` `NetSessionConfigDialog::RegisterMapNameCleanup` -> `src/Battlesport/game_net_body.h:1909`
- `0x41ca10` `NetSessionConfigDialog::CleanupMapNameStringsOnExit` -> `src/Battlesport/game_net_body.h:1918`
- `0x41ca30` `NetSessionConfigDialog::OnInitDialog` -> `src/Battlesport/game_net_body.h:1749`
- `0x41cb50` `NetSessionConfigDialog::OnDestroy` -> `src/Battlesport/game_net_body.h:1828`
- `0x41cb90` `NetSessionConfigDialog::OnMapChanged` -> `src/Battlesport/game_net_body.h:1850`
...
- `0x429f80` `zInput::BindGroupList_Clear` -> `src/GameZRecoil/zInput/zInput.cpp:1012`
- `0x42a070` `zInput::BindGroupList_AddGroup` -> `src/GameZRecoil/zInput/zInput.cpp:1077`
- `0x42a500` `zInput::BindMap_AddDefaultBinding` -> `src/GameZRecoil/zInput/zInput.cpp:1254`
- `0x42a550` `zInput::BindMap_InitDefaultBindings` -> `src/GameZRecoil/zInput/zInput.cpp:1282`
...
- `0x42df90` `RecoilApp_IState::~RecoilApp_IState` -> `src/Battlesport/recoil_app.h:45`
- `0x42df90` `RecoilApp_IState::~RecoilApp_IState is` -> `src/Battlesport/recoil_app_late_body.h:3868`
...
- `0x42ee40` `HudUiBackgroundContainer::SetEnabled` -> `src/GameZRecoil/zUI/zui.cpp:7282`
- `0x42ee40` `HudUiBackgroundContainer::SetEnabled` -> `src/GameZRecoil/zUI/zui.cpp:7292`
...
- `0x431bf0` `GameNetSpawnPointList::InitGlobals` -> `src/Battlesport/game_net_body.h:4026`
- `0x431c20` `GameNetPlayerRowList::Reset` -> `src/Battlesport/game_net_body.h:4040`
- `0x431c50` `GameNet::RegisterGameplayHandlersAndOptCatalogCallbacks` -> `src/Battlesport/game_net_body.h:2913`
- `0x431dd0` `Net::InitFromZrd` -> `src/Battlesport/game_net_body.h:875`
- `0x4320b0` `GameNet::WaitForLocalPlayerColorIndex` -> `src/Battlesport/game_net_body.h:3058`
- `0x4320f0` `GameNet::ResetRemotePlayersAndSpawnLists` -> `src/Battlesport/game_net_body.h:3019`
- `0x4321b0` `GameNet::UnregisterGameplayPacketHandlers` -> `src/Battlesport/game_net_body.h:2844`
- `0x4322a0` `GameNet::ResetHudTimerPanelNetStateLongCountdown` -> `src/Battlesport/game_net_body.h:3083`
- `0x432300` `GameNet::TickLocalPlayerPkt06ReplicationAndHudTimer` -> `src/Battlesport/game_net_body.h:2220`
- `0x4327e0` `GameNet::HandlePkt06_PlayerStateSnapshot` -> `src/Battlesport/game_net_body.h:2650`
- `0x432830` `GameNet::FindPlayerRowByKey` -> `src/Battlesport/game_net_body.h:2041`
- `0x432860` `GameNet::SpawnRemotePlayerFromPkt06_PlayerStateSnapshot` -> `src/Battlesport/game_net_body.h:2491`
- `0x432ae0` `GameNet::ApplyPkt06_PlayerStateSnapshotToRow` -> `src/Battlesport/game_net_body.h:2396`
- `0x432d60` `GameNet::UpdateRemotePlayerHudWidgetScreenPos` -> `src/Battlesport/game_net_body.h:3140`
- `0x432e70` `GameNet::ReassignPlayerColorsAndRefreshRows` -> `src/Battlesport/game_net_body.h:3234`
- `0x432ed0` `GameNet::HandlePkt03_RemoveRemotePlayer` -> `src/Battlesport/game_net_body.h:3263`
- `0x433000` `GameNet::SendPkt08_PlayerKillEvent` -> `src/Battlesport/game_net_body.h:3571`
- `0x433060` `GameNet::HandlePkt08_PlayerKillEvent` -> `src/Battlesport/game_net_body.h:3526`
- `0x4330f0` `GameNet::SendPkt0E_PlayerLapProgress` -> `src/Battlesport/game_net_body.h:3599`
- `0x433170` `GameNet::HandlePkt0E_PlayerLapProgress` -> `src/Battlesport/game_net_body.h:3784`
- `0x433200` `GameNet::AreAllPlayersAtLapTarget` -> `src/Battlesport/game_net_body.h:2115`
- `0x433250` `GameNet::HandlePkt0D_HudTimerPanelState` -> `src/Battlesport/game_net_body.h:3470`
- `0x433310` `GameNet::SendPkt0D_HudTimerPanelState` -> `src/Battlesport/game_net_body.h:3744`
- `0x433390` `GameNet::SendPkt0C_HudTimerStatusBits` -> `src/Battlesport/game_net_body.h:3894`
- `0x433410` `GameNet::HandlePkt0C_HudTimerStatusBits` -> `src/Battlesport/game_net_body.h:3351`
- `0x4334f0` `GameNet::SendPkt09_PlayerScoreboardSnapshot` -> `src/Battlesport/game_net_body.h:3629`
- `0x4335b0` `GameNet::HandlePkt09_PlayerScoreboardSnapshot` -> `src/Battlesport/game_net_body.h:3676`
- `0x4336f0` `GameNet::GetLocalPlayerColorIndexOrZero` -> `src/Battlesport/game_net_body.h:2061`
- `0x433710` `GameNet::SetStatusBitsFromFlags` -> `src/Battlesport/game_net_body.h:3110`
- `0x433730` `GameNet::GetStatusBitAllowMaps` -> `src/Battlesport/game_net_body.h:3122`
- `0x433740` `GameNet::GetStatusBitNameTags` -> `src/Battlesport/game_net_body.h:3131`
- `0x433750` `GameNet::SendPkt0B_ChatMessage` -> `src/Battlesport/game_net_body.h:3437`
- `0x4337e0` `GameNet::HandlePkt0B_ChatMessage` -> `src/Battlesport/game_net_body.h:3406`
- `0x433840` `GameNet::RespawnPlayerAndDropWeaponPickupIfAllowed` -> `src/Battlesport/game_net_body.h:2138`
- `0x4339d0` `GameNet::GetNearestOtherPlayerDistanceToSpawnPoint` -> `src/Battlesport/game_net_body.h:2081`
- `0x433a40` `HudTimerPanelNetState::ClearTailFlagsLocal` -> `src/Battlesport/game_net_body.h:860`
- `0x433a50` `GameNetPlayerRow::ApplyPlayerColorTint` -> `src/Battlesport/game_net_body.h:825`
...
- `0x433c30` `GameNet::HostSendPkt0F_CraterFeature` -> `src/Battlesport/game_net_body.h:2822`
- `0x433ca0` `GameNet::SendPkt10_QSandEvent` -> `src/Battlesport/game_net_body.h:2766`
- `0x433d40` `zDEClient_QSand::NetRelayCallback` -> `src/GameZRecoil/zDEClient/zdec_init.cpp:993`
- `0x433de0` `GameNet::HostSendPkt10_QSandFeature` -> `src/Battlesport/game_net_body.h:2802`
- `0x434130` `GameNet::SendPkt07_AltGunDispatch` -> `src/Battlesport/game_net_body.h:2732`
- `0x434190` `GameNet::HandlePkt07_AltGunDispatch` -> `src/Battlesport/game_net_body.h:2687`
- `0x434230` `GameNet::AltGunDispatchNoOpCallback` -> `src/Battlesport/game_net_body.h:2752`
- `0x434370` `GameNet::SendPkt13_EffectAnimActivationRecord` -> `src/Battlesport/game_net_body.h:3821`
- `0x4343f0` `GameNet::HandlePkt13_EffectAnimActivationRecord` -> `src/Battlesport/game_net_body.h:3873`
- `0x434430` `GameNet::SendAllPkt13_EffectAnimActivationRecords` -> `src/Battlesport/game_net_body.h:3856`
- `0x434460` `GameNet::SendPkt14_HudTimerAndFlagsSync` -> `src/Battlesport/game_net_body.h:3930`
- `0x4344b0` `GameNet::HandlePkt14_HudTimerAndFlagsSync` -> `src/Battlesport/game_net_body.h:3949`
- `0x434550` `GameNet::HostUpdateSessionDescStatusFields` -> `src/Battlesport/game_net_body.h:3997`
- `0x4345a0` `GameNetPlayerRowList::AppendNewRow` -> `src/Battlesport/game_net_body.h:4052`
- `0x434650` `GameNetPlayerRow::DestroyEmbeddedPanel` -> `src/Battlesport/game_net_body.h:851`
- `0x435e80` `RecoilStateSaveLoadTransition::OnUpdateShouldQuit` -> `src/Battlesport/recoil_state_dialog_host_body.h:31`
...
- `0x439b20` `HudLowMeterLoopSound::SetLoopActive` -> `src/Battlesport/hud.cpp:3752`
- `0x439b70` `HudLowMeterLoopSound::Disable` -> `src/Battlesport/hud.cpp:3775`
...
- `0x43cf40` `Net::FormatIpv4Address` -> `src/Battlesport/game_net_body.h:1040`
...
- `0x4422a0` `WestwoodOnlineUpgradeDownload::CreateInstanceAndAdvise` -> `src/Battlesport/wol_download_body.h:237`
- `0x4422f0` `WestwoodOnlineUpgradeDownload::UnadviseAndRelease` -> `src/Battlesport/wol_download_body.h:260`
- `0x4425c0` `WestwoodOnlineUpgradeDownloadEventSink::CreateInstance` -> `src/Battlesport/wol_download_body.h:216`
- `0x442660` `WestwoodOnlineUpgradeDownloadEventSink::OnDownloadFinished` -> `src/Battlesport/wol_download_body.h:82`
- `0x442680` `WestwoodOnlineUpgradeDownloadEventSink::OnDownloadError` -> `src/Battlesport/wol_download_body.h:92`
- `0x4426b0` `WestwoodOnlineUpgradeDownloadEventSink::OnDownloadProgress` -> `src/Battlesport/wol_download_body.h:105`
- `0x442720` `WestwoodOnlineUpgradeDownloadEventSink::OnStateChanged` -> `src/Battlesport/wol_download_body.h:139`
- `0x442770` `WestwoodOnlineUpgradeSharedComAddRef` -> `src/Battlesport/wol_download_body.h:156`
- `0x442790` `WestwoodOnlineUpgradeDownloadEventSink::Release` -> `src/Battlesport/wol_download_body.h:175`
- `0x4427d0` `WestwoodOnlineUpgradeDownloadEventSink::QueryInterface` -> `src/Battlesport/wol_download_body.h:190`
- `0x4427f0` `WestwoodOnlineUpgradeDownloadEventSink::~WestwoodOnlineUpgradeDownloadEventSink` -> `src/Battlesport/wol_download_body.h:206`
...
- `0x4706c0` `zInput_BindMapContext::InitFromTemplate` -> `src/GameZRecoil/zInput/zInput.cpp:1911`
- `0x4707a0` `zInput_BindMapContext::FreeAllBuffers` -> `src/GameZRecoil/zInput/zInput.cpp:1963`
- `0x470820` `zInput_BindMapContext::RebuildLookupIndices` -> `src/GameZRecoil/zInput/zInput.cpp:1990`
- `0x4708f0` `zInput_BindMapContext::InitCommandMap` -> `src/GameZRecoil/zInput/zInput.cpp:2031`
- `0x470960` `zInput_BindMapContext::FreeNonOwnedBuffers` -> `src/GameZRecoil/zInput/zInput.cpp:2067`
- `0x4709d0` `zInput_BindMapContext::ResetAllBindings` -> `src/GameZRecoil/zInput/zInput.cpp:2091`
- `0x470a10` `zInput::BindMap_PackBindingCode` -> `src/GameZRecoil/zInput/zInput.cpp:2109`
- `0x470a40` `zInput_BindMapContext::GetPrimaryKeyboardKey` -> `src/GameZRecoil/zInput/zInput.cpp:2123`
- `0x470a60` `zInput_BindMapContext::GetSecondaryKeyboardKey` -> `src/GameZRecoil/zInput/zInput.cpp:2133`
- `0x470a80` `zInput_BindMapContext::GetJoystickButtonSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2143`
- `0x470aa0` `zInput_BindMapContext::GetMouseButtonSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2153`
- `0x470ac0` `zInput_BindMapContext::GetCommandByPrimaryKey` -> `src/GameZRecoil/zInput/zInput.cpp:2163`
- `0x470ad0` `zInput_BindMapContext::GetCommandBySecondaryKey` -> `src/GameZRecoil/zInput/zInput.cpp:2174`
- `0x470ae0` `zInput_BindMapContext::GetCommandByAnyKeyboardKey` -> `src/GameZRecoil/zInput/zInput.cpp:2185`
- `0x470b00` `zInput_BindMapContext::GetCommandByJoystickSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2201`
- `0x470b10` `zInput_BindMapContext::GetCommandByMouseSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2212`
- `0x470b20` `zInput_BindMapContext::SetPrimaryKeyBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2222`
- `0x470b80` `zInput_BindMapContext::SetSecondaryKeyBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2244`
- `0x470bf0` `zInput_BindMapContext::SetJoystickBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2266`
- `0x470c60` `zInput_BindMapContext::SetMouseBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2288`
- `0x470cd0` `zInput_BindMapContext::SetBindingRecord` -> `src/GameZRecoil/zInput/zInput.cpp:2310`
- `0x470d40` `zInput_BindMapContext::DispatchMouseButtonCallbacks` -> `src/GameZRecoil/zInput/zInput.cpp:2349`
- `0x470db0` `zInput_BindMapContext::DispatchJoystickButtonCallbacks` -> `src/GameZRecoil/zInput/zInput.cpp:2378`
- `0x470df0` `zInput_BindMapContext::SetCommandCallback` -> `src/GameZRecoil/zInput/zInput.cpp:2396`
- `0x470e80` `zInput_BindMapContext_DispatchFromKeyboardEvent` -> `src/GameZRecoil/zInput/zInput.cpp:2429`
- `0x470eb0` `zInput_BindMapContext::ReadCommandInputState` -> `src/GameZRecoil/zInput/zInput.cpp:2443`
- `0x470f50` `zInput_BindMapContext::CopyCommandLabel` -> `src/GameZRecoil/zInput/zInput.cpp:2480`
- `0x470f80` `zInput::BindMap_FormatKeyComboName` -> `src/GameZRecoil/zInput/zInput.cpp:2504`
- `0x471040` `zInput::BindMap_CopyJoystickButtonName` -> `src/GameZRecoil/zInput/zInput.cpp:2555`
- `0x471070` `zInput::BindMap_CopyMouseButtonName` -> `src/GameZRecoil/zInput/zInput.cpp:2578`
- `0x471120` `zInput::BindMap_InitDikKeyNameTable` -> `src/GameZRecoil/zInput/zInput.cpp:2624`
- `0x4715e0` `zInput::BindMap_InitJoystickButtonNameTable` -> `src/GameZRecoil/zInput/zInput.cpp:2753`
- `0x471640` `zInput::BindMap_InitMouseButtonNameTable` -> `src/GameZRecoil/zInput/zInput.cpp:2770`
- `0x4716b0` `zInput::BindMap_Current_RebuildLookupIndices` -> `src/GameZRecoil/zInput/zInput.cpp:2809`
- `0x4716c0` `zInput::BindMapCurrent_ResetAllBindings` -> `src/GameZRecoil/zInput/zInput.cpp:2817`
- `0x4716d0` `zInput::BindMapCurrent_GetPrimaryKeyboardKey` -> `src/GameZRecoil/zInput/zInput.cpp:2825`
- `0x4716e0` `zInput::BindMapCurrent_GetSecondaryKeyboardKey` -> `src/GameZRecoil/zInput/zInput.cpp:2837`
- `0x4716f0` `zInput::BindMapCurrent_GetJoystickButtonSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2849`
- `0x471700` `zInput::BindMapCurrent_GetMouseButtonSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2861`
- `0x471710` `zInput::BindMapCurrent_GetCommandByPrimaryKey` -> `src/GameZRecoil/zInput/zInput.cpp:2873`
- `0x471720` `zInput::BindMapCurrent_GetCommandBySecondaryKey` -> `src/GameZRecoil/zInput/zInput.cpp:2885`
- `0x471730` `zInput::BindMapCurrent_GetCommandByJoystickSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2897`
- `0x471740` `zInput::BindMapCurrent_GetCommandByMouseSlot` -> `src/GameZRecoil/zInput/zInput.cpp:2909`
- `0x471750` `zInput::BindMapCurrent_SetPrimaryKeyBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2921`
- `0x471760` `zInput::BindMapCurrent_SetSecondaryKeyBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2937`
- `0x471770` `zInput::BindMapCurrent_SetJoystickBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2953`
- `0x471780` `zInput::BindMapCurrent_SetMouseBinding` -> `src/GameZRecoil/zInput/zInput.cpp:2969`
- `0x471790` `zInput::BindMap_Current_SetBindingRecord` -> `src/GameZRecoil/zInput/zInput.cpp:2985`
- `0x4717c0` `zInput::BindMapCurrent_SetCommandCallback` -> `src/GameZRecoil/zInput/zInput.cpp:3010`
- `0x4717d0` `zInput::BindMapCurrent_ReadCommandInputState` -> `src/GameZRecoil/zInput/zInput.cpp:3027`
- `0x4717e0` `zInput::BindMapCurrent_CopyCommandLabel` -> `src/GameZRecoil/zInput/zInput.cpp:3040`
- `0x471800` `zInput::BindMapCurrent_FormatKeyComboName` -> `src/GameZRecoil/zInput/zInput.cpp:3059`
- `0x471820` `zInput::BindMapCurrent_CopyJoystickButtonName` -> `src/GameZRecoil/zInput/zInput.cpp:3077`
- `0x471840` `zInput::BindMapCurrent_CopyMouseButtonName` -> `src/GameZRecoil/zInput/zInput.cpp:3095`
- `0x471860` `zInput::BindMapContext_Push` -> `src/GameZRecoil/zInput/zInput.cpp:3113`
- `0x471950` `zInput::BindMapContext_Pop` -> `src/GameZRecoil/zInput/zInput.cpp:3158`
- `0x471c50` `zInput::ResetAllTransitionState` -> `src/GameZRecoil/zInput/zin_init.cpp:222`
- `0x471de0` `zInput::PollActiveDevices` -> `src/GameZRecoil/zInput/zin_init.cpp:493`
...
- `0x4a5980` `zSys::ExitProcessWithCleanup` -> `src/GameZRecoil/zSys/zSys.cpp:1380`
- `0x4a59e0` `zSys::FindFileOnDriveType` -> `src/GameZRecoil/zSys/zSys.cpp:165`
...
- `0x4b2960` `zGame::Options_LoadFromRegistry` -> `src/GameZRecoil/zGame/zgame_opt.c:908`
- `0x4b2bf0` `zGame::Options_SaveToRegistry` -> `src/GameZRecoil/zGame/zgame_opt.c:1026`
- `0x4b2e80` `zGame::Options_GetOrCreateOption` -> `src/GameZRecoil/zGame/zgame_opt.c:833`
...
- `0x4b2fe0` `zSys::HasCpuidSupportRuntimeOptions` -> `src/GameZRecoil/zSys/zSys.cpp:251`
- `0x4b2fe0` `zSys::HasCpuidSupportRuntimeOptions` -> `src/GameZRecoil/zSys/zsys_cpu_asm.inl:68`
- `0x4b3020` `zCpu::HasMmxSupport` -> `src/GameZRecoil/zSys/zSys.cpp:1330`
- `0x4b3020` `zCpu::HasMmxSupport` -> `src/GameZRecoil/zSys/zsys_cpu_asm.inl:19`
- `0x4b3050` `zSys::CheckCpuSignatureMask` -> `src/GameZRecoil/zSys/zSys.cpp:236`
- `0x4b31b0` `zSys::GetCpuClass` -> `src/GameZRecoil/zSys/zsys_cpu_get_class.inl:2`
- `0x4b31c0` `zSys::GetCpuMhz` -> `src/GameZRecoil/zSys/zSys.cpp:1346`
- `0x4b31f0` `zSnd::HasMmxMixerSupport` -> `src/GameZRecoil/zSound/zsnd_init.cpp:796`
- `0x4b3210` `zSys::ReturnZeroStub` -> `src/GameZRecoil/zSys/zSys.cpp:1361`
- `0x4b3220` `zVid::HasAcceptedHardwareRenderer` -> `src/GameZRecoil/zVideo/zvid_main.c:2764`
- `0x4b3230` `zSys::GetTotalPhysKb` -> `src/GameZRecoil/zSys/zSys.cpp:1369`
- `0x4b3260` `zGame::Options_InitRegistryContext` -> `src/GameZRecoil/zGame/zgame_opt.c:891`
- `0x4b32c0` `zGame::Options_ShutdownRegistryContext` -> `src/GameZRecoil/zGame/zgame_opt.c:1138`
- `0x4b3380` `zGame::Options_FindOption` -> `src/GameZRecoil/zGame/zgame_opt.c:813`
- `0x4b3420` `zSys::DetectCpuClassAndFeatures` -> `src/GameZRecoil/zSys/zsys_cpu_detect.inl:2`
- `0x4b3480` `zSys::ReadCpuidFeatureFlags` -> `src/GameZRecoil/zSys/zSys.cpp:315`
- `0x4b36f0` `CpuBenchmarkResolver::ResolveCpuBenchmarkPacket` -> `src/GameZRecoil/zSys/zSys.cpp:1276`
- `0x4b37f0` `CpuBenchmarkResolver::MeasureMhzViaBsfLoop_Qpc` -> `src/GameZRecoil/zSys/zSys.cpp:465`
- `0x4b37f0` `CpuBenchmarkResolver::MeasureMhzViaBsfLoop_Qpc` -> `src/GameZRecoil/zSys/zSys.cpp:588`
- `0x4b38e0` `CpuBenchmarkResolver::MeasureCpuMhz_RdtscQpc` -> `src/GameZRecoil/zSys/zSys.cpp:659`
- `0x4b38e0` `CpuBenchmarkResolver::MeasureCpuMhz_RdtscQpc` -> `src/GameZRecoil/zSys/zSys.cpp:910`
- `0x4b3b00` `zSys::ReadCmosRtcSecondsBcd` -> `src/GameZRecoil/zSys/zSys.cpp:368`
- `0x4b3b20` `zSys::ReadTsc64` -> `src/GameZRecoil/zSys/zSys.cpp:379`
- `0x4b3b50` `CpuBenchmarkResolver::MeasureCpuMhz_CmosRtc` -> `src/GameZRecoil/zSys/zSys.cpp:1042`
- `0x4b3b50` `CpuBenchmarkResolver::MeasureCpuMhz_CmosRtc` -> `src/GameZRecoil/zSys/zSys.cpp:1191`
- `0x4b3ca0` `zSys::Sub64` -> `src/GameZRecoil/zSys/zSys.cpp:399`
- `0x4b3ce0` `HudUiWidget::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:14685`
- `0x4b3d00` `HudUiWidget::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:9071`
- `0x4b3d00` `HudUiWidget::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:9093`
- `0x4b3d50` `HudUiWidget::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:14677`
- `0x4b3da0` `HudUiWidget::ReleaseImageIfOwned` -> `src/GameZRecoil/zUI/zui.cpp:14624`
- `0x4b3dd0` `HudUiWidget::SetPos` -> `src/GameZRecoil/zUI/zui.cpp:14700`
- `0x4b3e30` `HudUiWidget::SetImageByPathOwned` -> `src/GameZRecoil/zUI/zui.cpp:14656`
- `0x4b3e70` `HudUiWidget::SetImageBorrowedAndInvalidate` -> `src/GameZRecoil/zUI/zui.cpp:14637`
- `0x4b4030` `HudUiWidget::HitTest` -> `src/GameZRecoil/zUI/zui.cpp:14553`
- `0x4b4070` `HudUiElement::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:6122`
- `0x4b40c0` `HudUiElement::CopyConstructor` -> `src/GameZRecoil/zUI/zui.cpp:6137`
- `0x4b4120` `HudUiElement::CopyFrom` -> `src/GameZRecoil/zUI/zui.cpp:6156`
- `0x4b4180` `HudUiElement::Invalidate` -> `src/GameZRecoil/zUI/zui.cpp:6184`
- `0x4b4190` `HudUiElement::SetBltSourceAndClipRect` -> `src/GameZRecoil/zUI/zui.cpp:6261`
- `0x4b41b0` `HudUiElement::SetClipRect` -> `src/GameZRecoil/zUI/zui.cpp:6273`
- `0x4b42c0` `HudUiElement::GetTextRect` -> `src/GameZRecoil/zUI/zui.cpp:6305`
- `0x4b42f0` `HudUiTextInput::HudUiTextInput` -> `src/GameZRecoil/zUI/zui.cpp:15066`
- `0x4b4370` `HudUiTextInput::~HudUiTextInput` -> `src/GameZRecoil/zUI/zui.cpp:15008`
- `0x4b4370` `HudUiTextInput::~HudUiTextInput` -> `src/GameZRecoil/zUI/zui.cpp:15018`
- `0x4b4390` `HudUiTextInput::AllocTextBuffer` -> `src/GameZRecoil/zUI/zui.cpp:15040`
- `0x4b43d0` `HudUiTextInput::SetContents` -> `src/GameZRecoil/zUI/zui.cpp:15123`
- `0x4b4410` `HudUiTextInput::GetBuffer` -> `src/GameZRecoil/zUI/zui.cpp:15139`
- `0x4b4420` `HudUiTextInput::SetCursorPosition` -> `src/GameZRecoil/zUI/zui.cpp:15099`
- `0x4b4420` `HudUiTextInput::SetCursorPosition` -> `src/GameZRecoil/zUI/zui.cpp:15110`
- `0x4b4460` `HudUiTextInput::DispatchKeyAction` -> `src/GameZRecoil/zUI/zui.cpp:15253`
- `0x4b44e0` `HudUiTextInput::InsertCharAtCursor` -> `src/GameZRecoil/zUI/zui.cpp:15232`
- `0x4b4530` `HudUiTextInput::BackspaceDeleteChar` -> `src/GameZRecoil/zUI/zui.cpp:15218`
- `0x4b4550` `HudUiTextInput::DeleteCharForward` -> `src/GameZRecoil/zUI/zui.cpp:15186`
- `0x4b4560` `HudUiTextInput::MoveCursorLeft` -> `src/GameZRecoil/zUI/zui.cpp:15197`
- `0x4b4570` `HudUiTextInput::MoveCursorRight` -> `src/GameZRecoil/zUI/zui.cpp:15207`
- `0x4b4590` `HudUiTextInput::ShiftTextRight` -> `src/GameZRecoil/zUI/zui.cpp:15147`
- `0x4b45e0` `HudUiTextInput::ShiftTextLeft` -> `src/GameZRecoil/zUI/zui.cpp:15168`
- `0x4b4620` `HudUiSliderBorder::HudUiSliderBorder` -> `src/GameZRecoil/zUI/zui.cpp:16080`
...
- `0x4b47a0` `HudUiElement::~HudUiElement` -> `src/GameZRecoil/zUI/zui.cpp:6175`
- `0x4b47b0` `HudUiSliderBorder::Update` -> `src/GameZRecoil/zUI/zui.cpp:16161`
- `0x4b47b0` `HudUiSliderBorder::Update` -> `src/GameZRecoil/zUI/zui.cpp:16170`
- `0x4b4810` `HudUiSliderBorder::SetBounds` -> `src/GameZRecoil/zUI/zui.cpp:16195`
- `0x4b49e0` `HudUiNumericTextInput::HudUiNumericTextInput` -> `src/GameZRecoil/zUI/zui.cpp:16277`
- `0x4b4a90` `HudUiNumericTextInput::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:16504`
- `0x4b4ab0` `HudUiTextInput::DestructorCoreThunk` -> `src/GameZRecoil/zUI/zui.cpp:15031`
- `0x4b4ac0` `HudUiNumericTextInput::~HudUiNumericTextInput` -> `src/GameZRecoil/zUI/zui.cpp:16474`
- `0x4b4b30` `HudUiNumericTextInput::RawKeyboardCallback` -> `src/GameZRecoil/zUI/zui.cpp:16535`
- `0x4b4b50` `HudUiNumericTextInput::OnRawKeyboardChar` -> `src/GameZRecoil/zUI/zui.cpp:16585`
- `0x4b4ba0` `HudUiNumericTextInput::SetInputActive` -> `src/GameZRecoil/zUI/zui.cpp:16550`
- `0x4b4c50` `HudUiNumericTextInput::SetRawKeyboardCapture` -> `src/GameZRecoil/zUI/zui.cpp:16439`
- `0x4b4c90` `HudUiNumericTextInput::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:16465`
- `0x4b4ca0` `HudUiNumericTextInput::UpdateCaptureUiAndClip` -> `src/GameZRecoil/zUI/zui.cpp:16374`
- `0x4b4e40` `HudUiNumericTextInput::AllocTextBuffer` -> `src/GameZRecoil/zUI/zui.cpp:16337`
- `0x4b4e60` `HudUiNumericTextInput::Update` -> `src/GameZRecoil/zUI/zui.cpp:16355`
- `0x4b4ed0` `HudUiNumericTextInput::GetBuffer` -> `src/GameZRecoil/zUI/zui.cpp:16347`
- `0x4b4ee0` `HudUiZrdWidget::HudUiZrdWidget` -> `src/GameZRecoil/zUI/zui.cpp:9554`
- `0x4b4ee0` `HudUiZrdWidget::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:9592`
- `0x4b50a0` `HudUiZrdWidget::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:10048`
- `0x4b50a0` `HudUiZrdWidget::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:10060`
- `0x4b50c0` `HudUiZrdWidget::~HudUiZrdWidget` -> `src/GameZRecoil/zUI/zui.cpp:9938`
- `0x4b52f0` `HudUiZrdWidget::DeleteChildIfPresent` -> `src/GameZRecoil/zUI/zui.cpp:9923`
- `0x4b5310` `HudUiZrdWidget::Invalidate` -> `src/GameZRecoil/zUI/zui.cpp:10092`
- `0x4b5350` `HudUiZrdWidget::GetBoundsRectOrNull` -> `src/GameZRecoil/zUI/zui.cpp:10111`
- `0x4b5630` `HudUiZrdWidget::ShowPreview` -> `src/GameZRecoil/zUI/zui.cpp:10233`
- `0x4b5740` `HudUiZrdWidget::RefreshState` -> `src/GameZRecoil/zUI/zui.cpp:10182`
- `0x4b5860` `HudUiZrdWidget::HidePreview` -> `src/GameZRecoil/zUI/zui.cpp:10320`
- `0x4b5900` `HudUiZrdWidget::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:10276`
- `0x4b59f0` `HudUiZrdWidget::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:9601`
- `0x4b6fc0` `HudUiCheckToggleWidget::HudUiCheckToggleWidget` -> `src/GameZRecoil/zUI/zui.cpp:10351`
- `0x4b6fc0` `HudUiCheckToggleWidget::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:10364`
- `0x4b7000` `HudUiCheckToggleWidget::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:10411`
- `0x4b70b0` `HudUiCheckToggleWidget::GetBoundsRectOrNull` -> `src/GameZRecoil/zUI/zui.cpp:10443`
- `0x4b70c0` `HudUiCheckToggleWidget::RefreshState` -> `src/GameZRecoil/zUI/zui.cpp:10451`
- `0x4b7210` `HudUiCheckToggleWidget::ShowPreview` -> `src/GameZRecoil/zUI/zui.cpp:10508`
- `0x4b7250` `HudUiCheckToggleWidget::HidePreview` -> `src/GameZRecoil/zUI/zui.cpp:10524`
- `0x4b7290` `HudUiCheckToggleWidget::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:10541`
- `0x4b72c0` `HudUiCheckToggleWidget::SetChecked` -> `src/GameZRecoil/zUI/zui.cpp:10686`
- `0x4b7d60` `HudUiCycleSelectorWidget::HudUiCycleSelectorWidget` -> `src/GameZRecoil/zUI/zui.cpp:10720`
- `0x4b7d60` `HudUiCycleSelectorWidget::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:10739`
- `0x4b7dc0` `HudUiCycleSelectorWidget::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:10786`
- `0x4b7e60` `HudUiCycleSelectorWidget::Update` -> `src/GameZRecoil/zUI/zui.cpp:10898`
- `0x4b7ee0` `HudUiCycleSelectorWidget::AdvanceSelectionAndActivate` -> `src/GameZRecoil/zUI/zui.cpp:10816`
- `0x4b7f20` `HudUiCycleSelectorWidget::SetIndexClamped` -> `src/GameZRecoil/zUI/zui.cpp:10838`
- `0x4b7f80` `HudUiCycleSelectorWidget::SetVisibleRange` -> `src/GameZRecoil/zUI/zui.cpp:10873`
- `0x4b7fd0` `HudUiCycleSelectorWidget::AddTextEntry` -> `src/GameZRecoil/zUI/zui.cpp:10920`
- `0x4b8100` `HudUiCycleSelectorWidget::ApplyFontStyleForEntry` -> `src/GameZRecoil/zUI/zui.cpp:11115`
- `0x4b8200` `HudUiCycleSelectorWidget::AddBitmapEntry` -> `src/GameZRecoil/zUI/zui.cpp:11186`
- `0x4b82e0` `HudUiCycleSelectorWidget::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:11224`
- `0x4b8450` `HudUiFillBitmap::HudUiFillBitmap` -> `src/GameZRecoil/zUI/zui.cpp:11353`
- `0x4b84b0` `HudUiFillBitmap::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:11411`
- `0x4b8520` `HudUiFillBitmap::Draw` -> `src/GameZRecoil/zUI/zui.cpp:11426`
- `0x4b85c0` `HudUiFillBitmap::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:11458`
- `0x4b8650` `HudUiFillBitmap::UpdateNormalizedFromCursor` -> `src/GameZRecoil/zUI/zui.cpp:11510`
- `0x4b86b0` `HudUiFillBitmap::SetNormalizedValueAndRebuild` -> `src/GameZRecoil/zUI/zui.cpp:11543`
- `0x4b8760` `HudUiZrdWidgetEx17C_Item::HudUiZrdWidgetEx17C_Item` -> `src/GameZRecoil/zUI/zui.cpp:11580`
- `0x4b87a0` `HudUiZrdWidgetEx17C_Item::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:11609`
- `0x4b87c0` `HudUiZrdWidgetEx17C_Item::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:11592`
- `0x4b87c0` `HudUiZrdWidgetEx17C_Item::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:11601`
- `0x4b87d0` `HudUiZrdWidgetEx17C_Item::ShowPreviewIfNotSelected` -> `src/GameZRecoil/zUI/zui.cpp:11624`
- `0x4b87e0` `HudUiZrdWidgetEx17C_Item::HidePreviewIfNotSelected` -> `src/GameZRecoil/zUI/zui.cpp:11634`
- `0x4b87e0` `HudUiZrdWidgetEx17C_Item::HidePreviewIfNotSelected` -> `src/GameZRecoil/zUI/zui.cpp:11642`
- `0x4b87f0` `HudUiZrdWidgetEx17C_Item::OnActivateSelectSelf` -> `src/GameZRecoil/zUI/zui.cpp:11652`
- `0x4b87f0` `HudUiZrdWidgetEx17C_Item::OnActivateSelectSelf` -> `src/GameZRecoil/zUI/zui.cpp:11660`
- `0x4b8850` `HudUiZrdWidgetEx17C_Item::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:11677`
- `0x4b8850` `HudUiZrdWidgetEx17C_Item::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:11685`
- `0x4b8a90` `HudUiZrdWidgetEx17C_Item::SetSelected` -> `src/GameZRecoil/zUI/zui.cpp:11779`
- `0x4b8af0` `HudUiZrdWidgetEx17C_Item::GetMouseRectOrBounds` -> `src/GameZRecoil/zUI/zui.cpp:11803`
- `0x4b8b10` `HudUiZrdWidgetEx17C::HudUiZrdWidgetEx17C` -> `src/GameZRecoil/zUI/zui.cpp:11811`
- `0x4b8b40` `HudUiZrdWidgetEx17C::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:11856`
- `0x4b8b60` `HudUiZrdWidgetEx17C::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:11826`
- `0x4b8b60` `HudUiZrdWidgetEx17C::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:11835`
- `0x4b8be0` `HudUiZrdWidgetEx17C::LoadFromZrd` -> `src/GameZRecoil/zUI/zui.cpp:11888`
- `0x4b8cf0` `HudUiZrdWidgetEx17C::SetSelectedIndex` -> `src/GameZRecoil/zUI/zui.cpp:11947`
- `0x4b8cf0` `HudUiZrdWidgetEx17C::SetSelectedIndex` -> `src/GameZRecoil/zUI/zui.cpp:11959`
- `0x4b8d30` `HudCmdBindButtonBase::HudCmdBindButtonBase` -> `src/GameZRecoil/zUI/zui.cpp:12021`
- `0x4b92a0` `HudUiListSelectorItem::HudUiListSelectorItem` -> `src/GameZRecoil/zHud/zhud_ui.h:1206`
- `0x4b92a0` `HudUiListSelectorItem::HudUiListSelectorItem` -> `src/GameZRecoil/zUI/zui.cpp:11981`
- `0x4b9520` `HudUiListSelectorItem::OnActivate` -> `src/GameZRecoil/zUI/zui.cpp:11980`
- `0x4ba070` `HudUiBackground::BindButtonsNodeToWidgetByName` -> `src/GameZRecoil/zUI/zui.cpp:8704`
- `0x4ba0c0` `HudUiBackground::BindWidgetByName` -> `src/GameZRecoil/zUI/zui.cpp:8734`
- `0x4ba0e0` `HudUiBackground::BindPrimitiveNodeToElement` -> `src/GameZRecoil/zUI/zui.cpp:8750`
- `0x4ba350` `HudUiBackground::FreeLoadedTreeRoots` -> `src/GameZRecoil/zUI/zui.cpp:8912`
- `0x4ba380` `HudUiDialogController::BlitOwnedSurfaceToPrimary` -> `src/GameZRecoil/zUI/zui.cpp:8284`
- `0x4ba3a0` `HudUiContainer::InvalidateChildren` -> `src/GameZRecoil/zUI/zui.cpp:7272`
- `0x4ba3c0` `HudUiFillBitmap::SetNormalizedValue` -> `src/GameZRecoil/zUI/zui.cpp:11522`
- `0x4ba3e0` `HudUiOwnedTextInput::OnAccept` -> `src/GameZRecoil/zUI/zui.cpp:15296`
- `0x4ba400` `HudUiPanel::GetWrapRect` -> `src/GameZRecoil/zUI/zui.cpp:17420`
- `0x4ba410` `HudUiListSelectorItem::Draw` -> `src/GameZRecoil/zUI/zui.cpp:12003`
- `0x4ba470` `StdPtrVector::FreeBufferAndReset` -> `src/GameZRecoil/zUI/zui.cpp:12050`
- `0x4ba4a0` `HudFontStyle::HudFontStyle` -> `src/GameZRecoil/zUI/zui.cpp:9039`
- `0x4ba4c0` `HudFontStyle::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:9053`
- `0x4ba4c0` `HudFontStyle::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:9063`
- `0x4ba4d0` `HudUiPanelPtrVector::EraseRange` -> `src/GameZRecoil/zUI/zui.cpp:9768`
- `0x4ba510` `HudUiPanelPtrVector::InsertN` -> `src/GameZRecoil/zUI/zui.cpp:9799`
- `0x4ba740` `HudUiPanel::HudUiPanel` -> `src/GameZRecoil/zUI/zui.cpp:17180`
- `0x4bab40` `HudUiPanel::~HudUiPanel` -> `src/GameZRecoil/zUI/zui.cpp:17340`
- `0x4bac10` `HudUiPanel::RebuildTextRect` -> `src/GameZRecoil/zUI/zui.cpp:17738`
- `0x4bb0c0` `HudUiFlashPanel::ComputeFlashBlendColor` -> `src/GameZRecoil/zUI/zui.cpp:7075`
- `0x4bb1c0` `HudUiPanel::MeasureTextPrefixRect` -> `src/GameZRecoil/zUI/zui.cpp:18029`
- `0x4bb2a0` `HudUiPanel::UpdateTextBoundsFromContent` -> `src/GameZRecoil/zUI/zui.cpp:17967`
- `0x4bb3d0` `HudUiPanel::HitTest` -> `src/GameZRecoil/zUI/zui.cpp:17428`
- `0x4bb460` `HudUiPanel::Draw` -> `src/GameZRecoil/zUI/zui.cpp:17364`
- `0x4bb540` `HudUiPanel::SetTextFmt` -> `src/GameZRecoil/zUI/zui.cpp:17624`
- `0x4bb5e0` `HudUiPanel::SetTextFmtV` -> `src/GameZRecoil/zUI/zui.cpp:17645`
- `0x4bb680` `HudUiPanel::SetText` -> `src/GameZRecoil/zUI/zui.cpp:17693`
- `0x4bb710` `HudUiPanel::QueryTextHeight` -> `src/GameZRecoil/zUI/zui.cpp:18082`
- `0x4bb740` `HudUiPanel::GetTextRect` -> `src/GameZRecoil/zUI/zui.cpp:17464`
- `0x4bb790` `HudUiCompositePanel::HudUiCompositePanel` -> `src/GameZRecoil/zUI/zui.cpp:6719`
- `0x4bb960` `HudUiCompositePanel::ScalarDeletingDestructor` -> `src/GameZRecoil/zUI/zui.cpp:6756`
- `0x4bb980` `HudUiCompositePanel::Update` -> `src/GameZRecoil/zUI/zui.cpp:6772`
- `0x4bb9f0` `HudUiCompositePanel::SetPos` -> `src/GameZRecoil/zUI/zui.cpp:6791`
- `0x4bbaa0` `HudUiCompositePanel::SetTextFmt` -> `src/GameZRecoil/zUI/zui.cpp:6861`
- `0x4bbac0` `HudUiCompositePanel::SetTextFmtV` -> `src/GameZRecoil/zUI/zui.cpp:6881`
- `0x4bbb20` `HudUiCompositePanel::ScrollHistory` -> `src/GameZRecoil/zUI/zui.cpp:6899`
- `0x4bbbe0` `HudUiCompositePanel::SetFont` -> `src/GameZRecoil/zUI/zui.cpp:6924`
- `0x4bbca0` `HudUiCompositePanel::ResizeEntryVectorAndRelayout` -> `src/GameZRecoil/zUI/zui.cpp:6969`
- `0x4bbe90` `HudUiCompositePanel::ReapplyEntryCount` -> `src/GameZRecoil/zUI/zui.cpp:6819`
- `0x4bbed0` `HudUiCompositePanel::ResizeEntryCount` -> `src/GameZRecoil/zUI/zui.cpp:6830`
- `0x4bbfa0` `HudUiCompositePanelVector::Clear` -> `src/GameZRecoil/zUI/zui.cpp:6602`
- `0x4bbff0` `HudUiCompositePanelVector::InsertCopies` -> `src/GameZRecoil/zUI/zui.cpp:6629`
- `0x4bc320` `HudUiCompositePanelEntry::ConstructorCopyRange` -> `src/GameZRecoil/zUI/zui.cpp:7049`
- `0x4bc3a0` `HudUiCompositePanelEntry::AssignCopy` -> `src/GameZRecoil/zUI/zui.cpp:7010`
- `0x4bc410` `HudUiCompositePanelEntry::ConstructorCopy` -> `src/GameZRecoil/zUI/zui.cpp:7028`
- `0x4bc480` `HudUiCircle::HudUiCircle` -> `src/GameZRecoil/zHud/zhud_ui.h:664`
- `0x4bc4c0` `HudUiCircle::Draw` -> `src/GameZRecoil/zUI/zui.cpp:6573`
- `0x4bc4e0` `HudUiCircle::HitTestCore` -> `src/GameZRecoil/zUI/zui.cpp:6588`
- `0x4bc510` `HudUiBackgroundContainer::HudUiBackgroundContainer` -> `src/GameZRecoil/zUI/zui.cpp:8161`
- `0x4bc540` `HudUiBackgroundContainer::~HudUiBackgroundContainer` -> `src/GameZRecoil/zUI/zui.cpp:8172`
- `0x4bc550` `HudUiBackgroundContainer::SetInputFocus` -> `src/GameZRecoil/zUI/zui.cpp:8180`
- `0x4bc560` `HudUiBackgroundContainer::GetInputFocus` -> `src/GameZRecoil/zUI/zui.cpp:8190`
- `0x4bc570` `HudUiBackgroundContainer::UpdateAll` -> `src/GameZRecoil/zUI/zui.cpp:8928`
- `0x4bc760` `HudUi::SetInvalidateMode` -> `src/GameZRecoil/zUI/zui.cpp:18970`
- `0x4bc780` `HudUiContainer::HudUiContainer` -> `src/GameZRecoil/zUI/zui.cpp:7105`
- `0x4bc7b0` `HudUiContainer::~HudUiContainer` -> `src/GameZRecoil/zUI/zui.cpp:7116`
- `0x4bc7b0` `HudUiContainer::DestructorCore` -> `src/GameZRecoil/zUI/zui.cpp:7124`
- `0x4bc7c0` `HudUiContainer::AddChild` -> `src/GameZRecoil/zUI/zui.cpp:7143`
- `0x4bc8d0` `HudUiContainer::SetChildFlags` -> `src/GameZRecoil/zUI/zui.cpp:7233`
- `0x4bc900` `HudUiContainer::UpdateAll` -> `src/GameZRecoil/zUI/zui.cpp:7256`
- `0x4bc930` `HudUiTransitionTextPanel::ResetFlashState` -> `src/GameZRecoil/zUI/zui.cpp:11046`
- `0x4bc980` `HudUiTransitionTextPanel::SetFlashRate` -> `src/GameZRecoil/zUI/zui.cpp:11072`
- `0x4bcb50` `HudUiTextLabel::HudUiTextLabel` -> `src/GameZRecoil/zUI/zui.cpp:16941`
- `0x4bccf0` `HudUiTextLabel::SetTextFmt` -> `src/GameZRecoil/zUI/zui.cpp:17029`
- `0x4bcd40` `HudUiPanel::SetClip` -> `src/GameZRecoil/zUI/zui.cpp:6289`
- `0x4bcd80` `HudUiTextLabel::RebuildTextBounds` -> `src/GameZRecoil/zUI/zui.cpp:17066`
- `0x4bcdc0` `HudUiTextLabel::MeasureTextWidth` -> `src/GameZRecoil/zUI/zui.cpp:17083`
- `0x4bcdf0` `HudUiTextLabel::UpdateTextExtents` -> `src/GameZRecoil/zUI/zui.cpp:17164`
- `0x4bce30` `HudUiTextLabel::OnDraw` -> `src/GameZRecoil/zUI/zui.cpp:17099`
- `0x4bcea0` `HudUiTextLabel::HitTest` -> `src/GameZRecoil/zUI/zui.cpp:17135`
- `0x4bcf20` `HudUiBar::HudUiBar` -> `src/GameZRecoil/zUI/zui.cpp:15922`
- `0x4bcff0` `HudUiBar::Draw` -> `src/GameZRecoil/zUI/zui.cpp:15939`
- `0x4bd020` `HudUiTopMessageStack::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:19256`
- `0x4bd100` `HudUiPanel::ConstructorDefaultThunk` -> `src/GameZRecoil/zUI/zui.cpp:17233`
- `0x4bd2a0` `HudUiTextStack4::Clear` -> `src/GameZRecoil/zUI/zui.cpp:19191`
- `0x4bd2d0` `HudUiChatMessageStack::Constructor` -> `src/GameZRecoil/zUI/zui.cpp:19299`
- `0x4bd3d0` `HudUiTextStack4::SetTextColors` -> `src/GameZRecoil/zUI/zui.cpp:19175`
- `0x4bd410` `HudUiTextStack4::SetXAll` -> `src/GameZRecoil/zUI/zui.cpp:19228`
- `0x4bd440` `HudUiTextStack4::SetYDescending` -> `src/GameZRecoil/zUI/zui.cpp:19241`
- `0x4bd470` `zTimedTask::RemoveFromActiveList` -> `src/GameZRecoil/zUI/zui.cpp:18796`
- `0x4bd4d0` `zTimedTask::RunImmediateAction` -> `src/GameZRecoil/zUI/zui.cpp:18829`
- `0x4bd660` `zTimedTask::TickActiveList` -> `src/GameZRecoil/zUI/zui.cpp:18940`
...
- `0x4bf840` `HudUiPolyline::HudUiPolyline` -> `src/GameZRecoil/zUI/zui.cpp:15989`
- `0x4bf8b0` `HudUiPolyline::SetPoint` -> `src/GameZRecoil/zUI/zui.cpp:16054`
- `0x4bf900` `HudUiPolyline::Draw` -> `src/GameZRecoil/zUI/zui.cpp:16008`
- `0x4bf900` `HudUiPolyline::Draw` -> `src/GameZRecoil/zUI/zui.cpp:16017`
- `0x4bfc80` `HudUiBackgroundVideoWidget::HudUiBackgroundVideoWidget` -> `src/GameZRecoil/zUI/zui.cpp:9373`
- `0x4bfcd0` `HudUiBackgroundVideoWidget::Destructor` -> `src/GameZRecoil/zUI/zui.cpp:9398`
- `0x4bfd40` `HudUiBackgroundVideoWidget::SetMediaPathOwnedAndRefresh` -> `src/GameZRecoil/zUI/zui.cpp:9406`
- `0x4bfe20` `HudUiBackgroundVideoWidget::SetColorKey565` -> `src/GameZRecoil/zUI/zui.cpp:9455`
- `0x4bfe40` `HudUiBackgroundVideoWidget::Update` -> `src/GameZRecoil/zUI/zui.cpp:9469`
- `0x4bfe90` `HudUiBackgroundVideoWidget::Draw` -> `src/GameZRecoil/zUI/zui.cpp:9489`
- `0x4bfec0` `HudUiBackgroundVideoWidget::DrawBase` -> `src/GameZRecoil/zUI/zui.cpp:9507`
- `0x4bff00` `HudUiBackgroundVideoWidget::RebuildBltRect` -> `src/GameZRecoil/zUI/zui.cpp:9526`
- `0x4bffb0` `HudUiPrimitiveBindTarget::SetSegmentEndpoints` -> `src/GameZRecoil/zUI/zui.cpp:6528`
