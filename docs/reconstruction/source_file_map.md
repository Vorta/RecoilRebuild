...
- `0x48d6d0` `zRndr_OverlayRect_Submit` -> `src/GameZRecoil/zRndr/zRndr.cpp:7762`
- `0x48d7a0` `zRndr_OverlayRect_FlushSw` -> `src/GameZRecoil/zRndr/zRndr.cpp:7806`
...
- `0x4907c0` `zRndr_SpanOcclusion_TestSpanDepthOrderPair` -> `src/GameZRecoil/zRndr/zRndr.cpp:6339`
- `0x490ae0` `zRndr_SpanOcclusion_InsertSpanNode_Local` -> `src/GameZRecoil/zRndr/zRndr.cpp:5594`
- `0x4912a0` `zRndr_SpanOcclusion_InsertSpanNode_NoDepthTest` -> `src/GameZRecoil/zRndr/zRndr.cpp:5616`
- `0x491840` `zRndr_SpanOcclusion_BuildSpanList` -> `src/GameZRecoil/zRndr/zRndr.cpp:5637`
- `0x491da0` `zRndr_SpanOcclusion_BuildSpanListFast` -> `src/GameZRecoil/zRndr/zRndr.cpp:5659`
- `0x491dd0` `zRndr_SpanOcclusion_TestColumnVisibility` -> `src/GameZRecoil/zRndr/zRndr.cpp:5680`
- `0x492000` `zRndr_RasterizePolyWithSpanList` -> `src/GameZRecoil/zRndr/zRndr.cpp:6887`
- `0x4927d0` `zRndr::SpanOcclusionRasterizeOccluderPoly` -> `src/GameZRecoil/zRndr/zRndr.cpp:2043`
- `0x492f00` `zRndr_DrawFlatImmediate` -> `src/GameZRecoil/zRndr/zRndr.cpp:7047`
- `0x4936d0` `zRndr_RasterizePoly` -> `src/GameZRecoil/zRndr/zRndr.cpp:7210`
- `0x493df0` `zRndr_DrawFlatQueued` -> `src/GameZRecoil/zRndr/zRndr.cpp:8180`
- `0x494af0` `Renderer_DrawPolyTLV` -> `src/GameZRecoil/zRndr/zRndr.cpp:8631`
- `0x495850` `zRndr_DrawTexturedQueued` -> `src/GameZRecoil/zRndr/zRndr.cpp:8398`
- `0x4969d0` `zRndr_DrawTexturedQueuedAlpha` -> `src/GameZRecoil/zRndr/zRndr.cpp:8845`
- `0x497ac0` `zRndr_DrawTexturedFanTri` -> `src/GameZRecoil/zRndr/zRndr.cpp:9055`
- `0x498bd0` `zRndr_DrawImmediateLine` -> `src/GameZRecoil/zRndr/zRndr.cpp:9264`
- `0x498c00` `zRndr_DrawClippedImmediateLineStrip` -> `src/GameZRecoil/zRndr/zRndr.cpp:9286`
- `0x498c40` `zRndr_SpanOcclusion_TestPointVisibility` -> `src/GameZRecoil/zRndr/zRndr.cpp:5754`
- `0x498cb0` `zRndr::LensFlare_DrawQueuedSample16_ClippedFramebuffer` -> `src/GameZRecoil/zRndr/zRndr.cpp:5405`
- `0x498f90` `zRndr_SpanOcclusion_TestSample` -> `src/GameZRecoil/zRndr/zRndr.cpp:5785`
- `0x498fb0` `zRndr_DrawCircleOutline16_Framebuffer` -> `src/GameZRecoil/zRndr/zRndr.cpp:5873`
- `0x499020` `zRndr_DrawCircleOctants16_Framebuffer` -> `src/GameZRecoil/zRndr/zRndr.cpp:5808`
- `0x499130` `zRndr_TextureMip_SelectVariantImage` -> `src/GameZRecoil/zRndr/zRndr.cpp:8121`
- `0x4992b0` `zRndr_PlotPixel16` -> `src/GameZRecoil/zRndr/zRndr.cpp:5923`
- `0x4992d0` `zRndr_DrawLine16` -> `src/GameZRecoil/zRndr/zRndr.cpp:5937`
- `0x4993a0` `zRndr_DrawLine16_Segmented` -> `src/GameZRecoil/zRndr/zRndr.cpp:6000`
- `0x499500` `zRndr_DrawLine16_Clipped` -> `src/GameZRecoil/zRndr/zRndr.cpp:6087`
- `0x4997d0` `zRndr_FillSpan16Opaque` -> `src/GameZRecoil/zRndr/zRndr.cpp:6226`
- `0x499810` `zRndr_FillSpan555Solid` -> `src/GameZRecoil/zRndr/zRndr.cpp:6263`
- `0x4998a0` `zRndr_FillSpan565Solid` -> `src/GameZRecoil/zRndr/zRndr.cpp:6301`
- `0x499930` `zRndr_SetPaletteRemapKey` -> `src/GameZRecoil/zRndr/zRndr.cpp:9753`
- `0x499990` `zRndr_SetPaletteRemapKeyFromRgb01` -> `src/GameZRecoil/zRndr/zRndr.cpp:9779`
- `0x499a00` `zRndr_SetPaletteShadeRecipeIndex` -> `src/GameZRecoil/zRndr/zRndr.cpp:9805`
- `0x499a20` `zRndr_SubmitPolyWithSpanList` -> `src/GameZRecoil/zRndr/zRndr.cpp:7357`
- `0x499c40` `zRndr_SubmitTexturedPolyUniformAlphaOrShade` -> `src/GameZRecoil/zRndr/zRndr.cpp:7453`
- `0x499ec0` `zRndr_SubmitTexturedPolyPerVertexAlphaOrShade` -> `src/GameZRecoil/zRndr/zRndr.cpp:7593`
- `0x49a2b0` `zRndr_FlushTransparentQueue` -> `src/GameZRecoil/zRndr/zRndr.cpp:7876`
- `0x49a490` `zRndr_FlushOverwriteQueue` -> `src/GameZRecoil/zRndr/zRndr.cpp:7976`
- `0x49a830` `zRndr_LensFlare_QueueProjectedSample` -> `src/GameZRecoil/zRndr/zRndr.cpp:9319`
- `0x49a8b0` `zRndr_LensFlare_GetQueuedSampleCount` -> `src/GameZRecoil/zRndr/zRndr.cpp:9345`
...
- `0x49a920` `zRndr_LensFlare_DrawQueuedSamples16_AndBuildVisibleList` -> `src/GameZRecoil/zRndr/zRndr.cpp:9353`
- `0x49a9c0` `zRndr_LensFlare::BuildVisibleSampleListFromQueue` -> `src/GameZRecoil/zRndr/zRndr.cpp:9395`
- `0x49aa30` `zRndr_SpanOcclusion_FilterSampleList` -> `src/GameZRecoil/zRndr/zRndr.cpp:9685`
- `0x49aa40` `zRndr_LensFlare_SetVisibleSampleStage` -> `src/GameZRecoil/zRndr/zRndr.cpp:9427`
- `0x49aa90` `zRndr_LensFlare_DrawSampleStageClipped` -> `src/GameZRecoil/zRndr/zRndr.cpp:9449`
- `0x49afb0` `zRndr_LensFlare_DrawVisibleSample` -> `src/GameZRecoil/zRndr/zRndr.cpp:9634`
- `0x49b020` `zRndr_LensFlare_DrawVisibleSampleStages` -> `src/GameZRecoil/zRndr/zRndr.cpp:9577`
- `0x49b1a0` `zRndr_LensFlare_DrawVisibleSamples` -> `src/GameZRecoil/zRndr/zRndr.cpp:9669`
...
- `0x49b5a0` `zRndr_FogTargetColorStaged_SetRgb01Clamped` -> `src/GameZRecoil/zRndr/zRndr.cpp:9702`
