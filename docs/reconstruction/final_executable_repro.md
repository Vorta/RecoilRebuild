...
Current virtual-tail attribution in
`build/vc5-final/final_data_diff_virtual_tail_parent.json` shows the reference
`.data` tail `0x775d08..0x779ac0` is missing from the candidate image; the
corresponding candidate window `0x762d08..0x766ac0` is outside the candidate
...
The current focused deltas are:
