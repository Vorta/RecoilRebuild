...
- `C`: governed functional behavior and source coverage.
...
Inspect owner membership, functional targets, source model, traceability docblocks, touched globals and extents, table/callback/helper provenance, provider boundaries, raw object evidence, relocations, linked presence, exact RVAs and operands where applicable, and VC5-generated lifecycle or helper artifacts.
