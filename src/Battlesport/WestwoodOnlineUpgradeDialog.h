...
struct WestwoodOnlineUpgradeProgressDialog : CDialog
{
    ...
    RECOIL_NOINLINE static BOOL CALLBACK
...
struct WestwoodOnlineUpgradeDialog : CDialog
{
    ...
    RECOIL_NOINLINE int RECOIL_CDECL AppendStatusTextFmt(const char *format, ...);
    ...
    GetSelectedProfileConnectString(CString *outConnectString);
    ...
    RECOIL_NOINLINE void RECOIL_THISCALL
    AppendConnectStatusAndRefreshList(const char *sessionName);
    RECOIL_NOINLINE void RECOIL_THISCALL SetAbortAndClose();
    RECOIL_NOINLINE static int RECOIL_FASTCALL
    ShowModalAndGetSelectedMissionIndex(int *selectedMissionIndexOut);
    RECOIL_NOINLINE static int RECOIL_FASTCALL
    ShowDownloadReadyList(WestwoodOnlineUpgradeDownloadReadyEntry *readyListHead);
    RECOIL_NOINLINE static int RECOIL_STDCALL
    OnBootstrapServerList(void *callbackContext,
                          int resultCode,
