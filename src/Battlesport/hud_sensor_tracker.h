...
struct HudSensorTracker {
    ...
    int ApplyMissionDataAndReload(void* reader, const char* token, const void* missionData, unsigned int dataSize);
    ...
    void ShowObjectivePickupInfo(int visible, int startAutoAdvance, OptCatalogEntryDef* optEntry);
    int UpdateObjectiveFlow();

    static int __fastcall ZarMissionSaveCallback(zZbdSectionCallbackCtx* writer, HudSensorTracker* self);
    ...
    static void __fastcall ZarMissionLateSaveCallback(zZbdSectionCallbackCtx* writer, HudSensorTracker* self);
...
namespace HudGeom2D {
int __fastcall ClassifyPointAgainstSegment(const zVec3* segmentStart, const zVec3* segmentEnd, const zVec3* point);
}
...
int __fastcall ClipSegmentToCurrentBounds(zVec3* point0, zVec3* point1, int* point0Clipped, int* point1Clipped);
int __fastcall ClipSegmentToCurrentXBounds(zVec3* point0, zVec3* point1, int* point0Clipped, int* point1Clipped);
int __fastcall ClipSegmentToCurrentYBounds(zVec3* point0, zVec3* point1, int* point0Clipped, int* point1Clipped);
void __fastcall ClipEndpointToX(zVec3* endpoint, const zVec3* otherEndpoint, float clipX);
void __fastcall ClipEndpointToY(zVec3* endpoint, const zVec3* otherEndpoint, float clipY);
} // namespace HudLineClip
