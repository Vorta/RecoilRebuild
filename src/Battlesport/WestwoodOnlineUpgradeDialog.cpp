...
WestwoodOnlineUpgradeCDialogMessageMapAccessor::GetMessageMap()
{
...
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable, RequestListMode) ==
                     0x18);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              SubmitQueryRequest) == 0x1c);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              LoadBrowseRecord) == 0x20);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable, ResetQueryState) ==
                     0x24);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable, Disconnect) ==
                     0x34);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              SubmitEncodedQueryString) == 0x3c);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              SubmitPendingSessionList) == 0x48);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              QueueSessionRequest) == 0x54);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              RequestUpgradeDownloadReadyResult) == 0x60);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              QueryStatusWithTokenAndServer) == 0x64);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              BeginConnectWithPreparedContext) == 0x6c);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              PrepareConnectContextAndMode) == 0x70);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeApiDialogVtable,
                              LookupBrowseRecordBySessionName) == 0x80);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeProgressWndVtable,
                              DestroyWindow) == 0x60);

WestwoodOnlineUpgradeApiDialogComObject *RECOIL_CDECL GetDialogApiComObject()
{
...
RECOIL_STATIC_ASSERT(sizeof(g_WestwoodOnlineUpgradeStatusAppendBuffer) ==
                     kStatusAppendBufferSize);

void RECOIL_CDECL DestructProgressDialog(WestwoodOnlineUpgradeProgressDialog *dialog)
{
    ((CDialog *)dialog)->CDialog::~CDialog();
}

void RECOIL_CDECL DestructMainDialog(WestwoodOnlineUpgradeDialog *dialog)
{
    dialog->Destructor();
}
} // namespace
...
AFX_MSGMAP_ENTRY const WestwoodOnlineUpgradeDialog::messageEntries[] = {
    {WM_TIMER, 0, 0, 0, kMfcMessageMapSigVoidUInt,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnRefreshListTimer},
    {WM_DESTROY, 0, 0, 0, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnDestroy},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeResetBrowseRecordButtonId,
     kWestwoodOnlineUpgradeResetBrowseRecordButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::ResetSelectedBrowseRecordAndRefreshList},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeDisconnectButtonId,
     kWestwoodOnlineUpgradeDisconnectButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::BeginDisconnectAndShowProgress},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeBeginConnectButtonId,
     kWestwoodOnlineUpgradeBeginConnectButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::BeginConnect},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeCheckUpgradeButtonId,
     kWestwoodOnlineUpgradeCheckUpgradeButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::CheckAndApplyUpgrade},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeQueryStatusButtonId,
     kWestwoodOnlineUpgradeQueryStatusButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::QueryStatus},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeActiveListModeButtonId,
     kWestwoodOnlineUpgradeActiveListModeButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::RequestActiveListMode},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeRefreshCurrentQueryButtonId,
     kWestwoodOnlineUpgradeRefreshCurrentQueryButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnRefreshCurrentQuery},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeQuerySessionsByNameCommandId,
     kWestwoodOnlineUpgradeQuerySessionsByNameCommandId, kMfcMessageMapSigVoid,
    ...
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeQueueVisibleLookupCommandId,
     kWestwoodOnlineUpgradeQueueVisibleLookupCommandId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::
         QueueVisibleSessionRequestsAndLookupBrowseRecords},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeListMode0ButtonId,
     kWestwoodOnlineUpgradeListMode0ButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::RequestListMode0},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeListMode11ButtonId,
     kWestwoodOnlineUpgradeListMode11ButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::RequestListMode11},
    {WM_COMMAND, CBN_SELCHANGE, kWestwoodOnlineUpgradeSessionModeComboId,
     kWestwoodOnlineUpgradeSessionModeComboId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnSessionModeComboSelChange},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeQueryStatusFlag0CheckId,
     kWestwoodOnlineUpgradeQueryStatusFlag0CheckId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnQueryControlsChanged},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeQueryStatusFlag1CheckId,
     kWestwoodOnlineUpgradeQueryStatusFlag1CheckId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnQueryControlsChanged},
    {WM_COMMAND, BN_CLICKED, kWestwoodOnlineUpgradeSubmitPendingSessionListButtonId,
     kWestwoodOnlineUpgradeSubmitPendingSessionListButtonId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::SubmitPendingSessionListFromResults},
    {WM_COMMAND, EN_CHANGE, kWestwoodOnlineUpgradeQueryValueOrTimeEditId,
     kWestwoodOnlineUpgradeQueryValueOrTimeEditId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnQueryControlsChanged},
    {WM_COMMAND, EN_CHANGE, kWestwoodOnlineUpgradeQueryAuxParamEditId,
     kWestwoodOnlineUpgradeQueryAuxParamEditId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnQueryControlsChanged},
    {WM_COMMAND, EN_CHANGE, kWestwoodOnlineUpgradeQueryMaxPlayersEditId,
     kWestwoodOnlineUpgradeQueryMaxPlayersEditId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnMaxPlayersEditChange},
    {WM_COMMAND, LBN_DBLCLK, kWestwoodOnlineUpgradeBrowseRecordListId,
     kWestwoodOnlineUpgradeBrowseRecordListId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnBrowseRecordListDblClk},
    {WM_COMMAND, EN_KILLFOCUS, kWestwoodOnlineUpgradeQueryMaxPlayersEditId,
     kWestwoodOnlineUpgradeQueryMaxPlayersEditId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnMaxPlayersEditKillFocus},
    {WM_COMMAND, EN_KILLFOCUS, kWestwoodOnlineUpgradeQueryAuxParamEditId,
     kWestwoodOnlineUpgradeQueryAuxParamEditId, kMfcMessageMapSigVoid,
     (AFX_PMSG)&WestwoodOnlineUpgradeDialog::OnAuxParamEditKillFocus},
    {WM_COMMAND, EN_KILLFOCUS, kWestwoodOnlineUpgradeQueryValueOrTimeEditId,
     kWestwoodOnlineUpgradeQueryValueOrTimeEditId, kMfcMessageMapSigVoid,
...
WestwoodOnlineUpgradeDialog::GetMessageMap() const
{
...
WestwoodOnlineUpgradeDialog::OnInitDialogBootstrap()
{
    ...
    m_sessionName.Format(
        zLoc::GetMessageString(kWolDialogDefaultSessionNameMessageId));

    for (int index = 0; index < kWolSessionModeCount; ++index)
    {
        LRESULT const itemIndex =
            ::SendMessageA(m_sessionModeCombo.m_hWnd,
                         CB_ADDSTRING,
                         0,
    ...
    ((CWnd *)this)
        ->SetDlgItemTextA(kWestwoodOnlineUpgradeStatusCaptionLabelId,
    ...
    ::SendMessageA(m_sessionNameEdit.m_hWnd,
                 EM_LIMITTEXT,
                 kWolSessionNameEditLimit,
                 0);
    ::SendMessageA(m_serverAddressEdit.m_hWnd,
                 EM_LIMITTEXT,
                 kWolServerAddressEditLimit,
                 0);
    ::SendMessageA(m_statusServerEdit.m_hWnd,
                 EM_LIMITTEXT,
                 kWolStatusServerEditLimit,
                 0);
    ::SendMessageA(m_statusTokenEdit.m_hWnd,
                 EM_LIMITTEXT,
                 kWolStatusTokenEditLimit,
                 0);
    ::SendMessageA(m_statusList.m_hWnd,
...
WestwoodOnlineUpgrade::TruncateStringAtFirstSpace(char *text)
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE WestwoodOnlineUpgradeDialog *RECOIL_THISCALL
...
WestwoodOnlineUpgradeDialog::Destructor()
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE WestwoodOnlineUpgradeDialog *RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::ScalarDeletingDestructor(unsigned int flags)
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::DoDataExchange(CDataExchange *dataExchange)
{
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeServerAddressEditId,
                *((CWnd *)&m_serverAddressEdit));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeStatusTokenEditId,
                *((CWnd *)&m_statusTokenEdit));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeQueryValueOrTimeEditId,
                *((CWnd *)&m_queryValueOrTimeEdit));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeQueryMaxPlayersEditId,
                *((CWnd *)&m_queryMaxPlayersEdit));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeQueryAuxParamEditId,
                *((CWnd *)&m_queryAuxParamEdit));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeQueryStatusFlag1CheckId,
                *((CWnd *)&m_queryStatusFlag1Check));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeQueryStatusFlag0CheckId,
                *((CWnd *)&m_queryStatusFlag0Check));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeSubmitPendingSessionListButtonId,
                *((CWnd *)&m_submitPendingSessionListButton));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeConnectButtonId,
                *((CWnd *)&m_connectButton));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeQuerySessionsByNameButtonId,
                *((CWnd *)&m_querySessionsByNameButton));
    DDX_Control(dataExchange,
                kWestwoodOnlineUpgradeQueueVisibleSessionRequestsButtonId,
                *((CWnd *)&m_queueVisibleSessionRequestsButton));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeStatusListId,
                *((CWnd *)&m_statusList));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeSessionModeComboId,
                *((CWnd *)&m_sessionModeCombo));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeSessionResultsListId,
                *((CWnd *)&m_sessionResultsList));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeStatusServerEditId,
                *((CWnd *)&m_statusServerEdit));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeSessionNameEditId,
                *((CWnd *)&m_sessionNameEdit));
    DDX_Control(dataExchange, kWestwoodOnlineUpgradeBrowseRecordListId,
                *((CWnd *)&m_browseRecordList));
    DDX_Text(dataExchange, kWestwoodOnlineUpgradeQueryAuxParamEditId,
             m_queryAuxParam);
    DDX_Text(dataExchange, kWestwoodOnlineUpgradeQueryMaxPlayersEditId,
             m_queryMaxPlayers);
    DDX_Text(dataExchange, kWestwoodOnlineUpgradeQueryValueOrTimeEditId,
             m_queryValueOrTime);
    DDX_Check(dataExchange, kWestwoodOnlineUpgradeQueryStatusFlag0CheckId,
              (int &)m_queryStatusFlagBit0);
    DDX_Check(dataExchange, kWestwoodOnlineUpgradeQueryStatusFlag1CheckId,
...
WestwoodOnlineUpgradeDialog::AppendStatusTextFmt(const char *format, ...)
{
    va_list args;
    ...
    {
        return (int)::SendMessageA(m_statusList.m_hWnd, LB_SETTOPINDEX,
                                 m_statusLineCount - kStatusListScrollBackCount, 0);
    }
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::ClearStatusList()
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::SetSelectedProfilePlayerName(CString playerName)
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::SetSelectedProfileConnectString(CString connectString)
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE CString *RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::GetSelectedProfilePlayerName(CString *outName)
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE CString *RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::GetSelectedProfileConnectString(CString *outConnectString)
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnRefreshListTimer(UINT_PTR)
{
    Time::Tick();
    if (g_WestwoodOnlineUpgradeProcessCallbacksFlag != 0)
    {
            ...
            g_WestwoodOnlineUpgradeNextAutoRefreshTime)
        {
            ...
            g_WestwoodOnlineUpgradeNextAutoRefreshTime =
                ...
                kWestwoodOnlineUpgradeAutoRefreshIntervalSec;
            api->vftable->RequestListMode(
                (IUnknown *)api, kWestwoodOnlineUpgradeAutoRefreshListMode, 1);
        }
    }
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::BeginDisconnectAndShowProgress()
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::BeginConnect()
{
    WestwoodOnlineUpgradeConnectContext context;
    ((CWnd *)&m_statusServerEdit)
    ...
    if (api->vftable->PrepareConnectContextAndMode((IUnknown *)api,
                                                   &context) != 0)
    {
        mode = 1;
    ...
    api = GetDialogApiComObject();
    api->vftable->BeginConnectWithPreparedContext((IUnknown *)api,
                                                  &context,
                                                  mode);
}
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE int RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::CheckAndApplyUpgrade()
{
    WestwoodOnlineUpgradeConnectContext context;
    ((CWnd *)&m_statusServerEdit)
        ->GetWindowTextA(context.m_requestText, kWolConnectRequestTextMaxChars);
    ...
    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
    return api->vftable->RequestUpgradeDownloadReadyResult((IUnknown *)api,
                                                           &context);
}
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE int RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::QueryStatus()
{
    char tokenInputText[kWolQueryStatusTokenTextBufferSize];
    ((CWnd *)&m_statusTokenEdit)
        ->GetWindowTextA(tokenInputText, kWolQueryStatusTokenTextMaxChars);
    ...
    if (token != 0)
    {
        ...
        WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
        return api->vftable->QueryStatusWithTokenAndServer((IUnknown *)api,
                                                           &tokenContext,
                                                           serverText);
    }

    char messageBoxTitle[kWolQueryStatusMessageBoxTitleBufferSize];
    strcpy(messageBoxTitle,
...
WestwoodOnlineUpgradeDialog::UpdateSessionListQueryFromControls()
{
    ...
    LRESULT const selectedMode =
        ::SendMessageA(g_pWestwoodOnlineUpgradeDialog->m_sessionModeCombo.m_hWnd,
                     CB_GETCURSEL,
                     0,
                     0);
    WestwoodOnlineUpgradeDialog *const dialog = g_pWestwoodOnlineUpgradeDialog;
    encodedQuery.Format(kWolEncodedSessionListQueryFormat,
                        selectedMode,
    ...
    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
    api->vftable->SubmitEncodedQueryString((IUnknown *)api, encodedQuery);
}

// Reimplements 0x43e680: WestwoodOnlineUpgradeDialog::RequestActiveListMode
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::RequestActiveListMode()
{
    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
    api->vftable->RequestListMode((IUnknown *)api,
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnRefreshCurrentQuery()
{
    ...
    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
    int const result =
        api->vftable->SubmitQueryRequest((IUnknown *)api, &request);
    if (result < 0)
    {
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnQuerySessionsByName()
{
    CString sessionNameText;
    ((CWnd *)&m_sessionNameEdit)->GetWindowTextA(sessionNameText);
    sessionNameText.TrimLeft();
    ...
    ((CWnd *)&m_serverAddressEdit)
        ->GetWindowTextA(request.m_serverAddress,
...
WestwoodOnlineUpgradeDialog::SubmitVisibleSessionRequestsAndStatusText()
{
    ...
    {
        api->vftable->SubmitStatusText((IUnknown *)api, pendingStatusText);
        AppendStatusTextFmt(kWolSubmitStatusAppendFormat,
    ...
    ::SendMessageA(m_sessionResultsList.m_hWnd,
                 LB_GETSELITEMS,
    ...
    for (int rowIndex = 0;
         rowIndex < g_WestwoodOnlineUpgradeVisibleSessionResultCount;
         ++rowIndex)
    {
        ...
        WestwoodOnlineUpgrade::TruncateStringAtFirstSpace(
    ...
    if (sessionRequest != 0)
    {
        ...
        zLoc::FormatMessage(statusFormatBuffer,
    ...
    {
        WestwoodOnlineUpgradeSessionRequest *const nextSessionRequest =
            sessionRequestList->m_next;
    ...
    WestwoodOnlineUpgradeBootstrapServerRecord *serverList)
{
    ...
    while (server != 0)
    {
        if (strcmp(server->m_serverType, kWolBootstrapServerTypeIrc) == 0 &&
            foundIrcServer == 0)
        {
            memcpy(&g_WestwoodOnlineUpgradeSelectedBootstrapServer,
                   server,
...

    {
        ...
        strcpy(g_WestwoodOnlineUpgradeSelectedBootstrapServer.m_playerName,
...

    {
        ...
        g_pWestwoodOnlineUpgradeDialog->GetSelectedProfileConnectString(
            &connectString);
        strcpy(g_WestwoodOnlineUpgradeSelectedBootstrapServer.m_connectString,
...
WestwoodOnlineUpgradeDialog::QueueVisibleSessionRequests()
{
         ...
         ++rowIndex)
    {
        ...
        WestwoodOnlineUpgrade::TruncateStringAtFirstSpace(
            sessionRequest->m_sessionName);
        if (strstr(sessionRequest->m_sessionName,
                   (const char *)m_selectedProfilePlayerName) == 0)
        {
            WestwoodOnlineUpgradeApiDialogComObject *const api =
                GetDialogApiComObject();
            api->vftable->QueueSessionRequest((IUnknown *)api, sessionRequest);
        }
    }
    delete sessionRequest;
}

// Reimplements 0x43ed10: WestwoodOnlineUpgradeDialog::QueueVisibleSessionRequestsAndLookupBrowseRecords
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::QueueVisibleSessionRequestsAndLookupBrowseRecords()
{
         ...
         ++rowIndex)
    {
        ...
        if (strstr(sessionRequest->m_sessionName,
                   (const char *)m_selectedProfilePlayerName) == 0)
        {
            WestwoodOnlineUpgradeApiDialogComObject *api =
                GetDialogApiComObject();
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnBrowseRecordListDblClk()
{
    LRESULT const selectedIndex =
        ::SendMessageA(m_browseRecordList.m_hWnd, LB_GETCURSEL, 0, 0);
    if (selectedIndex != LB_ERR &&
        g_WestwoodOnlineUpgradeCachedBrowseRecord.m_sessionName[0] != '\0')
    {
        if (strcmp(g_WestwoodOnlineUpgradeCachedBrowseRecord.m_sessionName,
    ...
    WestwoodOnlineUpgradeBrowseRecord *const selectedRecord =
        &g_WestwoodOnlineUpgradeCachedBrowseRecordList[selectedIndex];
    ((CWnd *)&m_serverAddressEdit)
        ->GetWindowTextA(selectedRecord->m_serverAddress,
                         kWolQuerySessionsByNameServerTextMaxChars);
    ((CWnd *)&m_serverAddressEdit)->SetWindowTextA(selectedRecord->m_serverAddress);

    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
    int const result =
        api->vftable->LoadBrowseRecord((IUnknown *)api, selectedRecord);
    if (result == kWolQueryDuplicateNameResult)
    {
        g_pWestwoodOnlineUpgradeDialog->AppendStatusTextFmt(
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::RequestListMode0()
{
    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
    g_WestwoodOnlineUpgradeActiveListMode = 0;
    api->vftable->RequestListMode((IUnknown *)api, 0, 0);
}

// Reimplements 0x43ee60: WestwoodOnlineUpgradeDialog::RequestListMode11
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::RequestListMode11()
{
    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnSessionModeComboSelChange()
{
    LRESULT const selectedIndex =
        ::SendMessageA(m_sessionModeCombo.m_hWnd, CB_GETCURSEL, 0, 0);
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::SubmitPendingSessionListFromResults()
{
    if (g_WestwoodOnlineUpgradeCachedBrowseRecord.m_sessionName[0] == '\0' ||
        g_WestwoodOnlineUpgradeCreateSessionFromQueryFlag != 1)
    {
    ...
    WestwoodOnlineUpgradeSessionRequest *sessionRequestList = 0;
    for (int rowIndex = 0;
         rowIndex < g_WestwoodOnlineUpgradePendingSessionResultCount;
         ++rowIndex)
    {
        WestwoodOnlineUpgradeSessionRequest *sessionRequest =
            new WestwoodOnlineUpgradeSessionRequest;
        memset(sessionRequest, 0, sizeof(WestwoodOnlineUpgradeSessionRequest));
        if (::SendMessageA(m_sessionResultsList.m_hWnd,
                         LB_GETTEXT,
                         rowIndex,
                         (LPARAM)sessionRequest->m_sessionName) == LB_ERR)
        {
            delete sessionRequest;
        }
        else
    ...
    WestwoodOnlineUpgradeApiDialogComObject *const api = GetDialogApiComObject();
    api->vftable->SubmitPendingSessionList((IUnknown *)api, sessionRequestList);
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnQueryControlsChanged()
{
    UpdateSessionListQueryFromControls();
}
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnMaxPlayersEditChange()
{
    ((CWnd *)g_pWestwoodOnlineUpgradeDialog)->UpdateData(1);
}
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnMaxPlayersEditKillFocus()
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnAuxParamEditKillFocus()
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnValueOrTimeEditKillFocus()
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::OnDestroy()
{
    ...
    WestwoodOnlineUpgradeProgressWndVtable *const progressVtable =
        (WestwoodOnlineUpgradeProgressWndVtable *)
            (*(void **)g_pWestwoodOnlineUpgradeProgressDialog);
    progressVtable->DestroyWindow((CWnd *)g_pWestwoodOnlineUpgradeProgressDialog, 0);
}

// Reimplements 0x43d6b0: WestwoodOnlineUpgradeDialog::EnableQueryControls
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::EnableQueryControls(int enable)
{
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::EnableConnectButton(int enable)
{
    ((CWnd *)&m_connectButton)->EnableWindow(enable);
}
...
// (D:\Proj\Battlesport\WestwoodOnlineUpgradeDialog.cpp)
RECOIL_NOINLINE void RECOIL_THISCALL
WestwoodOnlineUpgradeDialog::AppendConnectStatusAndRefreshList(const char *sessionName)
{
...
WestwoodOnlineUpgradeDialog::ShowModalAndGetSelectedMissionIndex(int *selectedMissionIndexOut)
{
    unsigned int dialogStorage[(sizeof(WestwoodOnlineUpgradeDialog) +
                                kStackStorageUnitSize - 1) /
                               kStackStorageUnitSize];
    unsigned int progressDialogStorage[(sizeof(WestwoodOnlineUpgradeProgressDialog) +
                                        kStackStorageUnitSize - 1) /
                                       kStackStorageUnitSize];
