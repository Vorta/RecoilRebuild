...
typedef int(__fastcall* zNetworkPacketHandler)(int senderPlayerId, zNetworkPacketHeader* packet);
...
enum { kZNetworkSessionNameCacheBytes = 0x50, kZNetworkStatusSessionNameBytes = 0x5c };
...
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlayServiceProviderInfo, displayName) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlayServiceProviderInfo, connectionData) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlayServiceProviderInfo, providerFlags) == 0x18);
...
int __fastcall zNetworkDPlaySendUnreliable(zNetworkPacketHeader* packet, unsigned int packetSizeBytes);
int __fastcall zNetworkDPlaySendReliable(zNetworkPacketHeader* packet, unsigned int packetSizeBytes);
int __fastcall zNetworkDPlaySendExUnreliableTracked(zNetworkPacketHeader* packet, unsigned int packetSizeBytes);
int __fastcall zNetworkDPlaySendExReliable(zNetworkPacketHeader* packet, unsigned int packetSizeBytes);
...
int __fastcall zNetworkDPlayReportError(int hresult, const char* sourceFile, int sourceLine);
int __fastcall zNetworkApplyPkt01PlayerColorAssignments(int senderPlayerId, zNetworkPacketHeader* packet);
...
int __fastcall zNetworkExtractStatusFieldsFromSessionDesc(zNetworkSessionDescStatusFields* outFields);
int __fastcall zNetworkApplyStatusFieldsToSessionDesc(zNetworkSessionDescStatusFields* statusFields);
}
...
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlayCaps, dwFlags) == 0x04);
RECOIL_STATIC_ASSERT(sizeof(zNetworkDPlaySessionDesc) == 0x50);
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlaySessionDesc, dwMaxPlayers) == 0x28);
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlaySessionDesc, lpszSessionNameA) == 0x30);
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlaySessionDesc, dwUser1) == 0x40);
