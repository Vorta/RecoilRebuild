...
typedef int (RECOIL_STDCALL *zNetworkDPlayEnumSessionsCallback)(
    zNetworkDPlaySessionDesc *sessionDesc, unsigned int *timeoutMs, unsigned int flags,
    void *context);
typedef int (RECOIL_STDCALL *zNetworkDPlayEnumConnectionsCallback)(
    ...
    zNetworkDPlayName *providerName, unsigned int providerFlags, void *context);
...
struct zNetwork_DPlay4Vtable {
    ...
    void *reserved_14;
    int(RECOIL_STDCALL *CreatePlayer_18)(zNetwork_DPlay4 *self, unsigned int *playerId,
                                         zNetworkDPlayName *playerNameInfo, void *eventHandle,
                                         void *data, unsigned int dataSize, unsigned int flags);
    void *reserved_1c[2];
    ...
    int(RECOIL_STDCALL *EnumPlayers_30)(zNetwork_DPlay4 *self, void *sessionGuid,
                                        ...
                                        unsigned int flags);
    int(RECOIL_STDCALL *EnumSessions_34)(zNetwork_DPlay4 *self,
                                         zNetworkDPlaySessionDesc *sessionDesc,
                                         unsigned int timeoutMs,
                                         zNetworkDPlayEnumSessionsCallback callback, void *context,
                                         unsigned int flags);
    int(RECOIL_STDCALL *GetCaps_38)(zNetwork_DPlay4 *self, zNetworkDPlayCaps *caps,
                                    unsigned int flags);
    void *reserved_3c[4];
    int(RECOIL_STDCALL *GetPlayerCaps_4c)(zNetwork_DPlay4 *self, unsigned int playerId,
                                          zNetworkDPlayCaps *caps, unsigned int flags);
    void *reserved_50[3];
    void *reserved_5c;
    int(RECOIL_STDCALL *Open_60)(zNetwork_DPlay4 *self,
                                 zNetworkDPlaySessionDesc *sessionDesc, unsigned int flags);
    ...
    int(RECOIL_STDCALL *EnumConnections_8c)(
        zNetwork_DPlay4 *self, unsigned char *applicationGuid,
        zNetworkDPlayEnumConnectionsCallback callback, void *context, unsigned int flags);
    void *reserved_90[2];
    int(RECOIL_STDCALL *InitializeConnection_98)(zNetwork_DPlay4 *self,
                                                 void *connectionData,
                                                 unsigned int flags);
    void *reserved_9c[10];
...
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, Release_08) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, Close_10) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, CreatePlayer_18) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, DestroyPlayer_24) == 0x24);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, GetCaps_38) == 0x38);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, GetPlayerCaps_4c) == 0x4c);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, Open_60) == 0x60);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, Send_68) == 0x68);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, SetSessionDesc_7c) == 0x7c);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, EnumConnections_8c) == 0x8c);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, InitializeConnection_98) == 0x98);
...
RECOIL_STATIC_ASSERT(offsetof(zNetwork_PlayerRecord, createPlayerEventHandle) == 0x3c);
...
RECOIL_STATIC_ASSERT(offsetof(zNetworkDPlayCaps, flags) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(zNetwork_DPlay4Vtable, EnumSessions_34) == 0x34);
