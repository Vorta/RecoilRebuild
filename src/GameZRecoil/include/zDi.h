...
RECOIL_STATIC_ASSERT(offsetof(zDiPartial, scrollRateU) == 0x24);
RECOIL_STATIC_ASSERT(offsetof(zDiPartial, scrollRateV) == 0x28);
...
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceSegmentEndpoints, end) == 0x0c);
RECOIL_STATIC_ASSERT(sizeof(CZDisplayInstanceSegmentEndpoints) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceSegmentBounds, maxX) == 0x0c);
RECOIL_STATIC_ASSERT(sizeof(CZDisplayInstanceSegmentBounds) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, filterRegionsNodeNamePrefix) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, filterRegionsCenter) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, filterRegionsRadiusSq) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, filterRegionsEnableClearanceCheck) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, filterRegionsLineOfSightWorld) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, filterRegionsOutHitList) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, breakOnFirstCandidate) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, stopAfterFirstHit) == 0x1c);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, pickQueryPoint) == 0x20);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, segmentEnd) == 0x2c);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, segmentBounds) == 0x38);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, pickCandidateBuffer) == 0x158);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, pickCandidateCursor) == 0x15c);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, pickPointQueryMaxY) == 0x160);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, pickPointArray) == 0x164);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, pickPointCount) == 0x168);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayInstanceRaycastFilterRuntime, unused_16c) == 0x16c);
