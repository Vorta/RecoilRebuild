...
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, auxFlags) == 0x28);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, boundsFlags) == 0x2c);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, classId) == 0x34);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, name) == 0x00);
RECOIL_STATIC_ASSERT(sizeof(((CZNodePartial*)0)->name) == 0x24);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, nodeType) == 0x30);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, classData) == 0x38);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, userDataOrDiRef) == 0x3c);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, callbackContext) == 0x40);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, callbackPriority) == 0x44);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, actionCallback) == 0x48);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, gridCol) == 0x4c);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, gridRow) == 0x50);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, listCountA) == 0x54);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, listA) == 0x58);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, listCountB) == 0x5c);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, listB) == 0x60);
RECOIL_STATIC_ASSERT(offsetof(CZNodePartial, cachedBounds) == 0x74);
RECOIL_STATIC_ASSERT(sizeof(CZNodePartial) == 0x8c);
RECOIL_STATIC_ASSERT(sizeof(CZTypeListLink) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZTypeListBucket, head) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZTypeListBucket, tail) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZTypeListBucket, pendingRemovalDirty) == 0x08);
RECOIL_STATIC_ASSERT(sizeof(CZTypeListBucket) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZNodeFreeListSlot, primaryBounds) == 0x8c);
RECOIL_STATIC_ASSERT(offsetof(CZNodeFreeListSlot, secondaryBounds) == 0xa4);
RECOIL_STATIC_ASSERT(offsetof(CZNodeFreeListSlot, damageHandler) == 0xbc);
RECOIL_STATIC_ASSERT(offsetof(CZNodeFreeListSlot, freeTag) == 0xc0);
RECOIL_STATIC_ASSERT(sizeof(CZNodeFreeListSlot) == 0xc4);
RECOIL_STATIC_ASSERT(sizeof(CZZbdHeader) == 0x24);
RECOIL_STATIC_ASSERT(offsetof(CZZbdHeader, texDirArg) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZZbdHeader, texDirOffset) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZZbdHeader, matlOffset) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZZbdHeader, model3dOffset) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZZbdHeader, nodeCount) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZZbdHeader, nodeFreeHead) == 0x1c);
RECOIL_STATIC_ASSERT(offsetof(CZZbdHeader, nodeTableOffset) == 0x20);
...
RECOIL_STATIC_ASSERT(offsetof(OptCatalogDamageHandlerPartial, timerContext) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(OptCatalogDamageHandlerPartial, timerCallback) == 0x0c);
RECOIL_STATIC_ASSERT(sizeof(OptCatalogDamageHandlerPartial) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZWindowClearPoly, vertices) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZWindowClearPoly, vertCount) == 0x30);
RECOIL_STATIC_ASSERT(sizeof(CZWindowClearPoly) == 0x34);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, flags) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, alphaScale) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, color) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, colorAlpha) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, rotation) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, scale) == 0x24);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, localMatrix) == 0x30);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DDataPartial, cachedWorldMatrix) == 0x60);
RECOIL_STATIC_ASSERT(sizeof(CZObject3DDataPartial) == 0x90);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateDataPartial, statusFlags) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateDataPartial, animatedTransform) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateDataPartial, savedParentMatrix) == 0x38);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateDataPartial, runtime) == 0x68);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, keyframes) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, sampledRotation) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, sampledPosition) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, sampledScale) == 0x20);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, outputRotationScale) == 0x2c);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, outputPositionScale) == 0x38);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, outputScaleScale) == 0x44);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, duration) == 0x50);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, currentTime) == 0x58);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, loopBase) == 0x5c);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, startTime) == 0x60);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, state) == 0x64);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, maxFrameIndex) == 0x68);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateRuntimePartial, loopCount) == 0x6a);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateKeyframePartial, rotation) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateKeyframePartial, position) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateKeyframePartial, scale) == 0x18);
RECOIL_STATIC_ASSERT(sizeof(CZAnimateKeyframePartial) == 0x24);
RECOIL_STATIC_ASSERT(sizeof(CZAnimateRuntimePartial) == 0x6c);
RECOIL_STATIC_ASSERT(
    offsetof(CZAnimateDataPartial, runtime) + offsetof(CZAnimateRuntimePartial, sampledRotation) == 0x70
);
RECOIL_STATIC_ASSERT(
    offsetof(CZAnimateDataPartial, runtime) + offsetof(CZAnimateRuntimePartial, sampledPosition) == 0x7c
);
RECOIL_STATIC_ASSERT(offsetof(CZAnimateDataPartial, runtime) + offsetof(CZAnimateRuntimePartial, sampledScale) == 0x88);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, viewportWidth) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, viewportHeight) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, resolutionWidth) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, resolutionHeight) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, clearPolys) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, clearPolyIndexFlags) == 0xe0);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, bufferIndex) == 0xe4);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, buffer) == 0xe8);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, fbWidth) == 0xec);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, fbHeight) == 0xf0);
RECOIL_STATIC_ASSERT(offsetof(CZWindowDataPartial, fbBpp) == 0xf4);
RECOIL_STATIC_ASSERT(sizeof(CZWindowDataPartial) == 0xf8);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayDataPartial, x) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayDataPartial, y) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayDataPartial, width) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayDataPartial, height) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayDataPartial, backgroundR) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayDataPartial, backgroundG) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZDisplayDataPartial, backgroundB) == 0x18);
...
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, pendingAreaUpdateCount) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, pendingAreaUpdateCapacity) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, pendingAreaUpdates) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, fogState) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, ambientColor) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, originX) == 0x34);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, originZ) == 0x38);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, worldMaxX) == 0x44);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, worldMaxZ) == 0x48);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, partitionMaxDecFeatureCount) == 0x4c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, clampQueriesToBounds) == 0x50);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaCellSizeX) == 0x54);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaCellSizeZ) == 0x58);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaHalfSizeX) == 0x5c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaHalfSizeZ) == 0x60);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaInvSizeX) == 0x64);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaInvSizeZ) == 0x68);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaCellRadiusBias) == 0x6c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, partitionInclusionTolX) == 0x70);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, partitionInclusionTolZ) == 0x74);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaGridColCount) == 0x78);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaGridRowCount) == 0x7c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaGridRows) == 0x80);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, scaleX) == 0x84);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, scaleY) == 0x88);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, scaleZ) == 0x8c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, lightCount) == 0x90);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, lightNodes) == 0x94);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, lightDataList) == 0x98);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, soundCount) == 0x9c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, soundNodes) == 0xa0);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, soundDataList) == 0xa4);
RECOIL_STATIC_ASSERT(offsetof(CZWorldDataPartial, areaGridExternalOwnership) == 0xa8);
RECOIL_STATIC_ASSERT(sizeof(CZWorldDataPartial) == 0xac);
RECOIL_STATIC_ASSERT(offsetof(CZWorldSettingsSectionRecord, fogState) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZWorldSettingsSectionRecord, fogColorRgb01) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZWorldSettingsSectionRecord, fogRangeNear) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZWorldSettingsSectionRecord, fogRangeFar) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZWorldSettingsSectionRecord, fogAltitudeHigh) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZWorldSettingsSectionRecord, fogAltitudeLow) == 0x1c);
RECOIL_STATIC_ASSERT(offsetof(CZWorldSettingsSectionRecord, fogDensity) == 0x20);
RECOIL_STATIC_ASSERT(sizeof(CZWorldSettingsSectionRecord) == 0x24);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, sample) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, playHandle) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, sampleSetName) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, runtimeFlags) == 0x2c);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, localPosition) == 0x30);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, worldPos) == 0x3c);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, savedParentMatrix) == 0x48);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, falloffMode) == 0x78);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, rangeMin) == 0x7c);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, rangeMax) == 0x80);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, rangeMaxSq) == 0x84);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, invRangeSpan) == 0x88);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, attachedWorldCount) == 0x8c);
RECOIL_STATIC_ASSERT(offsetof(CZSoundDataPartial, attachedWorlds) == 0x90);
RECOIL_STATIC_ASSERT(sizeof(CZSoundDataPartial) == 0x94);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, isActive) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, repeatAtBounds) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, wrapAtBounds) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, isPaused) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, step) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, currentIndex) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, currentTime) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, entryCount) == 0x1c);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceDataPartial, entries) == 0x20);
RECOIL_STATIC_ASSERT(offsetof(CZSequenceEntryPartial, node) == 0x00);
...
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, nearRangeSq) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, nearRange) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, farRangeSq) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, fadeWidth) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, fadeAmount) == 0x1c);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, fadeEndScale) == 0x28);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, fogFadeWidth) == 0x34);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, vertexShadingAmount) == 0x40);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, active) == 0x44);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, rangeNode) == 0x48);
RECOIL_STATIC_ASSERT(offsetof(CZLodDataPartial, rangeSq) == 0x4c);
RECOIL_STATIC_ASSERT(sizeof(CZLodDataPartial) == 0x50);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, worldPosScratch) == 0x68);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, viewPos) == 0x80);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, localRotation) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, localPosition) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, worldRotation) == 0x20);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, worldPosition) == 0x2c);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, savedParentMatrix) == 0x38);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, worldDir) == 0x8c);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, falloff) == 0xa4);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, intensityScale) == 0xa8);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, specularColor) == 0xac);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, isDirectional) == 0xb8);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, isDirectedSource) == 0xbc);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, isPointSource) == 0xc0);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, lightParam) == 0xc4);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, lightSubMode) == 0xc8);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, range1) == 0xcc);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, range2) == 0xd0);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, range2Sq) == 0xd4);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, invRangeDelta) == 0xd8);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, attachedWorldCount) == 0xdc);
RECOIL_STATIC_ASSERT(offsetof(CZLightDataPartial, attachedWorlds) == 0xe0);
...
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, worldNode) == 0x00);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, windowNode) == 0x04);
...
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, forwardDir) == 0x74);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, worldTarget) == 0xa4);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, nearClip) == 0xb0);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, farClip) == 0xb4);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, nearClipCenter) == 0xb8);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, farClipCenter) == 0xc4);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, clipDistance) == 0xd0);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, invClipDistanceSq) == 0xd4);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, viewportWidth) == 0xd8);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, viewportHeight) == 0xdc);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, frustumWidth) == 0xe0);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, frustumHeight) == 0xe4);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, fovX) == 0xe8);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, fovY) == 0xec);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, frustumYaw) == 0xf0);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, frustumPitch) == 0xf4);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, frustumVectorsDirty) == 0xf8);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, frustumOrigin) == 0xfc);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, frustumCorners) == 0x108);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, localFrustumNormalsDirty) == 0x138);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, localFrustumLeftNormal) == 0x13c);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, localFrustumRightNormal) == 0x148);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, localFrustumBottomNormal) == 0x154);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, localFrustumTopNormal) == 0x160);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, localFrustumNearNormal) == 0x16c);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, localFrustumFarNormal) == 0x178);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, transformDirty) == 0x184);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, worldFrustumNormals) == 0x188);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, viewportScaleX) == 0x1d4);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, viewportScaleY) == 0x1d8);
RECOIL_STATIC_ASSERT(offsetof(CZCameraDataPartial, variantOverrideEnabled) == 0x1e0);
 ...
 */
inline CZNodeFreeListSlot* zClassNodeSlotFromNode(CZNodePartial* node)
{
 ...
 */
inline const CZNodeFreeListSlot* zClassNodeSlotFromNode(const CZNodePartial* node)
{
 ...
 * bounding box.
 */
inline zVec3* zClassNodeViewSphereCenter(CZNodePartial* node)
{
 ...
 * bounding box.
 */
inline const zVec3* zClassNodeViewSphereCenter(const CZNodePartial* node)
{
 ...
 * bounding box.
 */
inline float* zClassNodeViewSphereRadius(CZNodePartial* node)
{
 ...
 * bounding box.
 */
inline const float* zClassNodeViewSphereRadius(const CZNodePartial* node)
{
    return &node->cachedSphereCenter[3];
}
...
RECOIL_STATIC_ASSERT(offsetof(CZObject3DModelRefLerpTask, callbackCtx) == 0x04);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DModelRefLerpTask, onComplete) == 0x08);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DModelRefLerpTask, invertModelRef) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DModelRefLerpTask, targetModelRef) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DModelRefLerpTask, currentModelRef) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DModelRefLerpTask, modelRefDeltaPerSec) == 0x18);
RECOIL_STATIC_ASSERT(offsetof(CZObject3DModelRefLerpTask, next) == 0x1c);
 ...
 */
inline CZTypeListBucket& Bucket(int bucket)
{
 ...
 */
inline CZTypeListLink*& Head(int bucket)
{
 ...
 */
inline CZTypeListLink*& Tail(int bucket)
{
 ...
 * type-list bucket.
 */
inline int& PendingRemovalDirty(int bucket)
{
    switch (bucket) {
    case 0:
 ...
 */
inline void SetPendingRemovalDirty(int bucket, int value)
{
    switch (bucket) {
    case 0:
