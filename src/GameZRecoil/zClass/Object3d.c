...
namespace CZObject3D
{
    ...
    {
        if (node == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0xe8, "Null node pointer.");
            return 5;
        }
        if (node->classData == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0xe9, "Null class data pointer");
            return 5;
        }
     ...
     */
    RemoveChild(CZNodePartial * parent, CZNodePartial * child)
    {
        if (parent == 0) {
    ...
    {
        if (node == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0x21f, "Null node pointer.");
            return 5;
        }

        CZObject3DDataPartial* data = (CZObject3DDataPartial*)(node->classData);
        if (data == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0x220, "Null class data pointer");
            return 5;
        }
    ...
    {
        if (node == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0x238, "Null node pointer.");
            return 5;
        }

        CZObject3DDataPartial* data = (CZObject3DDataPartial*)(node->classData);
        if (data == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0x239, "Null class data pointer");
            return 5;
        }
    ...
    {
        if (node == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0x254, "Null node pointer.");
            return 5;
        }

        CZObject3DDataPartial* data = (CZObject3DDataPartial*)(node->classData);
        if (data == 0) {
            zError::ReportOld(0x400, "D:\\Proj\\GameZRecoil\\zClass\\Object3d.c", 0x255, "Null class data pointer");
            return 5;
        }
