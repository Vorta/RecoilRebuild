...
int __fastcall ReportA3DError(int a3dError, const char* sourceFile, int sourceLine)
{
    ...
    if (a3dError <= 0) {
        if (a3dError != 0) {
            ...
            case 0x80040039u:
                ...
                break;
            default:
                sprintf(errorNameStorage, g_Player_MasterTypeName_Unknown);
                break;
            }
        } else {
            return 1;
    ...
    zError::ReportOld(0x400, sourceFile, sourceLine, g_zSnd_A3DErrorFmt, errorNameStorage);
    return 0;
}
...
int __fastcall ReportDirectSoundError(int directSoundError, const char* sourceFile, int sourceLine)
{
    ...
    case DSERR_GENERIC:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_Generic);
        break;
    case DSERR_UNSUPPORTED:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_Unsupported);
        break;
    case DSERR_OUTOFMEMORY:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_OutOfMemory);
        break;
    case DSERR_NOAGGREGATION:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_NoAggregation);
        break;
    case DSERR_INVALIDPARAM:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_InvalidParam);
        break;
    case DSERR_ALLOCATED:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_Allocated);
        break;
    case DSERR_CONTROLUNAVAIL:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_ControlUnavail);
        break;
    case DSERR_INVALIDCALL:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_InvalidCall);
        break;
    case DSERR_PRIOLEVELNEEDED:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_PrioLevelNeeded);
        break;
    case DSERR_BADFORMAT:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_BadFormat);
        break;
    case DSERR_NODRIVER:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_NoDriver);
        break;
    case DSERR_ALREADYINITIALIZED:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_AlreadyInitialized);
        break;
    case DSERR_BUFFERLOST:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_BufferLost);
        break;
    case DSERR_OTHERAPPHASPRIO:
        sprintf(errorNameStorage, g_zSnd_DsErrorName_OtherAppHasPrio);
        break;
    case DS_OK:
        return 1;
    default:
    ...
    zError::ReportOld(0x400, sourceFile, sourceLine, g_zSnd_DirectSoundErrorFmt, errorNameStorage);
    return 0;
}
} // namespace zSnd
