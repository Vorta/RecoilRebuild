 ...
 * Returns 2D perpendicular in the XY plane: out =(
     -v.y,
     v.x,
     0
 ).
 ...
 * Returns perpendicular in the XZ plane: out =(
     -v.z,
     0,
     v.x
 ).
 ...
 * Builds a 4x3 matrix from Euler angles(
     X,
     Y,
     Z
 ...
 * If length is 0, returns identity quaternion(
     1,
     0,
     0,
     0
