...
typedef int(__fastcall* zDEClient_CraterFeatureDispatch)(zDEClient_CraterEventTemplate* eventTemplate);
...
int __fastcall NetRelayCallback(int senderPlayerId, NetPkt10_QSandEvent* packet);
