...
{
    HRESULT(STDMETHODCALLTYPE *QueryInterface)(IUnknown *self, REFIID iid, void **out);
    ULONG(STDMETHODCALLTYPE *AddRef)(IUnknown *self);
    ULONG(STDMETHODCALLTYPE *Release)(IUnknown *self);
    HRESULT(STDMETHODCALLTYPE *BeginDownload)(IUnknown *self,
...
struct WestwoodOnlineUpgradeDownloadEventSink
{
    ...
    CreateInstance(WestwoodOnlineUpgradeDownloadEventSink **outSink);
};

extern WestwoodOnlineUpgradeDownloadEventSinkVtable
    g_WestwoodOnlineUpgradeDownloadEventSink_Vtbl;
...
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadComVtable, BeginDownload) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadComVtable, Abort) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadComVtable, Pump) == 0x14);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadReadyEntry, m_next) == 0x0c);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadReadyEntry, m_descriptor0) == 0x10);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadReadyEntry, m_sourcePathBase) == 0x51);
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadReadyEntry, m_fileName) == 0x151);
...
RECOIL_STATIC_ASSERT(offsetof(WestwoodOnlineUpgradeDownloadEventSink, m_vftable) == 0x00);
