    ...
    union {
        ...
        struct {
            ...
            union {
                ...
                struct {
                    PlayerProgressTargetSlotRuntime progressTargetRuntimeSlots[10];
                    zVec3 progressTargetPointStorage[10];
                };
                struct {
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        damageProtectionActive
    ) == 0x18
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        queuedFixedDamageFlag
    ) == 0x1c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        recentHitFxExpireTime
    ) == 0x58
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        recentHitLightHandle
    ) == 0x5c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        probeImpactSlot1SeenFlag
    ) == 0x34
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        probeImpactSlot4SeenFlag
    ) == 0x3c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        primaryGunGateUntilTime
    ) == 0x64
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        masterTypeTransitionCooldownUntilTime
    ) == 0x64
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        subVerticalInputCopy
    ) == 0x84
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        underwaterStatusActive
    ) == 0x8c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        modalProbeWorldByIndex
    ) == 0xf4
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        rootProbeWorldByIndex
    ) == 0x1a8
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        environmentAttachmentActive
    ) == 0x25c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        spawnStateInitialized
    ) == 0x448
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        aiTargetLineOfSightClear
    ) == 0x448
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        noPendingContactsQueued
    ) == 0x4d4
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        pickupQueueProcessed
    ) == 0x4d8
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        playerCollisionResolved
    ) == 0x4dc
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        worldCollisionResolved
    ) == 0x4e0
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        preferredCollisionResolved
    ) == 0x4e4
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        checkpointLapProgressNotified
    ) == 0x4e8
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        collisionProbeResolved
    ) == 0x4ec
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        cameraElevationOffset
    ) == 0x508
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        thirdPersonPositionYOffset
    ) == 0x50c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        altHardpointSelectState
    ) == 0xd44
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        primaryHardpointSelectState
    ) == 0xd48
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        altGunTransitionTimerA
    ) == 0xf28
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        altGunTransitionTimerB
    ) == 0xf2c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        masterTypeTransitionToAmphibNodeAction
    ) == 0xf40
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        masterTypeTransitionToAmphibLightHandle
    ) == 0xf44
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        masterTypeTransitionToSubLightHandle
    ) == 0xf48
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        masterTypeTransitionToSubNodeAction
    ) == 0xf4c
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        masterTypeTransitionToTrackNodeAction
    ) == 0xf50
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        masterTypeTransitionToTrackLightHandle
    ) == 0xf54
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        napalmVehicleFxEntry
    ) == 0xf58
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        shatterVehicleFxEntry
    ) == 0xf5c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        subTransitionFxEntry
    ) == 0xf64
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        destroyedRespawnFxEntry
    ) == 0xf68
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        destroyedRespawnAsyncHandle
    ) == 0xf6c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        aiSavedTopLevelState
    ) == 0xf88
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        aiReturnTopLevelState
    ) == 0xf8c
);
RECOIL_STATIC_ASSERT(
    offsetof(
...
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        aiPathCursorAdvanceRequested
    ) == 0xfec
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        aiCurrentSteeringSubstate
    ) == 0xff0
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        aiReturnSteeringSubstate
    ) == 0xff4
);
RECOIL_STATIC_ASSERT(
    offsetof(
        zUtil_PlayerStateStorage,
        aiMode2SteeringRetryCount
    ) == 0xffc
);
RECOIL_STATIC_ASSERT(
    offsetof(
