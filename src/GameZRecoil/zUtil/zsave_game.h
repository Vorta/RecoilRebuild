...
struct PlayerPendingContact {
    ...
    PlayerPendingContact* __fastcall SelectPreferred(PlayerPendingContact* rhs);
};
...
struct zUtil_SaveGameState {
    ...
    void StartModalLoopSfxHandle(int modalSfxIndex, float sfxVolume);
...
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, masterTypeTransitionCooldownUntilTime) == 0x64);
...
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, cameraBackOffset.x) == 0x52c);
...
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, altGunTransitionAnimScale) == 0xf24);
...
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, masterTypeTransitionToAmphibNodeAction) == 0xf40);
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, masterTypeTransitionToAmphibLightHandle) == 0xf44);
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, masterTypeTransitionToSubLightHandle) == 0xf48);
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, masterTypeTransitionToSubNodeAction) == 0xf4c);
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, masterTypeTransitionToTrackNodeAction) == 0xf50);
RECOIL_STATIC_ASSERT(offsetof(zUtil_PlayerStateStorage, masterTypeTransitionToTrackLightHandle) == 0xf54);
