...
RECOIL_NOINLINE int RECOIL_FASTCALL ZBD_LoadEntriesGlobal(
    const char *filename
) {
...
// (D:\Proj\GameZRecoil\zUtil\zutl_zar.cpp)
RECOIL_NOINLINE int RECOIL_FASTCALL ZAR_LoadFileGlobal(
    const char *filepath
) {
    zZbdManager *const manager = g_zUtil_ZbdManager;
    if (manager == 0) {
...
// (D:\Proj\GameZRecoil\zUtil\zUtil_ZBD.cpp; MSVC 5.0 STL list support)
RECOIL_NOINLINE void RECOIL_THISCALL zZbdSectionHandlerList::Front(
...
// (D:\Proj\GameZRecoil\zUtil\zUtil_ZBD.cpp; MSVC 5.0 STL list support)
RECOIL_NOINLINE void RECOIL_THISCALL zZbdSectionHandlerList::Swap(
...
// (D:\Proj\GameZRecoil\zUtil\zUtil_ZBD.cpp; MSVC 5.0 STL list support)
RECOIL_NOINLINE void RECOIL_THISCALL zZbdSectionHandlerList::SpliceThreeNodes(
...
// (D:\Proj\GameZRecoil\zUtil\zUtil_ZBD.cpp; MSVC 5.0 STL list support)
RECOIL_NOINLINE void RECOIL_THISCALL zZbdSectionHandlerList::Merge(
    zZbdSectionHandlerList *source
) {
    if (source == this) {
        return;
...
// (D:\Proj\GameZRecoil\zUtil\zUtil_ZBD.cpp)
RECOIL_NOINLINE int RECOIL_THISCALL zZbdManager::LoadEntries(
    const char *filename
) {
    int result = 0;
...
RECOIL_NOINLINE int RECOIL_THISCALL zZbdManager::LoadZarFile(
    const char *filepath
) {
...
RECOIL_NOINLINE int RECOIL_THISCALL zZbdManager::WriteSectionRecord(
...
RECOIL_NOINLINE void RECOIL_THISCALL zZbdManager::FlushTempStreamToSectionRecord(
    FILE *tempStream,
    zZbdSectionCallbackCtx *callbackCtx,
    const char *sectionToken
) {
...
// (D:\Proj\GameZRecoil\zUtil\zzbd.c)
RECOIL_NOINLINE FILE *RECOIL_THISCALL zZbdManager::CreateTempReadStreamFromBuffer(
    void *buffer,
    unsigned int size
) {
...
// (D:\Proj\GameZRecoil\zUtil\zzbd.c)
RECOIL_NOINLINE void RECOIL_THISCALL zZbdManager::RemoveTempFiles(
    FILE *tempStream
) {
    (void)tempStream;
...
// (D:\Proj\GameZRecoil\zZbd\zzbd.c)
RECOIL_NOINLINE int RECOIL_THISCALL zZbdSectionHandler::InvokePreLoad(
    zZbdSectionCallbackCtx *callbackCtx
) {
    if (onPreLoad == 0) {
        return 1;
    ...
    typedef int(RECOIL_FASTCALL * PreLoadCallback)(
...
// (D:\Proj\GameZRecoil\zZbd\zzbd.c)
RECOIL_NOINLINE void RECOIL_THISCALL zZbdSectionHandler::InvokeDataReady(
    zZbdSectionCallbackCtx *callbackCtx,
    const char *sectionToken,
    void *buffer,
    unsigned int size
    ...
    if (onDataReady != 0) {
        typedef void(RECOIL_FASTCALL * DataReadyCallback)(
            zZbdSectionCallbackCtx *,
            const char *,
            void *,
            unsigned int,
...
// (D:\Proj\GameZRecoil\zUtil\zbd_save.c)
RECOIL_NOINLINE void RECOIL_FASTCALL CloseTempReadStream(
    FILE *tempStream
) {
    zZbdManager *const manager = g_zUtil_ZbdManager;
    if (manager != 0) {
