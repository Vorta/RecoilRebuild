...
struct zUtil_PlayerStateStorage {
    union {
        ...
        struct {
            ...
            unsigned char unknown_00b0[0x270];
            zMat4x3 gunFireTransform;
            unsigned char unknown_0350[0x3c];
            zVec3 steerBasisRaw;
            unsigned char unknown_0398[0x54];
            zVec3 worldPos;
