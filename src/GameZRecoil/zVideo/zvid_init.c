...
namespace zVideo
{
    ...
    int __fastcall InitVideoSystem(HWND hWnd, int rendererBackend, int fullscreen, int modeIndex)
    {
        ...
        if (openResult != 0) {
            zError::ReportOld(0x800, g_zVideo_SourceFile_ZvidInitC, 0x7a, g_zVideo_InitFailOpenVideoModeMsg);
            return openResult;
        }
...
namespace zVideo
{
    ...
    void __fastcall BindRendererDispatch(int rendererType, int fullscreenOption)
    {
        ...
        g_zVideo_pfnShutdownVideoSystem = (zVideo_ShutdownVideoSystemProc)(zVideo_dd::ShutdownVideoSystem);
        ...
        g_zVideo_pfnImageUploadPixelsToSurface = zVideo_dd::ImageUploadPixelsToSurface;
        ...
        g_zVideo_pfnTextureRecordLockUploadSurface = zVideo_dd3d::TextureRecordLockUploadSurface;
        g_zVideo_pfnTextureRecordUnlockUploadSurface = zVideo_dd3d::TextureRecordUnlockUploadSurface;
        g_zVideo_pfnTextureRecordReleaseUploadSurfaceRef = zVideo_dd3d::TextureRecordReleaseUploadSurfaceRef;
        g_zVideo_pfnTextureRecordFinalizeUpload = zVideo_dd3d::TextureRecordFinalizeUpload;
        ...
        g_zVideo_pfnImageLazyCreateVideoMemorySurface = zVideo_dd::ImageLazyCreateVideoMemorySurface;
        g_zVideo_pfnImageEnsureSurfaceForCurrentDevice = zVideo_dd::ImageEnsureSurfaceForCurrentDevice;
