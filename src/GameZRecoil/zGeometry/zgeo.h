...
int __fastcall
AddIndexedPolygonToDi(zDiPartial* di, zModel_DrawBatchBasePartial* model, zModel_PolygonPartial* polygon);
zVec3* __fastcall
GetLinearBufferOfPolygonVertices(zModel_DrawBatchBasePartial* model, zModel_PolygonPartial* polygon, zVec3* points);
int __fastcall
IsFullyInsideClipPolygonXY(zGeometry_ClipPolygonPartial* clipPolygon, zModel_DrawBatchBasePartial* model);
int __fastcall
