...
class CallContractNormalizerRegistryTests(unittest.TestCase):
    ...
    def test_identity_uses_reviewed_integer_generation(self):
        ...
        self.assertEqual(14, NORMALIZER_REGISTRY_GENERATION)
    ...
    def test_record_validation_rejects_stale_generation(self):
        ...
        self.assertEqual(13, stale["registry_generation"])
    ...
    def test_live_generation_coordinates_are_current(self):
        self.assertEqual(16, CALL_CONTRACT_VERIFIER_GENERATION)
        self.assertEqual(14, NORMALIZER_REGISTRY_GENERATION)
        self.assertEqual(14, EXPECTED_FACT_SCHEMA_VERSION)
