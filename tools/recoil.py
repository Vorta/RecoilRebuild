...
_PROGRESS_TYPED_SPECS: tuple[CommandSpec, ...] = (
    ...
    spec("progress relocation-target retract", "relocation_target_mutation", prepend=("retract",), summary="Retract one exactly reviewed binding from a pre-existing symbol, preserving other identities, owners and evidence.", category="progress", mutates=True, required_revision_domains=("global",), mutation_scope="relocation-target", acceptance_effects=()),
