...
def check_native_x86() -> int:
    ...
    require_path(
        report,
        REPO_ROOT / "support" / "sdk" / "DirectX6" / "include" / "dplay.h",
        "DirectX August 2007 dplay.h",
    )
    require_path(
        report,
        REPO_ROOT / "support" / "sdk" / "DirectX6" / "lib" / "dplayx.lib",
        "DirectX 6 dplayx.lib",
    )
    require_path(
        report,
        Path(r"D:\Recoil Project\Compiler\VC5SP3\VC\MFC\INCLUDE\AFXWIN.H"),
        "canonical VC5SP3 MFC42 AFXWIN.H",
    )
    require_path(
        report,
        Path(r"D:\Recoil Project\Compiler\VC5SP3\VC\MFC\LIB\MFC42.LIB"),
        "canonical VC5SP3 MFC42 x86 import library",
    )
    require_path(
        report,
